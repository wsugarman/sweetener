...
namespace Sweetener.Logging 
{
    ...
    public abstract partial class Logger<T> : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Logger{T}"/> class that
        /// fulfills all logging requests.
        /// </summary>
        protected Logger()
            : this(LogLevel.Trace)
        { }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Logger{T}"/> class that
        /// fulfills all logging requests above a specified minimum <see cref="LogLevel"/>.
        /// </summary>
        ...
        // TODO: Should this method be protected (and exposed) instead of internal?
