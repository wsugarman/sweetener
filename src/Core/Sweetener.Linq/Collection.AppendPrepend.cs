...
namespace Sweetener.Linq
{
    static partial class Collection
    {
        ...
        public static IReadOnlyCollection<TSource> Append<TSource>(this ICollection<TSource> source, TSource element)
        ...
        public static IReadOnlyCollection<TSource> Append<TSource>(this IReadOnlyCollection<TSource> source, TSource element)
            => new AdditionalReadOnlyCollection<TSource>(source, Enumerable.Append(source, element));
        ...
        /// <exception cref="ArgumentNullException"><paramref name="source"/> is <see langword="null"/>.</exception>
        public static IReadOnlyCollection<TSource> Prepend<TSource>(this ICollection<TSource> source, TSource element)
        ...
        public static IReadOnlyCollection<TSource> Prepend<TSource>(this IReadOnlyCollection<TSource> source, TSource element)
            => new AdditionalReadOnlyCollection<TSource>(source, Enumerable.Prepend(source, element));
        ...
        private sealed class AdditionalCollection<TElement> : IReadOnlyCollection<TElement>
        {
            ...
            public AdditionalCollection(ICollection<TElement> source, IEnumerable<TElement> transformation)
            {
                _source = source;
        ...
        private sealed class AdditionalReadOnlyCollection<TElement> : IReadOnlyCollection<TElement>
        {
            public int Count => _source.Count + 1;
            ...
            public AdditionalReadOnlyCollection(IReadOnlyCollection<TElement> source, IEnumerable<TElement> transformation)
            {
                _source = source;
                _transformation = transformation;
            }
