...
namespace Sweetener.Linq
{
    partial class Collection
    {
        ...
        /// </exception>
        public static IReadOnlyCollection<TResult> Select<TSource, TResult>(this ICollection<TSource> source, Func<TSource, TResult> selector)
        ...
        /// <paramref name="source"/> or <paramref name="selector"/> is <see langword="null"/>.
        /// </exception>
        public static IEnumerable<TResult> Select<TSource, TResult>(this ICollection<TSource> source, Func<TSource, int, TResult> selector)
            => new SelectCollection<TSource, TResult>(source, Enumerable.Select(source, selector));
        ...
        public static IReadOnlyCollection<TResult> Select<TSource, TResult>(this IReadOnlyCollection<TSource> source, Func<TSource, TResult> selector)
            => new ReadOnlySelectCollection<TSource, TResult>(source, Enumerable.Select(source, selector));
        ...
        /// <paramref name="source"/> or <paramref name="selector"/> is <see langword="null"/>.
        /// </exception>
        public static IEnumerable<TResult> Select<TSource, TResult>(this IReadOnlyCollection<TSource> source, Func<TSource, int, TResult> selector)
            => new ReadOnlySelectCollection<TSource, TResult>(source, Enumerable.Select(source, selector));
        ...
        private sealed class SelectCollection<TSource, TResult> : IReadOnlyCollection<TResult>
        {
            ...
            public SelectCollection(ICollection<TSource> source, IEnumerable<TResult> projection)
            {
                _source = source;
        ...
        private sealed class ReadOnlySelectCollection<TSource, TResult> : IReadOnlyCollection<TResult>
        {
            public int Count => _source.Count;
            ...
            public ReadOnlySelectCollection(IReadOnlyCollection<TSource> source, IEnumerable<TResult> projection)
            {
                _source = source;
                _projection = projection;
            }
