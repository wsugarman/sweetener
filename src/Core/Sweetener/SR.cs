...
internal static class SR
{
    ...
    public static string InvalidInputStringFormatMessage => ExceptionResourceManager.GetString(nameof(InvalidInputStringFormatMessage), CultureInfo.CurrentUICulture);
