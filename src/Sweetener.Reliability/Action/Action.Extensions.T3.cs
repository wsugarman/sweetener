...
namespace Sweetener.Reliability
{
    static partial class ActionExtensions
    {
        ...
        /// </exception>
        public static Action<T1, T2, T3> WithRetry<T1, T2, T3>(this Action<T1, T2, T3> action, int maxRetries, ExceptionHandler exceptionHandler, DelayHandler delayHandler)
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public static Action<T1, T2, T3> WithRetry<T1, T2, T3>(this Action<T1, T2, T3> action, int maxRetries, ExceptionHandler exceptionHandler, ComplexDelayHandler delayHandler)
        {
            if (action == null)
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public static Action<T1, T2, T3, CancellationToken> WithRetry<T1, T2, T3>(this Action<T1, T2, T3, CancellationToken> action, int maxRetries, ExceptionHandler exceptionHandler, DelayHandler delayHandler)
            => WithRetry(action, maxRetries, exceptionHandler, delayHandler.ToComplex());
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public static Action<T1, T2, T3, CancellationToken> WithRetry<T1, T2, T3>(this Action<T1, T2, T3, CancellationToken> action, int maxRetries, ExceptionHandler exceptionHandler, ComplexDelayHandler delayHandler)
        {
            if (action == null)
                throw new ArgumentNullException(nameof(action));
