...
namespace Sweetener.Reliability
{
    ...
    {
        /// <summary>
        /// Creates a new <see cref="ReliableAsyncAction{T1, T2, T3, T4, T5, T6}"/>
        /// that executes the given <see cref="AsyncAction{T1, T2, T3, T4, T5, T6}"/>
        ...
        /// </exception>
        public static ReliableAsyncAction<T1, T2, T3, T4, T5, T6> Create<T1, T2, T3, T4, T5, T6>(
            AsyncAction<T1, T2, T3, T4, T5, T6> action,
            int maxRetries,
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncAction<T1, T2, T3, T4, T5, T6>(action, maxRetries, exceptionPolicy, delayPolicy);
        ...
        /// <summary>
        /// Creates a new <see cref="ReliableAsyncAction{T1, T2, T3, T4, T5, T6}"/>
        /// that executes the given <see cref="InterruptableAsyncAction{T1, T2, T3, T4, T5, T6}"/>
        /// at most a specific number of times based on the provided policies.
        /// </summary>
        /// <typeparam name="T1">The type of the first parameter of the method that this reliable delegate encapsulates.</typeparam>
        /// <typeparam name="T2">The type of the second parameter of the method that this reliable delegate encapsulates.</typeparam>
        ...
        /// </exception>
        public static ReliableAsyncAction<T1, T2, T3, T4, T5, T6> Create<T1, T2, T3, T4, T5, T6>(
            InterruptableAsyncAction<T1, T2, T3, T4, T5, T6> action,
            int maxRetries,
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncAction<T1, T2, T3, T4, T5, T6>(action, maxRetries, exceptionPolicy, delayPolicy);
