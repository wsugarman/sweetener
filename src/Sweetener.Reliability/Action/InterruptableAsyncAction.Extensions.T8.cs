...
namespace Sweetener.Reliability
{
    static partial class InterruptableAsyncActionExtensions
    {
        ...
        /// </exception>
        public static InterruptableAsyncAction<T1, T2, T3, T4, T5, T6, T7, T8> WithAsyncRetry<T1, T2, T3, T4, T5, T6, T7, T8>(this InterruptableAsyncAction<T1, T2, T3, T4, T5, T6, T7, T8> action, int maxRetries, ExceptionPolicy exceptionPolicy, DelayPolicy delayPolicy)
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public static InterruptableAsyncAction<T1, T2, T3, T4, T5, T6, T7, T8> WithAsyncRetry<T1, T2, T3, T4, T5, T6, T7, T8>(this InterruptableAsyncAction<T1, T2, T3, T4, T5, T6, T7, T8> action, int maxRetries, ExceptionPolicy exceptionPolicy, ComplexDelayPolicy delayPolicy)
        {
            if (action == null)
