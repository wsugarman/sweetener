...
namespace Sweetener.Reliability
{
    static partial class InterruptableAsyncActionExtensions
    {
        ...
        /// </exception>
        public static InterruptableAsyncAction<T1, T2, T3> WithAsyncRetry<T1, T2, T3>(this InterruptableAsyncAction<T1, T2, T3> action, int maxRetries, ExceptionPolicy exceptionPolicy, DelayPolicy delayPolicy)
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public static InterruptableAsyncAction<T1, T2, T3> WithAsyncRetry<T1, T2, T3>(this InterruptableAsyncAction<T1, T2, T3> action, int maxRetries, ExceptionPolicy exceptionPolicy, ComplexDelayPolicy delayPolicy)
        {
            if (action == null)
