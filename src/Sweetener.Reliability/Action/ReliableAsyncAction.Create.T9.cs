...
namespace Sweetener.Reliability
{
    partial class ReliableAsyncAction
    {
        ...
        /// that executes the given <see cref="Func{T1, T2, T3, T4, T5, T6, T7, T8, T9, Task}"/>
        ...
        /// <summary>
        /// Creates a new <see cref="ReliableAsyncAction{T1, T2, T3, T4, T5, T6, T7, T8, T9}"/>
        /// that executes the given <see cref="Func{T1, T2, T3, T4, T5, T6, T7, T8, T9, CancellationToken, Task}"/>
        /// at most a specific number of times based on the provided policies.
        /// </summary>
        /// <typeparam name="T1">The type of the first parameter of the method that this reliable delegate encapsulates.</typeparam>
        /// <typeparam name="T2">The type of the second parameter of the method that this reliable delegate encapsulates.</typeparam>
        ...
        /// </exception>
        public static ReliableAsyncAction<T1, T2, T3, T4, T5, T6, T7, T8, T9> Create<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, CancellationToken, Task> action,
            int maxRetries,
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncAction<T1, T2, T3, T4, T5, T6, T7, T8, T9>(action, maxRetries, exceptionPolicy, delayPolicy);
