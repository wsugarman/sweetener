...
namespace Sweetener.Reliability
{
    partial class ReliableAction
    {
        ...
        /// that executes the given <see cref="Action{T1, T2, T3, T4, T5, T6}"/>
        ...
        /// <summary>
        /// Creates a new <see cref="ReliableAction{T1, T2, T3, T4, T5, T6}"/>
        /// that executes the given <see cref="Action{T1, T2, T3, T4, T5, T6, CancellationToken}"/>
        /// at most a specific number of times based on the provided policies.
        /// </summary>
        /// <typeparam name="T1">The type of the first parameter of the method that this reliable delegate encapsulates.</typeparam>
        /// <typeparam name="T2">The type of the second parameter of the method that this reliable delegate encapsulates.</typeparam>
        ...
        /// </exception>
        public static ReliableAction<T1, T2, T3, T4, T5, T6> Create<T1, T2, T3, T4, T5, T6>(
            Action<T1, T2, T3, T4, T5, T6, CancellationToken> action,
            int maxRetries,
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAction<T1, T2, T3, T4, T5, T6>(action, maxRetries, exceptionPolicy, delayPolicy);
