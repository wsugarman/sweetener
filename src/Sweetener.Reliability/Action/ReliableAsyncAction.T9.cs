...
namespace Sweetener.Reliability
{
    ...
    public sealed class ReliableAsyncAction<T1, T2, T3, T4, T5, T6, T7, T8, T9> : ReliableDelegate
    {
        private readonly Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, CancellationToken, Task> _action;

        /// <summary>
        /// Initializes a new instance of the <see cref="ReliableAsyncAction{T1, T2, T3, T4, T5, T6, T7, T8, T9}"/>
        /// class that executes the given <see cref="Func{T1, T2, T3, T4, T5, T6, T7, T8, T9, Task}"/> at most a
        ...
        /// </exception>
        public ReliableAsyncAction(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, Task> action, int maxRetries, ExceptionPolicy exceptionPolicy, DelayPolicy delayPolicy)
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public ReliableAsyncAction(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, Task> action, int maxRetries, ExceptionPolicy exceptionPolicy, ComplexDelayPolicy delayPolicy)
            : this(action.IgnoreInterruption(), maxRetries, exceptionPolicy, delayPolicy)
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="ReliableAsyncAction{T1, T2, T3, T4, T5, T6, T7, T8, T9}"/>
        /// class that executes the given <see cref="Func{T1, T2, T3, T4, T5, T6, T7, T8, T9, CancellationToken, Task}"/> at most a
        /// specific number of times based on the provided policies.
        /// </summary>
        /// <param name="action">The action to encapsulate.</param>
        /// <param name="maxRetries">The maximum number of retry attempts.</param>
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public ReliableAsyncAction(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, CancellationToken, Task> action, int maxRetries, ExceptionPolicy exceptionPolicy, DelayPolicy delayPolicy)
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public ReliableAsyncAction(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, CancellationToken, Task> action, int maxRetries, ExceptionPolicy exceptionPolicy, ComplexDelayPolicy delayPolicy)
            : base(maxRetries, exceptionPolicy, delayPolicy)
        {
            _action = action ?? throw new ArgumentNullException(nameof(action));
        }
        ...
        public async Task InvokeAsync(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, T6 arg6, T7 arg7, T8 arg8, T9 arg9, CancellationToken cancellationToken)
        {
            int attempt = 0;
            do
            {
                ...
                try
                {
                    t = _action(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, cancellationToken);
