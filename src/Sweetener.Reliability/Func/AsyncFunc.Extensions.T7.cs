...
namespace Sweetener.Reliability
{
    static partial class AsyncFuncExtensions
    {
        ...
        /// </exception>
        public static InterruptableAsyncFunc<T1, T2, T3, T4, T5, T6, TResult> WithRetryAsync<T1, T2, T3, T4, T5, T6, TResult>(this AsyncFunc<T1, T2, T3, T4, T5, T6, TResult> func, int maxRetries, ExceptionPolicy exceptionPolicy, DelayPolicy delayPolicy)
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public static InterruptableAsyncFunc<T1, T2, T3, T4, T5, T6, TResult> WithRetryAsync<T1, T2, T3, T4, T5, T6, TResult>(this AsyncFunc<T1, T2, T3, T4, T5, T6, TResult> func, int maxRetries, ExceptionPolicy exceptionPolicy, ComplexDelayPolicy<TResult> delayPolicy)
        ...
        public static InterruptableAsyncFunc<T1, T2, T3, T4, T5, T6, TResult> WithRetryAsync<T1, T2, T3, T4, T5, T6, TResult>(
            this AsyncFunc<T1, T2, T3, T4, T5, T6, TResult> func,
            int                   maxRetries,
            ...
            ComplexDelayPolicy<TResult> delayPolicy)
        {
            ...
            Attempt:
                ...
                try
                {
                    result = await func(arg1, arg2, arg3, arg4, arg5, arg6).ConfigureAwait(false);
                }
                catch (Exception e)
                {
