...
namespace Sweetener.Reliability
{
    ...
    {
        /// <summary>
        /// Creates a new <see cref="ReliableAsyncFunc{T1, T2, T3, T4, T5, T6, T7, TResult}"/>
        /// that executes the given <see cref="AsyncFunc{T1, T2, T3, T4, T5, T6, T7, TResult}"/> at most a
        ...
        /// </exception>
        public static ReliableAsyncFunc<T1, T2, T3, T4, T5, T6, T7, TResult> Create<T1, T2, T3, T4, T5, T6, T7, TResult>(
            AsyncFunc<T1, T2, T3, T4, T5, T6, T7, TResult> func,
            int maxRetries,
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncFunc<T1, T2, T3, T4, T5, T6, T7, TResult>(func, maxRetries, exceptionPolicy, delayPolicy);
        ...
        public static ReliableAsyncFunc<T1, T2, T3, T4, T5, T6, T7, TResult> Create<T1, T2, T3, T4, T5, T6, T7, TResult>(
            ...
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncFunc<T1, T2, T3, T4, T5, T6, T7, TResult>(func, maxRetries, resultPolicy, exceptionPolicy, delayPolicy);
