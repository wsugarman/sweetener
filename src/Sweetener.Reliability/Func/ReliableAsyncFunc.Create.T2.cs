...
namespace Sweetener.Reliability
{
    static partial class ReliableAsyncFunc
    {
        ...
        /// that executes the given <see cref="AsyncFunc{T, TResult}"/> at most a
        ...
        public static ReliableAsyncFunc<T, TResult> Create<T, TResult>(
            ...
            => new ReliableAsyncFunc<T, TResult>(func, maxRetries, exceptionPolicy, delayPolicy);
        ...
        public static ReliableAsyncFunc<T, TResult> Create<T, TResult>(
            ...
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncFunc<T, TResult>(func, maxRetries, resultPolicy, exceptionPolicy, delayPolicy);
