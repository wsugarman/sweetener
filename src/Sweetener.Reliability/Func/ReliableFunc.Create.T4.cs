...
namespace Sweetener.Reliability
{
    static partial class ReliableFunc
    {
        ...
        public static ReliableFunc<T1, T2, T3, TResult> Create<T1, T2, T3, TResult>(
            ...
            => new ReliableFunc<T1, T2, T3, TResult>(func, maxRetries, exceptionHandler, delayHandler);
        ...
        public static ReliableFunc<T1, T2, T3, TResult> Create<T1, T2, T3, TResult>(
            ...
            ExceptionHandler       exceptionHandler,
            DelayHandler           delayHandler)
            => new ReliableFunc<T1, T2, T3, TResult>(func, maxRetries, resultHandler, exceptionHandler, delayHandler);
        ...
        /// </exception>
        public static ReliableFunc<T1, T2, T3, TResult> Create<T1, T2, T3, TResult>(
            Func<T1, T2, T3, CancellationToken, TResult> func,
            int              maxRetries,
            ExceptionHandler exceptionHandler,
            DelayHandler     delayHandler)
            => new ReliableFunc<T1, T2, T3, TResult>(func, maxRetries, exceptionHandler, delayHandler);
