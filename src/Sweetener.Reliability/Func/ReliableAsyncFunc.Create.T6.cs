...
namespace Sweetener.Reliability
{
    ...
    {
        /// <summary>
        /// Creates a new <see cref="ReliableAsyncFunc{T1, T2, T3, T4, T5, TResult}"/>
        ...
        /// </exception>
        public static ReliableAsyncFunc<T1, T2, T3, T4, T5, TResult> Create<T1, T2, T3, T4, T5, TResult>(
            Func<T1, T2, T3, T4, T5, Task<TResult>> func,
            int              maxRetries,
            ExceptionHandler exceptionHandler,
            DelayHandler     delayHandler)
            => new ReliableAsyncFunc<T1, T2, T3, T4, T5, TResult>(func, maxRetries, exceptionHandler, delayHandler);
        ...
        public static ReliableAsyncFunc<T1, T2, T3, T4, T5, TResult> Create<T1, T2, T3, T4, T5, TResult>(
            ...
            ExceptionHandler       exceptionHandler,
            DelayHandler           delayHandler)
            => new ReliableAsyncFunc<T1, T2, T3, T4, T5, TResult>(func, maxRetries, resultHandler, exceptionHandler, delayHandler);
        ...
        /// </exception>
        public static ReliableAsyncFunc<T1, T2, T3, T4, T5, TResult> Create<T1, T2, T3, T4, T5, TResult>(
            Func<T1, T2, T3, T4, T5, CancellationToken, Task<TResult>> func,
            int              maxRetries,
            ExceptionHandler exceptionHandler,
            DelayHandler     delayHandler)
            => new ReliableAsyncFunc<T1, T2, T3, T4, T5, TResult>(func, maxRetries, exceptionHandler, delayHandler);
