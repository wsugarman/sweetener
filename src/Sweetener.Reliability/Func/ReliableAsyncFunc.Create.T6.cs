...
namespace Sweetener.Reliability
{
    static partial class ReliableAsyncFunc
    {
        ...
        /// that executes the given <see cref="AsyncFunc{T1, T2, T3, T4, T5, TResult}"/> at most a
        ...
        public static ReliableAsyncFunc<T1, T2, T3, T4, T5, TResult> Create<T1, T2, T3, T4, T5, TResult>(
            AsyncFunc<T1, T2, T3, T4, T5, TResult> func,
            int maxRetries,
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncFunc<T1, T2, T3, T4, T5, TResult>(func, maxRetries, exceptionPolicy, delayPolicy);
