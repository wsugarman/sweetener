...
namespace Sweetener.Reliability
{
    static partial class AsyncFuncExtensions
    {
        ...
        /// </exception>
        public static Func<T1, T2, T3, T4, Task<TResult>> WithAsyncRetry<T1, T2, T3, T4, TResult>(this Func<T1, T2, T3, T4, Task<TResult>> func, int maxRetries, ExceptionHandler exceptionHandler, DelayHandler delayHandler)
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public static Func<T1, T2, T3, T4, Task<TResult>> WithAsyncRetry<T1, T2, T3, T4, TResult>(this Func<T1, T2, T3, T4, Task<TResult>> func, int maxRetries, ExceptionHandler exceptionHandler, ComplexDelayHandler<TResult> delayHandler)
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public static Func<T1, T2, T3, T4, CancellationToken, Task<TResult>> WithAsyncRetry<T1, T2, T3, T4, TResult>(this Func<T1, T2, T3, T4, CancellationToken, Task<TResult>> func, int maxRetries, ExceptionHandler exceptionHandler, DelayHandler delayHandler)
            => WithAsyncRetry(func, maxRetries, ResultPolicy.Default<TResult>(), exceptionHandler, delayHandler.ToComplex<TResult>());
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public static Func<T1, T2, T3, T4, CancellationToken, Task<TResult>> WithAsyncRetry<T1, T2, T3, T4, TResult>(this Func<T1, T2, T3, T4, CancellationToken, Task<TResult>> func, int maxRetries, ExceptionHandler exceptionHandler, ComplexDelayHandler<TResult> delayHandler)
            => WithAsyncRetry(func, maxRetries, ResultPolicy.Default<TResult>(), exceptionHandler, delayHandler);
