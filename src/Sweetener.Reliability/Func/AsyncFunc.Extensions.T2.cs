...
namespace Sweetener.Reliability
{
    static partial class AsyncFuncExtensions
    {
        ...
        /// </exception>
        public static InterruptableAsyncFunc<T, TResult> WithRetryAsync<T, TResult>(this AsyncFunc<T, TResult> func, int maxRetries, ExceptionPolicy exceptionPolicy, DelayPolicy delayPolicy)
        ...
        /// <paramref name="maxRetries" /> is a negative number other than <c>-1</c>, which represents an infinite number of retries.
        /// </exception>
        public static InterruptableAsyncFunc<T, TResult> WithRetryAsync<T, TResult>(this AsyncFunc<T, TResult> func, int maxRetries, ExceptionPolicy exceptionPolicy, ComplexDelayPolicy<TResult> delayPolicy)
