...
namespace Sweetener.Reliability
{
    static partial class ReliableAsyncFunc
    {
        ...
        /// that executes the given <see cref="AsyncFunc{T1, T2, T3, T4, T5, T6, TResult}"/> at most a
        ...
        public static ReliableAsyncFunc<T1, T2, T3, T4, T5, T6, TResult> Create<T1, T2, T3, T4, T5, T6, TResult>(
            AsyncFunc<T1, T2, T3, T4, T5, T6, TResult> func,
            int maxRetries,
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncFunc<T1, T2, T3, T4, T5, T6, TResult>(func, maxRetries, exceptionPolicy, delayPolicy);
        ...
        public static ReliableAsyncFunc<T1, T2, T3, T4, T5, T6, TResult> Create<T1, T2, T3, T4, T5, T6, TResult>(
            ...
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncFunc<T1, T2, T3, T4, T5, T6, TResult>(func, maxRetries, resultPolicy, exceptionPolicy, delayPolicy);
