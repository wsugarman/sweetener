...
namespace Sweetener.Reliability
{
    static partial class ReliableFunc
    {
        ...
        public static ReliableFunc<T1, T2, T3, T4, T5, T6, T7, T8, TResult> Create<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(
            ...
            => new ReliableFunc<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(func, maxRetries, exceptionHandler, delayHandler);
        ...
        public static ReliableFunc<T1, T2, T3, T4, T5, T6, T7, T8, TResult> Create<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(
            ...
            ExceptionHandler       exceptionHandler,
            DelayHandler           delayHandler)
            => new ReliableFunc<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(func, maxRetries, resultHandler, exceptionHandler, delayHandler);
        ...
        /// </exception>
        public static ReliableFunc<T1, T2, T3, T4, T5, T6, T7, T8, TResult> Create<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(
            Func<T1, T2, T3, T4, T5, T6, T7, T8, CancellationToken, TResult> func,
            int              maxRetries,
            ExceptionHandler exceptionHandler,
            DelayHandler     delayHandler)
            => new ReliableFunc<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(func, maxRetries, exceptionHandler, delayHandler);
