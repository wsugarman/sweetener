...
namespace Sweetener.Reliability
{
    static partial class ReliableAsyncFunc
    {
        ...
        public static ReliableAsyncFunc<T1, T2, T3, TResult> Create<T1, T2, T3, TResult>(
            ...
            => new ReliableAsyncFunc<T1, T2, T3, TResult>(func, maxRetries, exceptionHandler, delayHandler);
        ...
        public static ReliableAsyncFunc<T1, T2, T3, TResult> Create<T1, T2, T3, TResult>(
            ...
            ExceptionHandler       exceptionHandler,
            DelayHandler           delayHandler)
            => new ReliableAsyncFunc<T1, T2, T3, TResult>(func, maxRetries, resultHandler, exceptionHandler, delayHandler);
