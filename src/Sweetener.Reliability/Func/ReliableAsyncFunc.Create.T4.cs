...
namespace Sweetener.Reliability
{
    ...
    {
        /// <summary>
        /// Creates a new <see cref="ReliableAsyncFunc{T1, T2, T3, TResult}"/>
        /// that executes the given <see cref="AsyncFunc{T1, T2, T3, TResult}"/> at most a
        ...
        /// </exception>
        public static ReliableAsyncFunc<T1, T2, T3, TResult> Create<T1, T2, T3, TResult>(
            AsyncFunc<T1, T2, T3, TResult> func,
            int maxRetries,
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncFunc<T1, T2, T3, TResult>(func, maxRetries, exceptionPolicy, delayPolicy);
        ...
        public static ReliableAsyncFunc<T1, T2, T3, TResult> Create<T1, T2, T3, TResult>(
            ...
            ExceptionPolicy exceptionPolicy,
            DelayPolicy delayPolicy)
            => new ReliableAsyncFunc<T1, T2, T3, TResult>(func, maxRetries, resultPolicy, exceptionPolicy, delayPolicy);
