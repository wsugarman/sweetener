// Generated from ExceptionPolicy.Retry.tt
using System;
...
namespace Sweetener.Reliability
{
    static partial class ExceptionPolicy
    {
        ...
        public static ExceptionHandler Retry<T>()
            where T : Exception
            => exception =>
            {
                if (exception == null)
        ...
        public static ExceptionHandler Retry<T1, T2>()
            where T1 : Exception
            where T2 : Exception
            => exception =>
            {
        ...
        public static ExceptionHandler Retry<T1, T2, T3>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            => exception =>
        ...
        public static ExceptionHandler Retry<T1, T2, T3, T4>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            where T4 : Exception
        ...
        public static ExceptionHandler Retry<T1, T2, T3, T4, T5>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            where T4 : Exception
        ...
        public static ExceptionHandler Retry<T1, T2, T3, T4, T5, T6>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            where T4 : Exception
        ...
        public static ExceptionHandler Retry<T1, T2, T3, T4, T5, T6, T7>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            where T4 : Exception
        ...
        public static ExceptionHandler Retry<T1, T2, T3, T4, T5, T6, T7, T8>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            where T4 : Exception
