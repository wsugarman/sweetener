// Generated from ExceptionPolicy.Fail.tt
using System;
...
namespace Sweetener.Reliability
{
    ...
    {
        /// <summary>
        /// Creates an <see cref="ExceptionHandler" /> that immediately fails an operation
        ...
        public static ExceptionHandler Fail<T>()
            where T : Exception
            => exception =>
            {
                if (exception == null)
        ...
        public static ExceptionHandler Fail<T1, T2>()
            where T1 : Exception
            where T2 : Exception
            => exception =>
            {
        ...
        public static ExceptionHandler Fail<T1, T2, T3>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            => exception =>
        ...
        public static ExceptionHandler Fail<T1, T2, T3, T4>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            where T4 : Exception
        ...
        public static ExceptionHandler Fail<T1, T2, T3, T4, T5>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            where T4 : Exception
        ...
        public static ExceptionHandler Fail<T1, T2, T3, T4, T5, T6>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            where T4 : Exception
        ...
        public static ExceptionHandler Fail<T1, T2, T3, T4, T5, T6, T7>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            where T4 : Exception
        ...
        public static ExceptionHandler Fail<T1, T2, T3, T4, T5, T6, T7, T8>()
            where T1 : Exception
            where T2 : Exception
            where T3 : Exception
            where T4 : Exception
