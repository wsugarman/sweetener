...
namespace Sweetener.Reliability.Test
{
    partial class BaseActionExtensionsTest
    {
        ...
        internal void WithRetryT5_Success<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
        ...
        internal void WithRetryT5_Failure<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
            Func<Action<CancellationToken>, TActionProxy> actionFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TAction, int, ExceptionHandler, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, CancellationToken> invoke,
            ...
            where TDelayPolicyProxy : DelegateProxy<TDelayPolicy>
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.That.ThrowsException<OutOfMemoryException>(() => invoke(reliableAction, 42, "foo", 3.14D, 1000L, tokenSource.Token));
        ...
        internal void WithRetryT5_EventualSuccess<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
            Func<Action<CancellationToken>, TActionProxy> actionFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TAction, int, ExceptionHandler, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, CancellationToken> invoke,
        ...
        internal void WithRetryT5_EventualFailure<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
            Func<Action<CancellationToken>, TActionProxy> actionFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TAction, int, ExceptionHandler, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, CancellationToken> invoke,
        ...
        internal void WithRetryT5_RetriesExhausted<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
            Func<Action<CancellationToken>, TActionProxy> actionFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TAction, int, ExceptionHandler, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, CancellationToken> invoke,
        ...
        internal void WithRetryT5_Canceled_Delay<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
            Func<Action<CancellationToken>, TActionProxy> actionFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TAction, int, ExceptionHandler, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, CancellationToken> invoke,
