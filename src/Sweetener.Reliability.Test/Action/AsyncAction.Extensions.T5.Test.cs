...
namespace Sweetener.Reliability.Test
{
    ...
    using TestAction                   = Func     <int, string, double, long, ushort, Task>;
    using InterruptableTestAction      = Func     <int, string, double, long, ushort, CancellationToken, Task>;
    using TestActionProxy              = FuncProxy<int, string, double, long, ushort, Task>;
    using InterruptableTestActionProxy = FuncProxy<int, string, double, long, ushort, CancellationToken, Task>;
