...
#nullable disable
            ...
            TestAction nullTaskAction         = (arg1, arg2, arg3, arg4, arg5) => null;
            ...
            Assert.ThrowsExceptionAsync<InvalidOperationException>(() => nullTaskReliableAction(42, "foo", 3.14D, 1000L, (ushort)1)).Wait();
...
#nullable enable
            ...
            // Test each scenario
            WithRetryT6_Success         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int>());
            WithRetryT6_Failure         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int>());
...
#nullable enable
            ...
            // Test each scenario
            WithRetryT6_Success         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int, Exception>());
            WithRetryT6_Failure         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int, Exception>());
...
#nullable disable
            ...
            // Test an action that returns a null Task
            InterruptableTestAction nullTaskAction         = (arg1, arg2, arg3, arg4, arg5, token) => null;
            ...
            Assert.ThrowsExceptionAsync<InvalidOperationException>(() => nullTaskReliableAction(42, "foo", 3.14D, 1000L, (ushort)1, CancellationToken.None)).Wait();
