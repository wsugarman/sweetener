...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction6Test : ReliableDelegateTest
    {
        ...
        private void TryInvoke(bool passToken)
        {
            ...
            // Test retrying without a delay
            Invoke_NoDelay((r, arg1, arg2, arg3, arg4, arg5, arg6, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, arg5, arg6, t)));
        }
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAction<int, string, double, long, ushort, byte>, int, string, double, long, ushort, byte, CancellationToken, Type> assertInvoke, bool addEventHandlers, TimeSpan delay, TimeSpan minExpectedDelay)
        {
        ...
        private void Invoke_NoDelay(Action<ReliableAction<int, string, double, long, ushort, byte>, int, string, double, long, ushort, byte, CancellationToken, Type> assertInvoke)
