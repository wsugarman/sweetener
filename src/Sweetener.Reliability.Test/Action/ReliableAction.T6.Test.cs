...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction6Test : ReliableDelegateTest
    {
        ...
        private void Invoke_Canceled(Action<ReliableAction<int, string, double, long, ushort, byte>, int, string, double, long, ushort, byte, CancellationToken> assertInvoke, bool addEventHandlers)
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => assertInvoke(reliableAction, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, tokenSource.Token));
