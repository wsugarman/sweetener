...
namespace Sweetener.Reliability.Test
{
    partial class InterruptableActionExtensionsTest
    {
        ...
        {
            InterruptableAction<int, string> nullAction = null;
            InterruptableAction<int, string> action     = (arg1, arg2, token) => Operation.Null();
            ...
            Func<InterruptableAction<int, string>, int, ExceptionPolicy, DelayPolicy, InterruptableAction<int, string>> withRetry = (a, r, e, d) => a.WithRetry(r, e, d);
            ...
            WithRetryT2_EventualFailure (withRetry, invoke);
            WithRetryT2_RetriesExhausted(withRetry, invoke);
            WithRetryT2_Canceled_Action (withRetry, invoke);
        ...
        public void WithRetryT2_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAction<int, string>, int, string, CancellationToken> invoke;
            Func<InterruptableAction<int, string>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAction<int, string>> withRetry = (a, r, e, d) => a.WithRetry(r, e, d);
        ...
        public void WithAsyncRetryT2_DelayPolicy()
        {
            ...
            Func<InterruptableAction<int, string>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        public void WithAsyncRetryT2_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string>, int, string, CancellationToken> invoke;
            Func<InterruptableAction<int, string>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT2_Success<T>(
            Func<InterruptableAction<int, string>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT2_Success<T>(
            Func<InterruptableAction<int, string>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, CancellationToken> invoke)
            => WithRetryT2_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT2_Success<TDelayPolicy, TAction>(
            Func<InterruptableAction<int, string>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, CancellationToken> action = new ActionProxy<int, string, CancellationToken>((arg1, arg2, token) => Operation.Null());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, CancellationToken> action = new ActionProxy<int, string, CancellationToken>((arg1, arg2, token) => throw new InvalidOperationException());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, CancellationToken> action = new ActionProxy<int, string, CancellationToken>((arg1, arg2, token) => flakyAction());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, CancellationToken> action = new ActionProxy<int, string, CancellationToken>((arg1, arg2, token) => throw new IOException());
