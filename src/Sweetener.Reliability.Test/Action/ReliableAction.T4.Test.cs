...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction4Test : ReliableDelegateTest
    {
        ...
        private void Invoke(bool passToken)
        {
            ...
            Invoke_NoDelay((r, arg1, arg2, arg3, arg4, t, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, t), e));
        }
        ...
        private void InvokeAsync(bool passToken)
        {
            Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken> invoke;
            if (passToken)
                invoke = (r, arg1, arg2, arg3, arg4, t) => r.InvokeAsync(arg1, arg2, arg3, arg4, t).Wait();
            else
                invoke = (r, arg1, arg2, arg3, arg4, t) => r.InvokeAsync(arg1, arg2, arg3, arg4).Wait();
        ...
        private void TryInvoke(bool passToken)
        {
            ...
            // Test retrying without a delay
            Invoke_NoDelay((r, arg1, arg2, arg3, arg4, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, t)));
        }
        ...
        private void Invoke_Failure(Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAction, 42, "foo", 3.14D, 1000L, tokenSource.Token, typeof(InvalidOperationException));
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke, bool addEventHandlers, TimeSpan delay, TimeSpan minExpectedDelay)
        {
        ...
        private void Invoke_NoDelay(Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke)
