...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAction<int, string, double, long>, Action<int, string, double, long, CancellationToken>> s_getAction = DynamicGetter.ForField<ReliableAction<int, string, double, long>, Action<int, string, double, long, CancellationToken>>("_action");

        [TestMethod]
        public void Ctor_DelayHandler()
            => Ctor_DelayHandler((a, m, d, e) => new ReliableAction<int, string, double, long>(a, m, d, e));

        [TestMethod]
        public void Ctor_ComplexDelayHandler()
            => Ctor_ComplexDelayHandler((a, m, d, e) => new ReliableAction<int, string, double, long>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_DelayHandler()
            => Ctor_Interruptable_DelayHandler((a, m, d, e) => new ReliableAction<int, string, double, long>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayHandler()
            => Ctor_Interruptable_ComplexDelayHandler((a, m, d, e) => new ReliableAction<int, string, double, long>(a, m, d, e));
        ...
        private void Ctor_DelayHandler(Func<Action<int, string, double, long>, int, ExceptionHandler, DelayHandler, ReliableAction<int, string, double, long>> factory)
        {
            ActionProxy<int, string, double, long> action = new ActionProxy<int, string, double, long>();
            ...
            ReliableAction<int, string, double, long> actual = factory(action.Invoke, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_ComplexDelayHandler(Func<Action<int, string, double, long>, int, ExceptionHandler, ComplexDelayHandler, ReliableAction<int, string, double, long>> factory)
        {
            ActionProxy<int, string, double, long> action = new ActionProxy<int, string, double, long>();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long> actual = factory(action.Invoke, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_Interruptable_DelayHandler(Func<Action<int, string, double, long, CancellationToken>, int, ExceptionHandler, DelayHandler, ReliableAction<int, string, double, long>> factory)
        {
            Action<int, string, double, long, CancellationToken> action = (arg1, arg2, arg3, arg4, token) => Operation.Null();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            FuncProxy<int, TimeSpan> delayHandler = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
            Assert.ThrowsException<ArgumentNullException      >(() => factory(null, Retries.Infinite, exceptionHandler, delayHandler.Invoke));
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long> actual = factory(action, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_Interruptable_ComplexDelayHandler(Func<Action<int, string, double, long, CancellationToken>, int, ExceptionHandler, ComplexDelayHandler, ReliableAction<int, string, double, long>> factory)
        {
            Action<int, string, double, long, CancellationToken> action = (arg1, arg2, arg3, arg4, token) => Operation.Null();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ComplexDelayHandler delayHandler = (i, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long> actual = factory(action, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void CtorAction(ReliableAction<int, string, double, long> reliableAction, ActionProxy<int, string, double, long> expected)
        ...
        private void CtorAction(ReliableAction<int, string, double, long> reliableAction, Action<int, string, double, long, CancellationToken> expected)
            => CtorAction(reliableAction, (Action<int, string, double, long, CancellationToken> actual) => Assert.AreSame(expected, actual));

        private void CtorAction(ReliableAction<int, string, double, long> reliableAction, Action<Action<int, string, double, long, CancellationToken>> validateAction)
        ...
        {
            Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken> invoke;
            if (passToken)
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                Invoke_Failure         ((r, arg1, arg2, arg3, arg4, t, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, t), e), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, arg3, arg4, t, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, t), e), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, arg3, arg4, t, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, t), e), addEventHandlers);
        ...
        {
            Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken> invokeAsync;
            if (passToken)
                invokeAsync = (r, arg1, arg2, arg3, arg4, t) => r.InvokeAsync(arg1, arg2, arg3, arg4, t).Wait();
            else
                invokeAsync = (r, arg1, arg2, arg3, arg4, t) => r.InvokeAsync(arg1, arg2, arg3, arg4).Wait();
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                Invoke_Failure         ((r, arg1, arg2, arg3, arg4, t, e) => Assert.That.ThrowsException(() => invokeAsync(r, arg1, arg2, arg3, arg4, t), e), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, arg3, arg4, t, e) => Assert.That.ThrowsException(() => invokeAsync(r, arg1, arg2, arg3, arg4, t), e), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, arg3, arg4, t, e) => Assert.That.ThrowsException(() => invokeAsync(r, arg1, arg2, arg3, arg4, t), e), addEventHandlers);
        ...
        {
            Func<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken, bool> tryInvoke;
            if (passToken)
                tryInvoke = (r, arg1, arg2, arg3, arg4, t) => r.TryInvoke(arg1, arg2, arg3, arg4, t);
            else
                tryInvoke = (r, arg1, arg2, arg3, arg4, t) => r.TryInvoke(arg1, arg2, arg3, arg4);

            // Callers may optionally include event handlers
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                Invoke_Success         ((r, arg1, arg2, arg3, arg4, t   ) => Assert.IsTrue (tryInvoke(r, arg1, arg2, arg3, arg4, t)), addEventHandlers);
                Invoke_EventualSuccess ((r, arg1, arg2, arg3, arg4, t   ) => Assert.IsTrue (tryInvoke(r, arg1, arg2, arg3, arg4, t)), addEventHandlers);
                Invoke_Failure         ((r, arg1, arg2, arg3, arg4, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, t)), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, arg3, arg4, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, t)), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, arg3, arg4, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, t)), addEventHandlers);
        ...
        {
            Func<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken, bool> tryInvokeAsync;
            if (passToken)
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                Invoke_Success         ((r, arg1, arg2, arg3, arg4, t   ) => Assert.IsTrue (tryInvokeAsync(r, arg1, arg2, arg3, arg4, t)), addEventHandlers);
                Invoke_EventualSuccess ((r, arg1, arg2, arg3, arg4, t   ) => Assert.IsTrue (tryInvokeAsync(r, arg1, arg2, arg3, arg4, t)), addEventHandlers);
                Invoke_Failure         ((r, arg1, arg2, arg3, arg4, t, e) => Assert.IsFalse(tryInvokeAsync(r, arg1, arg2, arg3, arg4, t)), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, arg3, arg4, t, e) => Assert.IsFalse(tryInvokeAsync(r, arg1, arg2, arg3, arg4, t)), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, arg3, arg4, t, e) => Assert.IsFalse(tryInvokeAsync(r, arg1, arg2, arg3, arg4, t)), addEventHandlers);
        ...
        private void Invoke_Success(Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_Failure(Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create an "unsuccessful" user-defined action
            ActionProxy<int, string, double, long> action = new ActionProxy<int, string, double, long>((arg1, arg2, arg3, arg4) => throw new OutOfMemoryException());
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAction, 42, "foo", 3.14D, 1000L, tokenSource.Token, typeof(OutOfMemoryException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAction, 42, "foo", 3.14D, 1000L, tokenSource.Token, typeof(IOException));
        ...
        private void Invoke_Canceled_Action(Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
            ...
            // Define expectations
            action          .Invoking += Expect.ArgumentsAfterDelay<int, string, double, long, CancellationToken>(Arguments.Validate, Constants.MinDelay);
            exceptionHandler.Invoking += Expect.Exception(typeof(IOException));
            delayHandler    .Invoking += Expect.ExceptionAsc(typeof(IOException));
            retryHandler    .Invoking += Expect.ExceptionAsc(typeof(IOException));
            failedHandler   .Invoking += Expect.Nothing<Exception>();
            ...
            action          .Invoking += (arg1, arg2, arg3, arg4, t, c) =>
            {
                if (c.Calls == 2)
                    tokenSource.Cancel();
            };
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAction<int, string, double, long>, int, string, double, long, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
