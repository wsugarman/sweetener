...
namespace Sweetener.Reliability.Test
{
    partial class InterruptableActionExtensionsTest
    {
        ...
        {
            InterruptableAction<int, string, double, long> nullAction = null;
            InterruptableAction<int, string, double, long> action     = (arg1, arg2, arg3, arg4, token) => Operation.Null();
            ...
            Func<InterruptableAction<int, string, double, long>, int, ExceptionPolicy, DelayPolicy, InterruptableAction<int, string, double, long>> withRetry = (a, r, e, d) => a.WithRetry(r, e, d);
            ...
            WithRetryT4_EventualFailure (withRetry, invoke);
            WithRetryT4_RetriesExhausted(withRetry, invoke);
            WithRetryT4_Canceled_Action (withRetry, invoke);
        ...
        public void WithRetryT4_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAction<int, string, double, long>, int, string, double, long, CancellationToken> invoke;
            Func<InterruptableAction<int, string, double, long>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAction<int, string, double, long>> withRetry = (a, r, e, d) => a.WithRetry(r, e, d);
        ...
        public void WithAsyncRetryT4_DelayPolicy()
        {
            ...
            Func<InterruptableAction<int, string, double, long>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string, double, long>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        public void WithAsyncRetryT4_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken> invoke;
            Func<InterruptableAction<int, string, double, long>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string, double, long>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT4_Success<T>(
            Func<InterruptableAction<int, string, double, long>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT4_Success<T>(
            Func<InterruptableAction<int, string, double, long>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, double, long, CancellationToken> invoke)
            => WithRetryT4_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT4_Success<TDelayPolicy, TAction>(
            Func<InterruptableAction<int, string, double, long>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, double, long, CancellationToken> action = new ActionProxy<int, string, double, long, CancellationToken>((arg1, arg2, arg3, arg4, token) => Operation.Null());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, double, long, CancellationToken> action = new ActionProxy<int, string, double, long, CancellationToken>((arg1, arg2, arg3, arg4, token) => throw new InvalidOperationException());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, double, long, CancellationToken> action = new ActionProxy<int, string, double, long, CancellationToken>((arg1, arg2, arg3, arg4, token) => flakyAction());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, double, long, CancellationToken> action = new ActionProxy<int, string, double, long, CancellationToken>((arg1, arg2, arg3, arg4, token) => throw new IOException());
