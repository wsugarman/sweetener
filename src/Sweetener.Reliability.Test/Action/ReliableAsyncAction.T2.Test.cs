...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAsyncAction<int, string>, AsyncAction<int, string>> s_getAction = DynamicGetter.ForField<ReliableAsyncAction<int, string>, AsyncAction<int, string>>("_action");
        ...
        private void Ctor_DelayPolicy(Func<AsyncAction<int, string>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int, string>> factory)
        {
        ...
        private void Ctor_ComplexDelayPolicy(Func<AsyncAction<int, string>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string>> factory)
        {
            AsyncAction<int, string> action = (arg1, arg2) => Operation.NullAsync();
            ExceptionPolicy    exceptionPolicy    = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string> actual = factory(action, 37, exceptionPolicy, complexDelayPolicy);
            Ctor(actual, action, 37, exceptionPolicy, complexDelayPolicy);
        }

        private void Ctor(ReliableAsyncAction<int, string> reliableAction, AsyncAction<int, string> expectedAction, int expectedMaxRetries, ExceptionPolicy expectedExceptionPolicy, ComplexDelayPolicy expectedDelayPolicy)
        ...
        private void Ctor(ReliableAsyncAction<int, string> reliableAction, AsyncAction<int, string> expectedAction, int expectedMaxRetries, ExceptionPolicy expectedExceptionPolicy, Action<ComplexDelayPolicy> validateDelayPolicy)
        {
        ...
        private void InvokeAsync(AsyncAction<ReliableAsyncAction<int, string>, int, string> invokeAsync)
        {
        ...
        private void Invoke_Success(Action<ReliableAsyncAction<int, string>, int, string> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAsyncAction, 42, "foo");
        ...
        private void Invoke_Failure(Action<ReliableAsyncAction<int, string>, int, string, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAsyncAction, 42, "foo", typeof(InvalidOperationException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAsyncAction<int, string>, int, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAsyncAction<int, string>, int, string, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAsyncAction<int, string>, int, string, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAsyncAction, 42, "foo", typeof(IOException));
        ...
        private void Invoke_Canceled(AsyncAction<ReliableAsyncAction<int, string>, int, string, CancellationToken> invokeAsync, bool addEventHandlers)
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAsyncAction<int, string>, int, string, CancellationToken> assertInvoke, bool addEventHandlers)
        {
