...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAsyncAction<int, string>, InterruptableAsyncAction<int, string>> s_getAction = DynamicGetter.ForField<ReliableAsyncAction<int, string>, InterruptableAsyncAction<int, string>>("_action");
        ...
        {
            AsyncActionProxy<int, string> action = new AsyncActionProxy<int, string>();
            ...
            ReliableAsyncAction<int, string> actual = factory(action.InvokeAsync, 37, exceptionPolicy, delayPolicy.Invoke);

            // Validate wrapped action
            InterruptableAsyncAction<int, string> actualAction = s_getAction(actual);
        ...
        private void Ctor_ComplexDelayPolicy(Func<AsyncAction<int, string>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string>> factory)
        {
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string> actual = factory(action.InvokeAsync, 37, exceptionPolicy, complexDelayPolicy);
        ...
        private void Ctor_Interruptable_DelayPolicy(Func<InterruptableAsyncAction<int, string>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int, string>> factory)
        {
            InterruptableAsyncAction<int, string> action = (arg1, arg2, t) => Operation.NullAsync();
            ExceptionPolicy          exceptionPolicy = ExceptionPolicies.Fatal;
            FuncProxy<int, TimeSpan> delayPolicy     = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<InterruptableAsyncAction<int, string>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string>> factory)
        {
            InterruptableAsyncAction<int, string> action = (arg1, arg2, t) => Operation.NullAsync();
            ExceptionPolicy    exceptionPolicy    = ExceptionPolicies.Fatal;
            ComplexDelayPolicy complexDelayPolicy = (i, e) => TimeSpan.FromHours(1);
