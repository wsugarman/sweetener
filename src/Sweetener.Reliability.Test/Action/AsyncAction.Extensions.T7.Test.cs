...
namespace Sweetener.Reliability.Test
{
    partial class AsyncActionExtensionsTest
    {
        ...
        public void WithAsyncRetryT7_DelayPolicy()
        {
            ...
            AsyncAction<int, string, double, long, ushort, byte, TimeSpan> action     = async (arg1, arg2, arg3, arg4, arg5, arg6, arg7) => await Operation.NullAsync().ConfigureAwait(false);
            ...
            Func<AsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        public void WithAsyncRetryT7_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> invoke;
            Func<AsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT7_Success<T>(
            Func<AsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT7_Success<T>(
            Func<AsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> invoke)
            => WithRetryT7_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT7_Success<TDelayPolicy, TAction>(
            Func<AsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
