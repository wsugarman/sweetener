...
namespace Sweetener.Reliability.Test
{
    ...
    using TestAction                   = Func     <int, string, double, long, ushort, byte, TimeSpan, Task>;
    using InterruptableTestAction      = Func     <int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Task>;
    using TestActionProxy              = FuncProxy<int, string, double, long, ushort, byte, TimeSpan, Task>;
    using InterruptableTestActionProxy = FuncProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Task>;
