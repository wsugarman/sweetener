...
namespace Sweetener.Reliability.Test
{
    ...
    partial class AsyncActionExtensionsTest
    {
        ...
        public void WithAsyncRetryT8_Async_DelayHandler()
        {
            ...
            TestAction nullTaskAction         = (arg1, arg2, arg3, arg4, arg5, arg6, arg7) => null;
            ...
            Assert.ThrowsExceptionAsync<InvalidOperationException>(() => nullTaskReliableAction(42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30))).Wait();
            ...
            // Test each scenario
            WithRetryT8_Success         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int>());
            WithRetryT8_Failure         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int>());
        ...
        public void WithAsyncRetryT8_Async_ComplexDelayHandler()
        {
            ...
            // Test each scenario
            WithRetryT8_Success         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int, Exception>());
            WithRetryT8_Failure         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int, Exception>());
        ...
        public void WithAsyncRetryT8_Async_WithToken_DelayHandler()
        {
            ...
            // Test an action that returns a null Task
            InterruptableTestAction nullTaskAction         = (arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => null;
            ...
            Assert.ThrowsExceptionAsync<InvalidOperationException>(() => nullTaskReliableAction(42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), CancellationToken.None)).Wait();
