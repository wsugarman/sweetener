...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAsyncAction, AsyncAction> s_getAction = DynamicGetter.ForField<ReliableAsyncAction, AsyncAction>("_action");

        [TestMethod]
        public void Ctor_DelayPolicy()
            => Ctor_DelayPolicy((a, m, d, e) => new ReliableAsyncAction(a, m, d, e));

        [TestMethod]
        public void Ctor_ComplexDelayPolicy()
            => Ctor_ComplexDelayPolicy((a, m, d, e) => new ReliableAsyncAction(a, m, d, e));
        ...
        private void Ctor(ReliableAsyncAction reliableAction, AsyncAction expectedAction, int expectedMaxRetries, ExceptionPolicy expectedExceptionPolicy, ComplexDelayPolicy expectedDelayPolicy)
        ...
        private void Ctor(ReliableAsyncAction reliableAction, AsyncAction expectedAction, int expectedMaxRetries, ExceptionPolicy expectedExceptionPolicy, Action<ComplexDelayPolicy> validateDelayPolicy)
        {
        ...
        private void InvokeAsync(AsyncAction<ReliableAsyncAction> invokeAsync)
        {
        ...
        private void Invoke_Success(Action<ReliableAsyncAction> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAsyncAction);
        ...
        private void Invoke_Failure(Action<ReliableAsyncAction, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAsyncAction, typeof(InvalidOperationException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAsyncAction> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAsyncAction, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAsyncAction, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAsyncAction, typeof(IOException));
        ...
        private void Invoke_Canceled(AsyncAction<ReliableAsyncAction, CancellationToken> invokeAsync, bool addEventHandlers)
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAsyncAction, CancellationToken> assertInvoke, bool addEventHandlers)
        {
