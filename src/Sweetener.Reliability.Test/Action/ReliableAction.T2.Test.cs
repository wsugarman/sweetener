...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction2Test : ReliableDelegateTest
    {
        ...
        private void Invoke_Canceled(Action<ReliableAction<int, string>, int, string, CancellationToken> assertInvoke, bool addEventHandlers)
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => assertInvoke(reliableAction, 42, "foo", tokenSource.Token));
