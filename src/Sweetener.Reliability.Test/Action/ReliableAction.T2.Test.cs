...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAction<int, string>, Action<int, string, CancellationToken>> s_getAction = DynamicGetter.ForField<ReliableAction<int, string>, Action<int, string, CancellationToken>>("_action");

        [TestMethod]
        public void Ctor_DelayHandler()
            => Ctor_DelayHandler((a, m, d, e) => new ReliableAction<int, string>(a, m, d, e));

        [TestMethod]
        public void Ctor_ComplexDelayHandler()
            => Ctor_ComplexDelayHandler((a, m, d, e) => new ReliableAction<int, string>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_DelayHandler()
            => Ctor_Interruptable_DelayHandler((a, m, d, e) => new ReliableAction<int, string>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayHandler()
            => Ctor_Interruptable_ComplexDelayHandler((a, m, d, e) => new ReliableAction<int, string>(a, m, d, e));
        ...
        private void Ctor_DelayHandler(Func<Action<int, string>, int, ExceptionHandler, DelayHandler, ReliableAction<int, string>> factory)
        {
            ActionProxy<int, string> action = new ActionProxy<int, string>();
...
#nullable enable
            ...
            ReliableAction<int, string> actual = factory(action.Invoke, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_ComplexDelayHandler(Func<Action<int, string>, int, ExceptionHandler, ComplexDelayHandler, ReliableAction<int, string>> factory)
        {
            ActionProxy<int, string> action = new ActionProxy<int, string>();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
...
#nullable enable
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string> actual = factory(action.Invoke, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_Interruptable_DelayHandler(Func<Action<int, string, CancellationToken>, int, ExceptionHandler, DelayHandler, ReliableAction<int, string>> factory)
        {
            Action<int, string, CancellationToken> action = (arg1, arg2, token) => Operation.Null();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            FuncProxy<int, TimeSpan> delayHandler = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
...
#nullable enable
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string> actual = factory(action, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_Interruptable_ComplexDelayHandler(Func<Action<int, string, CancellationToken>, int, ExceptionHandler, ComplexDelayHandler, ReliableAction<int, string>> factory)
        {
            Action<int, string, CancellationToken> action = (arg1, arg2, token) => Operation.Null();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ComplexDelayHandler delayHandler = (i, e) => TimeSpan.FromHours(1);
...
#nullable enable
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string> actual = factory(action, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void CtorAction(ReliableAction<int, string> reliableAction, ActionProxy<int, string> expected)
        ...
        private void CtorAction(ReliableAction<int, string> reliableAction, Action<int, string, CancellationToken> expected)
            => CtorAction(reliableAction, (Action<int, string, CancellationToken> actual) => Assert.AreSame(expected, actual));

        private void CtorAction(ReliableAction<int, string> reliableAction, Action<Action<int, string, CancellationToken>> validateAction)
        ...
        {
            Action<ReliableAction<int, string>, int, string, CancellationToken> invoke;
            if (passToken)
        ...
        {
            Action<ReliableAction<int, string>, int, string, CancellationToken> invokeAsync;
            if (passToken)
                invokeAsync = (r, arg1, arg2, t) => r.InvokeAsync(arg1, arg2, t).Wait();
            else
                invokeAsync = (r, arg1, arg2, t) => r.InvokeAsync(arg1, arg2).Wait();
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                Invoke_Failure         ((r, arg1, arg2, t, e) => Assert.That.ThrowsException(() => invokeAsync(r, arg1, arg2, t), e), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, t, e) => Assert.That.ThrowsException(() => invokeAsync(r, arg1, arg2, t), e), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, t, e) => Assert.That.ThrowsException(() => invokeAsync(r, arg1, arg2, t), e), addEventHandlers);
        ...
        {
            Func<ReliableAction<int, string>, int, string, CancellationToken, bool> tryInvoke;
            if (passToken)
                tryInvoke = (r, arg1, arg2, t) => r.TryInvoke(arg1, arg2, t);
            else
                tryInvoke = (r, arg1, arg2, t) => r.TryInvoke(arg1, arg2);

            // Callers may optionally include event handlers
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                Invoke_Success         ((r, arg1, arg2, t   ) => Assert.IsTrue (tryInvoke(r, arg1, arg2, t)), addEventHandlers);
                Invoke_EventualSuccess ((r, arg1, arg2, t   ) => Assert.IsTrue (tryInvoke(r, arg1, arg2, t)), addEventHandlers);
                Invoke_Failure         ((r, arg1, arg2, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, t)), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, t)), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, t)), addEventHandlers);
        ...
        {
            Func<ReliableAction<int, string>, int, string, CancellationToken, bool> tryInvokeAsync;
            if (passToken)
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                Invoke_Success         ((r, arg1, arg2, t   ) => Assert.IsTrue (tryInvokeAsync(r, arg1, arg2, t)), addEventHandlers);
                Invoke_EventualSuccess ((r, arg1, arg2, t   ) => Assert.IsTrue (tryInvokeAsync(r, arg1, arg2, t)), addEventHandlers);
                Invoke_Failure         ((r, arg1, arg2, t, e) => Assert.IsFalse(tryInvokeAsync(r, arg1, arg2, t)), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, t, e) => Assert.IsFalse(tryInvokeAsync(r, arg1, arg2, t)), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, t, e) => Assert.IsFalse(tryInvokeAsync(r, arg1, arg2, t)), addEventHandlers);
        ...
        private void Invoke_Success(Action<ReliableAction<int, string>, int, string, CancellationToken> assertInvoke, bool addEventHandlers)
        {
            ...
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAction, 42, "foo", tokenSource.Token);
        ...
        private void Invoke_Failure(Action<ReliableAction<int, string>, int, string, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create an "unsuccessful" user-defined action
            ActionProxy<int, string> action = new ActionProxy<int, string>((arg1, arg2) => throw new OutOfMemoryException());
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAction, 42, "foo", tokenSource.Token, typeof(OutOfMemoryException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAction<int, string>, int, string, CancellationToken> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAction<int, string>, int, string, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAction<int, string>, int, string, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAction, 42, "foo", tokenSource.Token, typeof(IOException));
        ...
        private void Invoke_Canceled_Action(Action<ReliableAction<int, string>, int, string, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAction<int, string>, int, string, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
