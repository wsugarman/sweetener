...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction2Test : ReliableDelegateTest
    {
        ...
        public void Ctor_DelayPolicy()
            => Ctor_DelayPolicy((a, m, d, e) => new ReliableAction<int, string>(a, m, d, e));

        [TestMethod]
        public void Ctor_ComplexDelayPolicy()
            => Ctor_ComplexDelayPolicy((a, m, d, e) => new ReliableAction<int, string>(a, m, d, e));
        ...
        public void Invoke_NoCancellationToken()
            => Invoke((r, arg1, arg2) => r.Invoke(arg1, arg2));

        [TestMethod]
        public void Invoke_CancellationToken()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Invoke((r, arg1, arg2) => r.Invoke(arg1, arg2, tokenSource.Token));

            // Ensure CancellationToken prevents additional retry
            Invoke_Canceled((r, arg1, arg2, token) => r.Invoke(arg1, arg2, token), addEventHandlers: false);
            Invoke_Canceled((r, arg1, arg2, token) => r.Invoke(arg1, arg2, token), addEventHandlers: true );
        }

        [TestMethod]
        public void InvokeAsync_NoCancellationToken()
            => InvokeAsync(async (r, arg1, arg2) => await r.InvokeAsync(arg1, arg2).ConfigureAwait(false));

        [TestMethod]
        public void InvokeAsync_CancellationToken()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                InvokeAsync(async (r, arg1, arg2) => await r.InvokeAsync(arg1, arg2, tokenSource.Token).ConfigureAwait(false));

            // Ensure CancellationToken prevents additional retry
            Invoke_Canceled(async (r, arg1, arg2, token) => await r.InvokeAsync(arg1, arg2, token), addEventHandlers: false);
            Invoke_Canceled(async (r, arg1, arg2, token) => await r.InvokeAsync(arg1, arg2, token), addEventHandlers: true );
        }

        [TestMethod]
        public void TryInvoke_NoCancellationToken()
            => TryInvoke((r, arg1, arg2) => r.TryInvoke(arg1, arg2));

        [TestMethod]
        public void TryInvoke_CancellationToken()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                TryInvoke((r, arg1, arg2) => r.TryInvoke(arg1, arg2, tokenSource.Token));

            // Ensure CancellationToken prevents additional retry
            Invoke_Canceled((r, arg1, arg2, token) => r.TryInvoke(arg1, arg2, token), addEventHandlers: false);
            Invoke_Canceled((r, arg1, arg2, token) => r.TryInvoke(arg1, arg2, token), addEventHandlers: true );
        }

        #region Ctor

        private void Ctor_DelayPolicy(Func<Action<int, string>, int, ExceptionPolicy, DelayPolicy, ReliableAction<int, string>> factory)
        {
            ...
            ReliableAction<int, string> actual = factory(action, 37, exceptionPolicy, delayPolicy.Invoke);
        ...
        private void Ctor_ComplexDelayPolicy(Func<Action<int, string>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAction<int, string>> factory)
        {
            Action<int, string> action = (arg1, arg2) => Operation.Null();
            ExceptionPolicy    exceptionPolicy    = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string> actual = factory(action, 37, exceptionPolicy, complexDelayPolicy);
        ...
        private void Invoke(Action<ReliableAction<int, string>, int, string> invoke)
        {
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                Invoke_Failure         ((r, arg1, arg2, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2), e), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2), e), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2), e), addEventHandlers);
            }
        }
        ...
        private void InvokeAsync(AsyncAction<ReliableAction<int, string>, int, string> invokeAsync)
        {
            // Callers may optionally include event handlers
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                Invoke_Success        ((r, arg1, arg2) => invokeAsync(r, arg1, arg2).Wait(), addEventHandlers);
                Invoke_EventualSuccess((r, arg1, arg2) => invokeAsync(r, arg1, arg2).Wait(), addEventHandlers);

                Invoke_Failure         ((r, arg1, arg2, e) => Assert.That.ThrowsException(async () => await invokeAsync(r, arg1, arg2).ConfigureAwait(false), e), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, e) => Assert.That.ThrowsException(async () => await invokeAsync(r, arg1, arg2).ConfigureAwait(false), e), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, e) => Assert.That.ThrowsException(async () => await invokeAsync(r, arg1, arg2).ConfigureAwait(false), e), addEventHandlers);
            }
        }
        ...
        private void TryInvoke(Func<ReliableAction<int, string>, int, string, bool> tryInvoke)
        {
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                Invoke_Success         ((r, arg1, arg2   ) => Assert.IsTrue (tryInvoke(r, arg1, arg2)), addEventHandlers);
                Invoke_EventualSuccess ((r, arg1, arg2   ) => Assert.IsTrue (tryInvoke(r, arg1, arg2)), addEventHandlers);
                Invoke_Failure         ((r, arg1, arg2, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2)), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2)), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2)), addEventHandlers);
            }
        }
        ...
        private void Invoke_Success(Action<ReliableAction<int, string>, int, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_Failure(Action<ReliableAction<int, string>, int, string, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAction, 42, "foo", typeof(InvalidOperationException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAction<int, string>, int, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAction<int, string>, int, string, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAction<int, string>, int, string, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAction, 42, "foo", typeof(IOException));
        ...
        private void Invoke_Canceled(Action<ReliableAction<int, string>, int, string, CancellationToken> invoke, bool addEventHandlers)
            => Invoke_Canceled_Delay((r, arg1, arg2, token) => Assert.That.ThrowsException<OperationCanceledException>(() => invoke(r, arg1, arg2, token)), addEventHandlers);

        // The Async method will expose a "TaskCanceledException" directly
        private void Invoke_Canceled(AsyncAction<ReliableAction<int, string>, int, string, CancellationToken> invokeAsync, bool addEventHandlers)
            => Invoke_Canceled_Delay((r, arg1, arg2, token) => Assert.That.ThrowsException<TaskCanceledException>(async () => await invokeAsync(r, arg1, arg2, token).ConfigureAwait(false)), addEventHandlers);

        private void Invoke_Canceled_Delay(Action<ReliableAction<int, string>, int, string, CancellationToken> assertInvoke, bool addEventHandlers)
        {
