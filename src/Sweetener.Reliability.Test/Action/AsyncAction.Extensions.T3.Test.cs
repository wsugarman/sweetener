...
namespace Sweetener.Reliability.Test
{
    partial class AsyncActionExtensionsTest
    {
        ...
        public void WithAsyncRetryT3_DelayPolicy()
        {
            ...
            AsyncAction<int, string, double> action     = async (arg1, arg2, arg3) => await Operation.NullAsync().ConfigureAwait(false);
            ...
            Func<AsyncAction<int, string, double>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string, double>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
            ...
            // With Token
            invoke = (action, arg1, arg2, arg3, token) => action(arg1, arg2, arg3, token).Wait();
        ...
        public void WithAsyncRetryT3_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string, double>, int, string, double, CancellationToken> invoke;
            Func<AsyncAction<int, string, double>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string, double>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT3_Success<T>(
            Func<AsyncAction<int, string, double>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT3_Success<T>(
            Func<AsyncAction<int, string, double>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, double, CancellationToken> invoke)
            => WithRetryT3_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT3_Success<TDelayPolicy, TAction>(
            Func<AsyncAction<int, string, double>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
