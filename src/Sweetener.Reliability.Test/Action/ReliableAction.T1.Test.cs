...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAction<int>, InterruptableAction<int>> s_getAction = DynamicGetter.ForField<ReliableAction<int>, InterruptableAction<int>>("_action");
        ...
        private void Ctor_DelayPolicy(Func<Action<int>, int, ExceptionPolicy, DelayPolicy, ReliableAction<int>> factory)
        {
            ...
            InterruptableAction<int> actualAction = s_getAction(actual);
        ...
        private void Ctor_ComplexDelayPolicy(Func<Action<int>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAction<int>> factory)
        {
            ...
            // Create a ReliableAction and validate
            ReliableAction<int> actual = factory(action.Invoke, 37, exceptionPolicy, complexDelayPolicy);
        ...
        private void Ctor_Interruptable_DelayPolicy(Func<InterruptableAction<int>, int, ExceptionPolicy, DelayPolicy, ReliableAction<int>> factory)
        {
            InterruptableAction<int> action = (arg, t) => Operation.Null();
            ExceptionPolicy          exceptionPolicy = ExceptionPolicies.Fatal;
            FuncProxy<int, TimeSpan> delayPolicy     = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<InterruptableAction<int>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAction<int>> factory)
        {
            InterruptableAction<int> action = (arg, t) => Operation.Null();
            ExceptionPolicy    exceptionPolicy    = ExceptionPolicies.Fatal;
            ComplexDelayPolicy complexDelayPolicy = (i, e) => TimeSpan.FromHours(1);
