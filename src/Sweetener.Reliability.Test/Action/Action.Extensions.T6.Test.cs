...
namespace Sweetener.Reliability.Test
{
    partial class ActionExtensionsTest
    {
        ...
        public void WithAsyncRetryT6_DelayPolicy()
        {
            ...
            Func<Action<int, string, double, long, ushort, byte>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        public void WithAsyncRetryT6_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string, double, long, ushort, byte>, int, string, double, long, ushort, byte, CancellationToken> invoke;
            Func<Action<int, string, double, long, ushort, byte>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT6_Success<T>(
            Func<Action<int, string, double, long, ushort, byte>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT6_Success<T>(
            Func<Action<int, string, double, long, ushort, byte>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, double, long, ushort, byte, CancellationToken> invoke)
            => WithRetryT6_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT6_Success<TDelayPolicy, TAction>(
            Func<Action<int, string, double, long, ushort, byte>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
