...
namespace Sweetener.Reliability.Test
{
    partial class InterruptableAsyncActionExtensionsTest
    {
        ...
        {
            InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan> nullAction = null;
            InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan> action     = async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => await Operation.NullAsync().ConfigureAwait(false);
            ...
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
            ...
            // With Token
            invoke = (action, arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => action(arg1, arg2, arg3, arg4, arg5, arg6, arg7, token).Wait(token);
            ...
            WithRetryT7_EventualFailure (withAsyncRetry, invoke);
            WithRetryT7_RetriesExhausted(withAsyncRetry, invoke);
            WithRetryT7_Canceled_Action (withAsyncRetry, invoke);
        ...
        public void WithAsyncRetryT7_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> invoke;
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT7_Success<T>(
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT7_Success<T>(
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> invoke)
            => WithRetryT7_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT7_Success<TDelayPolicy, TAction>(
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken> action = new AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken>(async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => await Operation.NullAsync().ConfigureAwait(false));
            ...
            // Define expectations
            action         .Invoking += Expect.Arguments<int, string, double, long, ushort, byte, TimeSpan, CancellationToken>(Arguments.Validate);
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken> action = new AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken>(async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => await Task.Run(() => throw new InvalidOperationException()).ConfigureAwait(false));
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken> action = new AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken>(async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => await Task.Run(flakyAction).ConfigureAwait(false));
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken> action = new AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken>(async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => await Task.Run(() => throw new IOException()).ConfigureAwait(false));
        ...
        private void WithRetryT7_Canceled_Action<T>(
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
            Action<T, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> invoke)
            => WithRetryT7_Canceled_Action(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT7_Canceled_Action<TDelayPolicy, TAction>(
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> invoke,
            Func<TDelayPolicy> delayPolicyFactory)
            where TDelayPolicy : DelegateProxy
