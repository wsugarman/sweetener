...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction5Test : ReliableDelegateTest
    {
        ...
        private void Ctor_DelayPolicy(Func<Func<int, string, double, long, ushort, Task>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int, string, double, long, ushort>> factory)
        {
            ...
            ReliableAsyncAction<int, string, double, long, ushort> actual = factory(action.Invoke, 37, exceptionPolicy, delayPolicy.Invoke);

            // Validate wrapped action
            Func<int, string, double, long, ushort, CancellationToken, Task> actualAction = s_getAction(actual);
        ...
        private void Ctor_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, Task>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string, double, long, ushort>> factory)
        {
            FuncProxy<int, string, double, long, ushort, Task> action = new FuncProxy<int, string, double, long, ushort, Task>();
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double, long, ushort> actual = factory(action.Invoke, 37, exceptionPolicy, delayPolicy);
        ...
        private void Ctor_Interruptable_DelayPolicy(Func<Func<int, string, double, long, ushort, CancellationToken, Task>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int, string, double, long, ushort>> factory)
        {
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, CancellationToken, Task>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string, double, long, ushort>> factory)
        {
            Func<int, string, double, long, ushort, CancellationToken, Task> action = async (arg1, arg2, arg3, arg4, arg5, token) => await Operation.NullAsync().ConfigureAwait(false);
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ComplexDelayPolicy delayPolicy = (i, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double, long, ushort> actual = factory(action, 37, exceptionPolicy, delayPolicy);
