...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction5Test : ReliableDelegateTest
    {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAsyncAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke, bool addEventHandlers, TimeSpan delay, TimeSpan minExpectedDelay)
        {
        ...
        private void Invoke_NoDelay(Action<ReliableAsyncAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke)
