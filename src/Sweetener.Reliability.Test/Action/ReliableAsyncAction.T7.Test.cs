...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Task>> s_getAction = DynamicGetter.ForField<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Task>>("_action");

        [TestMethod]
        public void Ctor_DelayHandler()
            => Ctor_DelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>(a, m, d, e));

        [TestMethod]
        public void Ctor_ComplexDelayHandler()
            => Ctor_ComplexDelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_DelayHandler()
            => Ctor_Interruptable_DelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayHandler()
            => Ctor_Interruptable_ComplexDelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>(a, m, d, e));
...
#nullable enable
        ...
        private void CtorAction(ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan> reliableAction, FuncProxy<int, string, double, long, ushort, byte, TimeSpan, Task> expected)
        ...
        private void CtorAction(ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan> reliableAction, Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Task> expected)
            => CtorAction(reliableAction, (Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Task> actual) => Assert.AreSame(expected, actual));

        private void CtorAction(ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan> reliableAction, Action<Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Task>> validateAction)
        ...
        {
            Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> invokeAsync;
            if (passToken)
...
#nullable enable
        ...
        {
            Func<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, bool> tryInvokeAsync;
            if (passToken)
...
#nullable enable
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                if (passToken)
                {
                    ...
                    Invoke_Canceled_Action((r, arg1, arg2, arg3, arg4, arg5, arg6, arg7, t) => r.TryInvokeAsync(arg1, arg2, arg3, arg4, arg5, arg6, arg7, t).Wait(), addEventHandlers, useSynchronousAction: false);
                    Invoke_Canceled_Action((r, arg1, arg2, arg3, arg4, arg5, arg6, arg7, t) => r.TryInvokeAsync(arg1, arg2, arg3, arg4, arg5, arg6, arg7, t).Wait(), addEventHandlers, useSynchronousAction: true );
        ...
        private void Invoke_Failure(Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, Task> action = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, Task>(async (arg1, arg2, arg3, arg4, arg5, arg6, arg7) => await Task.FromException(new OutOfMemoryException()));
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAsyncAction, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), tokenSource.Token, typeof(OutOfMemoryException));
        ...
        private void Invoke_Canceled(Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> invoke, bool addEventHandlers)
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Task> action = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Task>(
