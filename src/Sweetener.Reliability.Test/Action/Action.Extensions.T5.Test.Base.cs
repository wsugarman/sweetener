...
namespace Sweetener.Reliability.Test
{
    partial class BaseActionExtensionsTest
    {
        ...
        internal void WithRetryT6_Success<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
        ...
        internal void WithRetryT6_Failure<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
            Func<Action<CancellationToken>, TActionProxy> actionFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TAction, int, ExceptionHandler, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, ushort, CancellationToken> invoke,
        ...
        internal void WithRetryT6_EventualSuccess<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
            Func<Action<CancellationToken>, TActionProxy> actionFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TAction, int, ExceptionHandler, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, ushort, CancellationToken> invoke,
        ...
        internal void WithRetryT6_EventualFailure<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
            Func<Action<CancellationToken>, TActionProxy> actionFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TAction, int, ExceptionHandler, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, ushort, CancellationToken> invoke,
        ...
        internal void WithRetryT6_RetriesExhausted<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
            Func<Action<CancellationToken>, TActionProxy> actionFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TAction, int, ExceptionHandler, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, ushort, CancellationToken> invoke,
        ...
        internal void WithRetryT6_Canceled_Delay<TAction, TDelayPolicy, TActionProxy, TDelayPolicyProxy>(
            Func<Action<CancellationToken>, TActionProxy> actionFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TAction, int, ExceptionHandler, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, ushort, CancellationToken> invoke,
