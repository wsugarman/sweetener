...
namespace Sweetener.Reliability.Test
{
    ...
    public partial class AsyncActionExtensionsTest
    {
        ...
        public void WithAsyncRetry_DelayPolicy()
        {
            ...
            AsyncAction action     = async () => await Operation.NullAsync().ConfigureAwait(false);
            ...
            Func<AsyncAction, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
            ...
            // With Token
            invoke = (action, token) => action(token).Wait();
        ...
        public void WithAsyncRetry_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction, CancellationToken> invoke;
            Func<AsyncAction, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetry_Success<T>(
            Func<AsyncAction, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetry_Success<T>(
            Func<AsyncAction, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, CancellationToken> invoke)
            => WithRetry_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetry_Success<TDelayPolicy, TAction>(
            Func<AsyncAction, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
