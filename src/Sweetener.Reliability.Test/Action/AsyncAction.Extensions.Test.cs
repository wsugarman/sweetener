...
#nullable disable
            ...
            TestAction nullTaskAction         = () => null;
            ...
            Assert.ThrowsExceptionAsync<InvalidOperationException>(() => nullTaskReliableAction()).Wait();
...
#nullable enable
            ...
            // Test each scenario
            WithRetryT1_Success         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int>());
            WithRetryT1_Failure         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int>());
...
#nullable enable
            ...
            // Test each scenario
            WithRetryT1_Success         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int, Exception>());
            WithRetryT1_Failure         (actionFactory, delayHandlerFactory, withAsyncRetry, invoke, observeAction     ,  d     => d.Invoking += Expect.Nothing<int, Exception>());
...
#nullable disable
            ...
            // Test an action that returns a null Task
            InterruptableTestAction nullTaskAction         = (token) => null;
            ...
            Assert.ThrowsExceptionAsync<InvalidOperationException>(() => nullTaskReliableAction(CancellationToken.None)).Wait();
