...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction12Test : ReliableDelegateTest
    {
        ...
        private void InvokeAsync(bool passToken)
        {
            ...
            Assert.That.ThrowsException<InvalidOperationException>(() => invoke(badAction, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), 112U, Tuple.Create(true, 64UL), new DateTime(2019, 10, 06), 321UL, (sbyte)-7, CancellationToken.None));
