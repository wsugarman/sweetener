...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction9Test : ReliableDelegateTest
    {
        ...
        private void Invoke_Canceled(Action<ReliableAction<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>>, int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, CancellationToken> assertInvoke, bool addEventHandlers)
        {
