...
namespace Sweetener.Reliability.Test
{
    partial class InterruptableAsyncActionExtensionsTest
    {
        ...
        {
            InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint> nullAction = null;
            InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint> action     = async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => await Operation.NullAsync().ConfigureAwait(false);
            ...
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        public void WithAsyncRetryT8_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> invoke;
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT8_Success<T>(
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT8_Success<T>(
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> invoke)
            => WithRetryT8_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT8_Success<TDelayPolicy, TAction>(
            Func<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> action = new AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken>(async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => await Operation.NullAsync().ConfigureAwait(false));
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> action = new AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken>(async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => await Task.Run(() => throw new InvalidOperationException()).ConfigureAwait(false));
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> action = new AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken>(async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => await Task.Run(flakyAction).ConfigureAwait(false));
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> action = new AsyncActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken>(async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => await Task.Run(() => throw new IOException()).ConfigureAwait(false));
