...
namespace Sweetener.Reliability.Test
{
    partial class InterruptableAsyncActionExtensionsTest
    {
        ...
        {
            InterruptableAsyncAction<int, string> nullAction = null;
            InterruptableAsyncAction<int, string> action     = async (arg1, arg2, token) => await Operation.NullAsync().ConfigureAwait(false);
            ...
            Func<InterruptableAsyncAction<int, string>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
            ...
            // With Token
            invoke = (action, arg1, arg2, token) => action(arg1, arg2, token).Wait(token);
            ...
            WithRetryT2_EventualFailure (withAsyncRetry, invoke);
            WithRetryT2_RetriesExhausted(withAsyncRetry, invoke);
            WithRetryT2_Canceled_Action (withAsyncRetry, invoke);
        ...
        public void WithAsyncRetryT2_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string>, int, string, CancellationToken> invoke;
            Func<InterruptableAsyncAction<int, string>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT2_Success<T>(
            Func<InterruptableAsyncAction<int, string>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT2_Success<T>(
            Func<InterruptableAsyncAction<int, string>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, CancellationToken> invoke)
            => WithRetryT2_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT2_Success<TDelayPolicy, TAction>(
            Func<InterruptableAsyncAction<int, string>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, CancellationToken> action = new AsyncActionProxy<int, string, CancellationToken>(async (arg1, arg2, token) => await Operation.NullAsync().ConfigureAwait(false));
            ...
            // Define expectations
            action         .Invoking += Expect.Arguments<int, string, CancellationToken>(Arguments.Validate);
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, CancellationToken> action = new AsyncActionProxy<int, string, CancellationToken>(async (arg1, arg2, token) => await Task.Run(() => throw new InvalidOperationException()).ConfigureAwait(false));
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, CancellationToken> action = new AsyncActionProxy<int, string, CancellationToken>(async (arg1, arg2, token) => await Task.Run(flakyAction).ConfigureAwait(false));
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, CancellationToken> action = new AsyncActionProxy<int, string, CancellationToken>(async (arg1, arg2, token) => await Task.Run(() => throw new IOException()).ConfigureAwait(false));
        ...
        private void WithRetryT2_Canceled_Action<T>(
            Func<InterruptableAsyncAction<int, string>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
            Action<T, int, string, CancellationToken> invoke)
            => WithRetryT2_Canceled_Action(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT2_Canceled_Action<TDelayPolicy, TAction>(
            Func<InterruptableAsyncAction<int, string>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, CancellationToken> invoke,
            Func<TDelayPolicy> delayPolicyFactory)
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, CancellationToken> action = new AsyncActionProxy<int, string, CancellationToken>(async (arg1, arg2, token) =>
            {
