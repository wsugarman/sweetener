...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAsyncAction<int>, InterruptableAsyncAction<int>> s_getAction = DynamicGetter.ForField<ReliableAsyncAction<int>, InterruptableAsyncAction<int>>("_action");
        ...
        {
            AsyncActionProxy<int> action = new AsyncActionProxy<int>();
            ...
            ReliableAsyncAction<int> actual = factory(action.InvokeAsync, 37, exceptionPolicy, delayPolicy.Invoke);

            // Validate wrapped action
            InterruptableAsyncAction<int> actualAction = s_getAction(actual);
        ...
        private void Ctor_ComplexDelayPolicy(Func<AsyncAction<int>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int>> factory)
        {
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int> actual = factory(action.InvokeAsync, 37, exceptionPolicy, complexDelayPolicy);
        ...
        private void Ctor_Interruptable_DelayPolicy(Func<InterruptableAsyncAction<int>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int>> factory)
        {
            InterruptableAsyncAction<int> action = (arg, t) => Operation.NullAsync();
            ExceptionPolicy          exceptionPolicy = ExceptionPolicies.Fatal;
            FuncProxy<int, TimeSpan> delayPolicy     = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<InterruptableAsyncAction<int>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int>> factory)
        {
            InterruptableAsyncAction<int> action = (arg, t) => Operation.NullAsync();
            ExceptionPolicy    exceptionPolicy    = ExceptionPolicies.Fatal;
            ComplexDelayPolicy complexDelayPolicy = (i, e) => TimeSpan.FromHours(1);
