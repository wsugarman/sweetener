...
namespace Sweetener.Reliability.Test
{
    partial class InterruptableActionExtensionsTest
    {
        ...
        {
            InterruptableAction<int> nullAction = null;
            InterruptableAction<int> action     = (arg, token) => Operation.Null();
            ...
            Func<InterruptableAction<int>, int, ExceptionPolicy, DelayPolicy, InterruptableAction<int>> withRetry = (a, r, e, d) => a.WithRetry(r, e, d);
            ...
            WithRetryT1_EventualFailure (withRetry, invoke);
            WithRetryT1_RetriesExhausted(withRetry, invoke);
            WithRetryT1_Canceled_Action (withRetry, invoke);
        ...
        public void WithRetryT1_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAction<int>, int, CancellationToken> invoke;
            Func<InterruptableAction<int>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAction<int>> withRetry = (a, r, e, d) => a.WithRetry(r, e, d);
        ...
        public void WithAsyncRetryT1_DelayPolicy()
        {
            ...
            Func<InterruptableAction<int>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        public void WithAsyncRetryT1_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int>, int, CancellationToken> invoke;
            Func<InterruptableAction<int>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT1_Success<T>(
            Func<InterruptableAction<int>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT1_Success<T>(
            Func<InterruptableAction<int>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, CancellationToken> invoke)
            => WithRetryT1_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT1_Success<TDelayPolicy, TAction>(
            Func<InterruptableAction<int>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, CancellationToken> invoke,
            Func<TDelayPolicy> delayPolicyFactory)
            where TDelayPolicy : DelegateProxy
        {
            // Create a "successful" user-defined action
            ActionProxy<int, CancellationToken> action = new ActionProxy<int, CancellationToken>((arg, token) => Operation.Null());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, CancellationToken> action = new ActionProxy<int, CancellationToken>((arg, token) => throw new InvalidOperationException());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, CancellationToken> action = new ActionProxy<int, CancellationToken>((arg, token) => flakyAction());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, CancellationToken> action = new ActionProxy<int, CancellationToken>((arg, token) => throw new IOException());
