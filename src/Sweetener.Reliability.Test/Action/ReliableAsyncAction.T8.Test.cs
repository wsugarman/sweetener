...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction8Test : ReliableDelegateTest
    {
        ...
        private void InvokeAsync(bool passToken)
        {
            ...
            Assert.That.ThrowsException<InvalidOperationException>(() => invoke(badAction, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), 112U, CancellationToken.None));
