...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction8Test : ReliableDelegateTest
    {
        ...
        private void InvokeAsync(bool passToken)
        {
            ...
            Invoke_NoDelay((r, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, t, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, t), e));
        }
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Type> assertInvoke, bool addEventHandlers, TimeSpan delay, TimeSpan minExpectedDelay)
        {
        ...
        private void Invoke_NoDelay(Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Type> assertInvoke)
