...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, AsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>> s_getAction = DynamicGetter.ForField<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, AsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>>("_action");

        [TestMethod]
        public void Ctor_DelayPolicy()
            => Ctor_DelayPolicy((a, m, d, e) => new ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>(a, m, d, e));

        [TestMethod]
        public void Ctor_ComplexDelayPolicy()
            => Ctor_ComplexDelayPolicy((a, m, d, e) => new ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>(a, m, d, e));
        ...
        private void Ctor_DelayPolicy(Func<AsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>> factory)
        {
            ...
            ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint> actual = factory(action, 37, exceptionPolicy, delayPolicy.Invoke);
        ...
        private void Ctor_ComplexDelayPolicy(Func<AsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>> factory)
        {
            AsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint> action = (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) => Operation.NullAsync();
            ExceptionPolicy    exceptionPolicy    = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint> actual = factory(action, 37, exceptionPolicy, complexDelayPolicy);
            Ctor(actual, action, 37, exceptionPolicy, complexDelayPolicy);
        }

        private void Ctor(ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint> reliableAction, AsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint> expectedAction, int expectedMaxRetries, ExceptionPolicy expectedExceptionPolicy, ComplexDelayPolicy expectedDelayPolicy)
        ...
        private void Ctor(ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint> reliableAction, AsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint> expectedAction, int expectedMaxRetries, ExceptionPolicy expectedExceptionPolicy, Action<ComplexDelayPolicy> validateDelayPolicy)
        {
        ...
        private void InvokeAsync(AsyncAction<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint> invokeAsync)
        {
        ...
        private void Invoke_Success(Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAsyncAction, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), 112U);
        ...
        private void Invoke_Failure(Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAsyncAction, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), 112U, typeof(InvalidOperationException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAsyncAction, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), 112U, typeof(IOException));
        ...
        private void Invoke_Canceled(AsyncAction<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> invokeAsync, bool addEventHandlers)
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> assertInvoke, bool addEventHandlers)
        {
