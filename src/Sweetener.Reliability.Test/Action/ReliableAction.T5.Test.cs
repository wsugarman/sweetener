...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAction<int, string, double, long, ushort>, Action<int, string, double, long, ushort, CancellationToken>> s_getAction = DynamicGetter.ForField<ReliableAction<int, string, double, long, ushort>, Action<int, string, double, long, ushort, CancellationToken>>("_action");

        [TestMethod]
        public void Ctor_DelayHandler()
            => Ctor_DelayHandler((a, m, d, e) => new ReliableAction<int, string, double, long, ushort>(a, m, d, e));

        [TestMethod]
        public void Ctor_ComplexDelayHandler()
            => Ctor_ComplexDelayHandler((a, m, d, e) => new ReliableAction<int, string, double, long, ushort>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_DelayHandler()
            => Ctor_Interruptable_DelayHandler((a, m, d, e) => new ReliableAction<int, string, double, long, ushort>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayHandler()
            => Ctor_Interruptable_ComplexDelayHandler((a, m, d, e) => new ReliableAction<int, string, double, long, ushort>(a, m, d, e));
        ...
        private void Ctor_DelayHandler(Func<Action<int, string, double, long, ushort>, int, ExceptionHandler, DelayHandler, ReliableAction<int, string, double, long, ushort>> factory)
        {
            ActionProxy<int, string, double, long, ushort> action = new ActionProxy<int, string, double, long, ushort>();
            ...
            ReliableAction<int, string, double, long, ushort> actual = factory(action.Invoke, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_ComplexDelayHandler(Func<Action<int, string, double, long, ushort>, int, ExceptionHandler, ComplexDelayHandler, ReliableAction<int, string, double, long, ushort>> factory)
        {
            ActionProxy<int, string, double, long, ushort> action = new ActionProxy<int, string, double, long, ushort>();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long, ushort> actual = factory(action.Invoke, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_Interruptable_DelayHandler(Func<Action<int, string, double, long, ushort, CancellationToken>, int, ExceptionHandler, DelayHandler, ReliableAction<int, string, double, long, ushort>> factory)
        {
            Action<int, string, double, long, ushort, CancellationToken> action = (arg1, arg2, arg3, arg4, arg5, token) => Operation.Null();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            FuncProxy<int, TimeSpan> delayHandler = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
            Assert.ThrowsException<ArgumentNullException      >(() => factory(null, Retries.Infinite, exceptionHandler, delayHandler.Invoke));
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long, ushort> actual = factory(action, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_Interruptable_ComplexDelayHandler(Func<Action<int, string, double, long, ushort, CancellationToken>, int, ExceptionHandler, ComplexDelayHandler, ReliableAction<int, string, double, long, ushort>> factory)
        {
            Action<int, string, double, long, ushort, CancellationToken> action = (arg1, arg2, arg3, arg4, arg5, token) => Operation.Null();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ComplexDelayHandler delayHandler = (i, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long, ushort> actual = factory(action, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void CtorAction(ReliableAction<int, string, double, long, ushort> reliableAction, ActionProxy<int, string, double, long, ushort> expected)
        ...
        private void CtorAction(ReliableAction<int, string, double, long, ushort> reliableAction, Action<int, string, double, long, ushort, CancellationToken> expected)
            => CtorAction(reliableAction, (Action<int, string, double, long, ushort, CancellationToken> actual) => Assert.AreSame(expected, actual));

        private void CtorAction(ReliableAction<int, string, double, long, ushort> reliableAction, Action<Action<int, string, double, long, ushort, CancellationToken>> validateAction)
        ...
        {
            Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken> invoke;
            if (passToken)
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                Invoke_Failure         ((r, arg1, arg2, arg3, arg4, arg5, t, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, arg5, t), e), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, arg3, arg4, arg5, t, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, arg5, t), e), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, arg3, arg4, arg5, t, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, arg5, t), e), addEventHandlers);
            ...
            Invoke_NoDelay((r, arg1, arg2, arg3, arg4, arg5, t, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, arg5, t), e));
        }
        ...
        private void InvokeAsync(bool passToken)
        {
            Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken> invoke;
            if (passToken)
                invoke = (r, arg1, arg2, arg3, arg4, arg5, t) => r.InvokeAsync(arg1, arg2, arg3, arg4, arg5, t).Wait();
            else
                invoke = (r, arg1, arg2, arg3, arg4, arg5, t) => r.InvokeAsync(arg1, arg2, arg3, arg4, arg5).Wait();
        ...
        {
            Func<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken, bool> tryInvoke;
            if (passToken)
                tryInvoke = (r, arg1, arg2, arg3, arg4, arg5, t) => r.TryInvoke(arg1, arg2, arg3, arg4, arg5, t);
            else
                tryInvoke = (r, arg1, arg2, arg3, arg4, arg5, t) => r.TryInvoke(arg1, arg2, arg3, arg4, arg5);

            // Callers may optionally include event handlers
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                Invoke_Success         ((r, arg1, arg2, arg3, arg4, arg5, t   ) => Assert.IsTrue (tryInvoke(r, arg1, arg2, arg3, arg4, arg5, t)), addEventHandlers);
                Invoke_EventualSuccess ((r, arg1, arg2, arg3, arg4, arg5, t   ) => Assert.IsTrue (tryInvoke(r, arg1, arg2, arg3, arg4, arg5, t)), addEventHandlers);
                Invoke_Failure         ((r, arg1, arg2, arg3, arg4, arg5, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, arg5, t)), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, arg3, arg4, arg5, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, arg5, t)), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, arg3, arg4, arg5, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, arg5, t)), addEventHandlers);
            ...
            // Test retrying without a delay
            Invoke_NoDelay((r, arg1, arg2, arg3, arg4, arg5, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, arg5, t)));
        }
        ...
        private void Invoke_Success(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_Failure(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAction, 42, "foo", 3.14D, 1000L, (ushort)1, tokenSource.Token, typeof(InvalidOperationException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke, bool addEventHandlers)
            => Invoke_RetriesExhausted(assertInvoke, addEventHandlers, Constants.Delay, Constants.MinDelay);

        private void Invoke_RetriesExhausted(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke, bool addEventHandlers, TimeSpan delay, TimeSpan minExpectedDelay)
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAction, 42, "foo", 3.14D, 1000L, (ushort)1, tokenSource.Token, typeof(IOException));
        ...
        private void Invoke_Canceled_Action(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
        ...
        private void Invoke_NoDelay(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke)
