...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAction<int, string, double, long, ushort>, InterruptableAction<int, string, double, long, ushort>> s_getAction = DynamicGetter.ForField<ReliableAction<int, string, double, long, ushort>, InterruptableAction<int, string, double, long, ushort>>("_action");
        ...
        private void Ctor_DelayPolicy(Func<Action<int, string, double, long, ushort>, int, ExceptionPolicy, DelayPolicy, ReliableAction<int, string, double, long, ushort>> factory)
        {
            ...
            InterruptableAction<int, string, double, long, ushort> actualAction = s_getAction(actual);
            action.Invoking += Expect.Arguments<int, string, double, long, ushort>(Arguments.Validate);
            Assert.AreEqual(0, action.Calls);
            actualAction(42, "foo", 3.14D, 1000L, (ushort)1);
        ...
        private void Ctor_ComplexDelayPolicy(Func<Action<int, string, double, long, ushort>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAction<int, string, double, long, ushort>> factory)
        {
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long, ushort> actual = factory(action.Invoke, 37, exceptionPolicy, complexDelayPolicy);
        ...
        private void Ctor_Interruptable_DelayPolicy(Func<InterruptableAction<int, string, double, long, ushort>, int, ExceptionPolicy, DelayPolicy, ReliableAction<int, string, double, long, ushort>> factory)
        {
            InterruptableAction<int, string, double, long, ushort> action = (arg1, arg2, arg3, arg4, arg5, t) => Operation.Null();
            ExceptionPolicy          exceptionPolicy = ExceptionPolicies.Fatal;
            FuncProxy<int, TimeSpan> delayPolicy     = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<InterruptableAction<int, string, double, long, ushort>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAction<int, string, double, long, ushort>> factory)
        {
            InterruptableAction<int, string, double, long, ushort> action = (arg1, arg2, arg3, arg4, arg5, t) => Operation.Null();
            ExceptionPolicy    exceptionPolicy    = ExceptionPolicies.Fatal;
            ComplexDelayPolicy complexDelayPolicy = (i, e) => TimeSpan.FromHours(1);
