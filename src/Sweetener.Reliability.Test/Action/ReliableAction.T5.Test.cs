...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction5Test : ReliableDelegateTest
    {
        ...
        public void Ctor_DelayPolicy()
        {
            ...
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableAction<int, string, double, long, ushort>(null  , Retries.Infinite, exceptionPolicy, delayPolicy.Invoke));
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new ReliableAction<int, string, double, long, ushort>(action, -2              , exceptionPolicy, delayPolicy.Invoke));
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableAction<int, string, double, long, ushort>(action, Retries.Infinite, null           , delayPolicy.Invoke));
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableAction<int, string, double, long, ushort>(action, Retries.Infinite, exceptionPolicy, (DelayPolicy)null ));

            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long, ushort> actual = new ReliableAction<int, string, double, long, ushort>(action, 37, exceptionPolicy, delayPolicy.Invoke);
        ...
        public void Ctor_ComplexDelayPolicy()
        {
            ...
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableAction<int, string, double, long, ushort>(null  , Retries.Infinite, exceptionPolicy, complexDelayPolicy));
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new ReliableAction<int, string, double, long, ushort>(action, -2              , exceptionPolicy, complexDelayPolicy));
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableAction<int, string, double, long, ushort>(action, Retries.Infinite, null           , complexDelayPolicy));
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableAction<int, string, double, long, ushort>(action, Retries.Infinite, exceptionPolicy, (ComplexDelayPolicy)null));

            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long, ushort> actual = new ReliableAction<int, string, double, long, ushort>(action, 37, exceptionPolicy, complexDelayPolicy);
        ...
        public void Invoke_CancellationToken()
        {
            ...
            Invoke_Canceled((r, arg1, arg2, arg3, arg4, arg5, token) => r.Invoke(arg1, arg2, arg3, arg4, arg5, token));
        }
        ...
        public void TryInvoke_CancellationToken()
        {
            ...
            // Ensure CancellationToken prevents additional retry
            Invoke_Canceled((r, arg1, arg2, arg3, arg4, arg5, token) => r.TryInvoke(arg1, arg2, arg3, arg4, arg5, token));
        }
        ...
        private void Invoke(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort> invoke)
        {
            ...
            Invoke_Failure         ((r, arg1, arg2, arg3, arg4, arg5, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, arg5), e));
            Invoke_EventualFailure ((r, arg1, arg2, arg3, arg4, arg5, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, arg5), e));
            Invoke_RetriesExhausted((r, arg1, arg2, arg3, arg4, arg5, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3, arg4, arg5), e));
        }
        ...
        private void TryInvoke(Func<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, bool> tryInvoke)
        {
            ...
            Invoke_Failure         ((r, arg1, arg2, arg3, arg4, arg5, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, arg5)));
            Invoke_EventualFailure ((r, arg1, arg2, arg3, arg4, arg5, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, arg5)));
            Invoke_RetriesExhausted((r, arg1, arg2, arg3, arg4, arg5, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, arg5)));
        }
        ...
        private void Invoke_Failure(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, Type> assertInvoke)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, Type> assertInvoke)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, Type> assertInvoke)
        {
        ...
        private void Invoke_Canceled(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken> assertInvoke)
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => assertInvoke(reliableAction, 42, "foo", 3.14D, 1000L, (ushort)1, tokenSource.Token));
