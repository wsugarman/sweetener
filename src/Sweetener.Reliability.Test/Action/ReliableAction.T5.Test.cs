...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction5Test : ReliableDelegateTest
    {
        ...
        private void Invoke_Canceled(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken> assertInvoke, bool addEventHandlers)
        {
