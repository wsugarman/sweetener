...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction5Test : ReliableDelegateTest
    {
        ...
        public void Ctor_Interruptable_DelayPolicy()
            => Ctor_Interruptable_DelayPolicy((a, m, d, e) => new ReliableAction<int, string, double, long, ushort>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayPolicy()
            => Ctor_Interruptable_ComplexDelayPolicy((a, m, d, e) => new ReliableAction<int, string, double, long, ushort>(a, m, d, e));
        ...
        private void Ctor_DelayPolicy(Func<Action<int, string, double, long, ushort>, int, ExceptionPolicy, DelayPolicy, ReliableAction<int, string, double, long, ushort>> factory)
        {
            ...
            ReliableAction<int, string, double, long, ushort> actual = factory(action.Invoke, 37, exceptionPolicy, delayPolicy.Invoke);
        ...
        private void Ctor_ComplexDelayPolicy(Func<Action<int, string, double, long, ushort>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAction<int, string, double, long, ushort>> factory)
        {
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long, ushort> actual = factory(action.Invoke, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorAction(actual, action);
        }

        private void Ctor_Interruptable_DelayPolicy(Func<Action<int, string, double, long, ushort, CancellationToken>, int, ExceptionPolicy, DelayPolicy, ReliableAction<int, string, double, long, ushort>> factory)
        {
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<Action<int, string, double, long, ushort, CancellationToken>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAction<int, string, double, long, ushort>> factory)
        {
            Action<int, string, double, long, ushort, CancellationToken> action = (arg1, arg2, arg3, arg4, arg5, token) => Operation.Null();
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ComplexDelayPolicy delayPolicy = (i, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string, double, long, ushort> actual = factory(action, 37, exceptionPolicy, delayPolicy);
