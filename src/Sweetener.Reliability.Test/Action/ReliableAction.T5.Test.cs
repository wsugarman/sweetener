...
#nullable enable
        ...
        {
            Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken> invokeAsync;
            if (passToken)
        ...
        {
            Func<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken, bool> tryInvokeAsync;
            if (passToken)
        ...
        private void Invoke_Failure(Action<ReliableAction<int, string, double, long, ushort>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            ActionProxy<int, string, double, long, ushort> action = new ActionProxy<int, string, double, long, ushort>((arg1, arg2, arg3, arg4, arg5) => throw new OutOfMemoryException());
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAction, 42, "foo", 3.14D, 1000L, (ushort)1, tokenSource.Token, typeof(OutOfMemoryException));
