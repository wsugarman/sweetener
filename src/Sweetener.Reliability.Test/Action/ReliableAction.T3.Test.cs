...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction3Test : ReliableDelegateTest
    {
        ...
        {
            Action<ReliableAction<int, string, double>, int, string, double, CancellationToken> invokeAsync;
            if (passToken)
        ...
        {
            Func<ReliableAction<int, string, double>, int, string, double, CancellationToken, bool> tryInvokeAsync;
            if (passToken)
                tryInvokeAsync = (r, arg1, arg2, arg3, t) => r.TryInvoke(arg1, arg2, arg3, t);
            else
                tryInvokeAsync = (r, arg1, arg2, arg3, t) => r.TryInvoke(arg1, arg2, arg3);
        ...
        private void Invoke_Failure(Action<ReliableAction<int, string, double>, int, string, double, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            ActionProxy<int, string, double> action = new ActionProxy<int, string, double>((arg1, arg2, arg3) => throw new OutOfMemoryException());
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAction, 42, "foo", 3.14D, tokenSource.Token, typeof(OutOfMemoryException));
