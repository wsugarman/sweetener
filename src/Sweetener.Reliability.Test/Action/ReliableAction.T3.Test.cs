...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction3Test : ReliableDelegateTest
    {
        ...
        public void Invoke_CancellationToken()
        {
            ...
            Invoke_Canceled((r, arg1, arg2, arg3, token) => r.Invoke(arg1, arg2, arg3, token), addEventHandlers: false);
            Invoke_Canceled((r, arg1, arg2, arg3, token) => r.Invoke(arg1, arg2, arg3, token), addEventHandlers: true );
        }
        ...
        public void TryInvoke_CancellationToken()
        {
            ...
            // Ensure CancellationToken prevents additional retry
            Invoke_Canceled((r, arg1, arg2, arg3, token) => r.TryInvoke(arg1, arg2, arg3, token), addEventHandlers: false);
            Invoke_Canceled((r, arg1, arg2, arg3, token) => r.TryInvoke(arg1, arg2, arg3, token), addEventHandlers: true );
        }
        ...
        private void Invoke(Action<ReliableAction<int, string, double>, int, string, double> invoke)
        {
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                Invoke_Failure         ((r, arg1, arg2, arg3, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3), e), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, arg3, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3), e), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, arg3, e) => Assert.That.ThrowsException(() => invoke(r, arg1, arg2, arg3), e), addEventHandlers);
            }
        }
        ...
        private void InvokeAsync(AsyncAction<ReliableAction<int, string, double>, int, string, double> invokeAsync)
        {
            // Callers may optionally include event handlers
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
        ...
        private void TryInvoke(Func<ReliableAction<int, string, double>, int, string, double, bool> tryInvoke)
        {
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                Invoke_Success         ((r, arg1, arg2, arg3   ) => Assert.IsTrue (tryInvoke(r, arg1, arg2, arg3)), addEventHandlers);
                Invoke_EventualSuccess ((r, arg1, arg2, arg3   ) => Assert.IsTrue (tryInvoke(r, arg1, arg2, arg3)), addEventHandlers);
                Invoke_Failure         ((r, arg1, arg2, arg3, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3)), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, arg3, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3)), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, arg3, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3)), addEventHandlers);
            }
        }
        ...
        private void Invoke_Success(Action<ReliableAction<int, string, double>, int, string, double> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_Failure(Action<ReliableAction<int, string, double>, int, string, double, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualSuccess(Action<ReliableAction<int, string, double>, int, string, double> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAction<int, string, double>, int, string, double, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAction<int, string, double>, int, string, double, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_Canceled(AsyncAction<ReliableAction<int, string, double>, int, string, double, CancellationToken> invokeAsync, bool addEventHandlers)
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAction<int, string, double>, int, string, double, CancellationToken> assertInvoke, bool addEventHandlers)
        {
