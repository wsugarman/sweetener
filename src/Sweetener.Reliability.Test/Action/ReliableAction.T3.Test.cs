...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAction<int, string, double>, InterruptableAction<int, string, double>> s_getAction = DynamicGetter.ForField<ReliableAction<int, string, double>, InterruptableAction<int, string, double>>("_action");
        ...
        private void Ctor_DelayPolicy(Func<Action<int, string, double>, int, ExceptionPolicy, DelayPolicy, ReliableAction<int, string, double>> factory)
        {
            ...
            InterruptableAction<int, string, double> actualAction = s_getAction(actual);
        ...
        private void Ctor_ComplexDelayPolicy(Func<Action<int, string, double>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAction<int, string, double>> factory)
        {
            ...
            // Create a ReliableAction and validate
            ReliableAction<int, string, double> actual = factory(action.Invoke, 37, exceptionPolicy, complexDelayPolicy);
        ...
        private void Ctor_Interruptable_DelayPolicy(Func<InterruptableAction<int, string, double>, int, ExceptionPolicy, DelayPolicy, ReliableAction<int, string, double>> factory)
        {
            InterruptableAction<int, string, double> action = (arg1, arg2, arg3, t) => Operation.Null();
            ExceptionPolicy          exceptionPolicy = ExceptionPolicies.Fatal;
            FuncProxy<int, TimeSpan> delayPolicy     = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<InterruptableAction<int, string, double>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAction<int, string, double>> factory)
        {
            InterruptableAction<int, string, double> action = (arg1, arg2, arg3, t) => Operation.Null();
            ExceptionPolicy    exceptionPolicy    = ExceptionPolicies.Fatal;
            ComplexDelayPolicy complexDelayPolicy = (i, e) => TimeSpan.FromHours(1);
