...
namespace Sweetener.Reliability.Test
{
    partial class ActionExtensionsTest
    {
        ...
        public void WithAsyncRetryT9_DelayPolicy()
        {
            ...
            Func<Action<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        public void WithAsyncRetryT9_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>>, int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, CancellationToken> invoke;
            Func<Action<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT9_Success<T>(
            Func<Action<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT9_Success<T>(
            Func<Action<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, CancellationToken> invoke)
            => WithRetryT9_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT9_Success<TDelayPolicy, TAction>(
            Func<Action<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
