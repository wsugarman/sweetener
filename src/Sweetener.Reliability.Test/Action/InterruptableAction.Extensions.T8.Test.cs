...
namespace Sweetener.Reliability.Test
{
    partial class InterruptableActionExtensionsTest
    {
        ...
        {
            InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint> nullAction = null;
            InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint> action     = (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => Operation.Null();
            ...
            Func<InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, DelayPolicy, InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>> withRetry = (a, r, e, d) => a.WithRetry(r, e, d);
            ...
            WithRetryT8_EventualFailure (withRetry, invoke);
            WithRetryT8_RetriesExhausted(withRetry, invoke);
            WithRetryT8_Canceled_Action (withRetry, invoke);
        ...
        public void WithRetryT8_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> invoke;
            Func<InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>> withRetry = (a, r, e, d) => a.WithRetry(r, e, d);
        ...
        public void WithAsyncRetryT8_DelayPolicy()
        {
            ...
            Func<InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
            ...
            // With Token
            invoke = (action, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => action(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token).Wait(token);
            ...
            WithRetryT8_EventualFailure (withAsyncRetry, invoke);
            WithRetryT8_RetriesExhausted(withAsyncRetry, invoke);
            WithRetryT8_Canceled_Action (withAsyncRetry, invoke);
        ...
        public void WithAsyncRetryT8_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> invoke;
            Func<InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string, double, long, ushort, byte, TimeSpan, uint>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT8_Success<T>(
            Func<InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT8_Success<T>(
            Func<InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> invoke)
            => WithRetryT8_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT8_Success<TDelayPolicy, TAction>(
            Func<InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> action = new ActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken>((arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => Operation.Null());
            ...
            // Define expectations
            action         .Invoking += Expect.Arguments<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken>(Arguments.Validate);
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> action = new ActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken>((arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => throw new InvalidOperationException());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> action = new ActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken>((arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => flakyAction());
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            ActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> action = new ActionProxy<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken>((arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => throw new IOException());
        ...
        private void WithRetryT8_Canceled_Action<T>(
            Func<InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
            Action<T, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> invoke)
            => WithRetryT8_Canceled_Action(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT8_Canceled_Action<TDelayPolicy, TAction>(
            Func<InterruptableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> invoke,
            Func<TDelayPolicy> delayPolicyFactory)
            where TDelayPolicy : DelegateProxy
