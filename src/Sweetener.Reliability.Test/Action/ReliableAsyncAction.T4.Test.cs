...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAsyncAction<int, string, double, long>, Func<int, string, double, long, CancellationToken, Task>> s_getAction = DynamicGetter.ForField<ReliableAsyncAction<int, string, double, long>, Func<int, string, double, long, CancellationToken, Task>>("_action");

        [TestMethod]
        public void Ctor_DelayHandler()
            => Ctor_DelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double, long>(a, m, d, e));

        [TestMethod]
        public void Ctor_ComplexDelayHandler()
            => Ctor_ComplexDelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double, long>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_DelayHandler()
            => Ctor_Interruptable_DelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double, long>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayHandler()
            => Ctor_Interruptable_ComplexDelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double, long>(a, m, d, e));
        ...
        private void Ctor_DelayHandler(Func<Func<int, string, double, long, Task>, int, ExceptionHandler, DelayHandler, ReliableAsyncAction<int, string, double, long>> factory)
        {
            FuncProxy<int, string, double, long, Task> action = new FuncProxy<int, string, double, long, Task>();
            ...
            ReliableAsyncAction<int, string, double, long> actual = factory(action.Invoke, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_ComplexDelayHandler(Func<Func<int, string, double, long, Task>, int, ExceptionHandler, ComplexDelayHandler, ReliableAsyncAction<int, string, double, long>> factory)
        {
            FuncProxy<int, string, double, long, Task> action = new FuncProxy<int, string, double, long, Task>();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double, long> actual = factory(action.Invoke, 37, exceptionHandler, delayHandler);
        ...
        private void Ctor_Interruptable_DelayHandler(Func<Func<int, string, double, long, CancellationToken, Task>, int, ExceptionHandler, DelayHandler, ReliableAsyncAction<int, string, double, long>> factory)
        {
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double, long> actual = factory(action, 37, exceptionHandler, delayHandler.Invoke);
        ...
        private void Ctor_Interruptable_ComplexDelayHandler(Func<Func<int, string, double, long, CancellationToken, Task>, int, ExceptionHandler, ComplexDelayHandler, ReliableAsyncAction<int, string, double, long>> factory)
        {
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double, long> actual = factory(action, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void CtorAction(ReliableAsyncAction<int, string, double, long> reliableAction, FuncProxy<int, string, double, long, Task> expected)
        ...
        private void CtorAction(ReliableAsyncAction<int, string, double, long> reliableAction, Func<int, string, double, long, CancellationToken, Task> expected)
            => CtorAction(reliableAction, (Func<int, string, double, long, CancellationToken, Task> actual) => Assert.AreSame(expected, actual));

        private void CtorAction(ReliableAsyncAction<int, string, double, long> reliableAction, Action<Func<int, string, double, long, CancellationToken, Task>> validateAction)
        ...
        {
            Action<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken> invokeAsync;
            if (passToken)
            ...
            ReliableAsyncAction<int, string, double, long> badAction = new ReliableAsyncAction<int, string, double, long>((arg1, arg2, arg3, arg4) => null, Retries.Infinite, ExceptionPolicy.Transient, DelayPolicy.None);
            Assert.That.ThrowsException<InvalidOperationException>(() => invokeAsync(badAction, 42, "foo", 3.14D, 1000L, CancellationToken.None));
        ...
        {
            Func<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken, bool> tryInvokeAsync;
            if (passToken)
            ...
            // Test an action that returns a null Task
            ReliableAsyncAction<int, string, double, long> badAction = new ReliableAsyncAction<int, string, double, long>((arg1, arg2, arg3, arg4) => null, Retries.Infinite, ExceptionPolicy.Transient, DelayPolicy.None);
            Assert.That.ThrowsException<InvalidOperationException>(() => tryInvokeAsync(badAction, 42, "foo", 3.14D, 1000L, CancellationToken.None));
        ...
        private void Invoke_Failure(Action<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            FuncProxy<int, string, double, long, Task> action = new FuncProxy<int, string, double, long, Task>(async (arg1, arg2, arg3, arg4) => await Task.FromException(new OutOfMemoryException()));
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAsyncAction, 42, "foo", 3.14D, 1000L, tokenSource.Token, typeof(OutOfMemoryException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAsyncAction, 42, "foo", 3.14D, 1000L, tokenSource.Token, typeof(IOException));
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
