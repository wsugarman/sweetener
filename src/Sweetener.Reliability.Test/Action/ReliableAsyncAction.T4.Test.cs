...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction4Test : ReliableDelegateTest
    {
        ...
        {
            Action<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken> invoke;
            if (passToken)
            ...
            Assert.That.ThrowsException<InvalidOperationException>(() => invoke(badAction, 42, "foo", 3.14D, 1000L, CancellationToken.None));
