...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction4Test : ReliableDelegateTest
    {
        ...
        private void Invoke_Failure(Action<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAsyncAction, 42, "foo", 3.14D, 1000L, tokenSource.Token, typeof(InvalidOperationException));
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke, bool addEventHandlers, TimeSpan delay, TimeSpan minExpectedDelay)
        {
        ...
        private void Invoke_NoDelay(Action<ReliableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken, Type> assertInvoke)
