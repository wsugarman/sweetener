...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction7Test : ReliableDelegateTest
    {
        ...
        private void InvokeAsync(AsyncAction<ReliableAction<int, string, double, long, ushort, byte, TimeSpan>, int, string, double, long, ushort, byte, TimeSpan> invokeAsync)
        {
            // Callers may optionally include event handlers
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
        ...
        private void Invoke_Canceled(AsyncAction<ReliableAction<int, string, double, long, ushort, byte, TimeSpan>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> invokeAsync, bool addEventHandlers)
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAction<int, string, double, long, ushort, byte, TimeSpan>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> assertInvoke, bool addEventHandlers)
        {
