...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction3Test : ReliableDelegateTest
    {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken, Type> assertInvoke, bool addEventHandlers, TimeSpan delay, TimeSpan minExpectedDelay)
        {
        ...
        private void Invoke_NoDelay(Action<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken, Type> assertInvoke)
