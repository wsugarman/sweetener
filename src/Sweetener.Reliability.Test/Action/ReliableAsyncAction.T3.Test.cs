...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction3Test : ReliableDelegateTest
    {
        ...
        private void Ctor_DelayPolicy(Func<Func<int, string, double, Task>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int, string, double>> factory)
        {
            ...
            ReliableAsyncAction<int, string, double> actual = factory(action.Invoke, 37, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorAction(actual, action);
        }

        private void Ctor_ComplexDelayPolicy(Func<Func<int, string, double, Task>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string, double>> factory)
        {
            FuncProxy<int, string, double, Task> action = new FuncProxy<int, string, double, Task>();
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double> actual = factory(action.Invoke, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorAction(actual, action);
        }

        private void Ctor_Interruptable_DelayPolicy(Func<Func<int, string, double, CancellationToken, Task>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int, string, double>> factory)
        {
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<Func<int, string, double, CancellationToken, Task>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string, double>> factory)
        {
            Func<int, string, double, CancellationToken, Task> action = async (arg1, arg2, arg3, token) => await Operation.NullAsync().ConfigureAwait(false);
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ComplexDelayPolicy delayPolicy = (i, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double> actual = factory(action, 37, exceptionPolicy, delayPolicy);
