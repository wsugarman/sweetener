...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAsyncAction<int, string, double>, InterruptableAsyncAction<int, string, double>> s_getAction = DynamicGetter.ForField<ReliableAsyncAction<int, string, double>, InterruptableAsyncAction<int, string, double>>("_action");
        ...
        public void Ctor_Interruptable_DelayPolicy()
            => Ctor_Interruptable_DelayPolicy((a, m, d, e) => new ReliableAsyncAction<int, string, double>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayPolicy()
            => Ctor_Interruptable_ComplexDelayPolicy((a, m, d, e) => new ReliableAsyncAction<int, string, double>(a, m, d, e));
        ...
        {
            AsyncActionProxy<int, string, double> action = new AsyncActionProxy<int, string, double>();
            ...
            ReliableAsyncAction<int, string, double> actual = factory(action.InvokeAsync, 37, exceptionPolicy, delayPolicy.Invoke);

            // Validate wrapped action
            InterruptableAsyncAction<int, string, double> actualAction = s_getAction(actual);
            action.Invoking += Expect.Arguments<int, string, double>(Arguments.Validate);
            Assert.AreEqual(0, action.Calls);
            actualAction(42, "foo", 3.14D);
        ...
        private void Ctor_ComplexDelayPolicy(Func<AsyncAction<int, string, double>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string, double>> factory)
        {
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double> actual = factory(action.InvokeAsync, 37, exceptionPolicy, complexDelayPolicy);
        ...
        private void Ctor_Interruptable_DelayPolicy(Func<InterruptableAsyncAction<int, string, double>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int, string, double>> factory)
        {
            InterruptableAsyncAction<int, string, double> action = (arg1, arg2, arg3, t) => Operation.NullAsync();
            ExceptionPolicy          exceptionPolicy = ExceptionPolicies.Fatal;
            FuncProxy<int, TimeSpan> delayPolicy     = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<InterruptableAsyncAction<int, string, double>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string, double>> factory)
        {
            InterruptableAsyncAction<int, string, double> action = (arg1, arg2, arg3, t) => Operation.NullAsync();
            ExceptionPolicy    exceptionPolicy    = ExceptionPolicies.Fatal;
            ComplexDelayPolicy complexDelayPolicy = (i, e) => TimeSpan.FromHours(1);
        ...
        {
            Action<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken> invoke;
            if (passToken)
        ...
        private void Invoke_Failure(Action<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            assertInvoke(reliableAsyncAction, 42, "foo", 3.14D, tokenSource.Token, typeof(InvalidOperationException));
