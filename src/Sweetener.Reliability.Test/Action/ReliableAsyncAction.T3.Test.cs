...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAsyncAction<int, string, double>, Func<int, string, double, CancellationToken, Task>> s_getAction = DynamicGetter.ForField<ReliableAsyncAction<int, string, double>, Func<int, string, double, CancellationToken, Task>>("_action");

        [TestMethod]
        public void Ctor_DelayHandler()
            => Ctor_DelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double>(a, m, d, e));

        [TestMethod]
        public void Ctor_ComplexDelayHandler()
            => Ctor_ComplexDelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_DelayHandler()
            => Ctor_Interruptable_DelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double>(a, m, d, e));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayHandler()
            => Ctor_Interruptable_ComplexDelayHandler((a, m, d, e) => new ReliableAsyncAction<int, string, double>(a, m, d, e));
        ...
        private void Ctor_DelayHandler(Func<Func<int, string, double, Task>, int, ExceptionHandler, DelayHandler, ReliableAsyncAction<int, string, double>> factory)
        {
            FuncProxy<int, string, double, Task> action = new FuncProxy<int, string, double, Task>();
            ...
            ReliableAsyncAction<int, string, double> actual = factory(action.Invoke, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void Ctor_ComplexDelayHandler(Func<Func<int, string, double, Task>, int, ExceptionHandler, ComplexDelayHandler, ReliableAsyncAction<int, string, double>> factory)
        {
            FuncProxy<int, string, double, Task> action = new FuncProxy<int, string, double, Task>();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double> actual = factory(action.Invoke, 37, exceptionHandler, delayHandler);
        ...
        private void Ctor_Interruptable_DelayHandler(Func<Func<int, string, double, CancellationToken, Task>, int, ExceptionHandler, DelayHandler, ReliableAsyncAction<int, string, double>> factory)
        {
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double> actual = factory(action, 37, exceptionHandler, delayHandler.Invoke);
        ...
        private void Ctor_Interruptable_ComplexDelayHandler(Func<Func<int, string, double, CancellationToken, Task>, int, ExceptionHandler, ComplexDelayHandler, ReliableAsyncAction<int, string, double>> factory)
        {
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double> actual = factory(action, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorAction(actual, action);
        }

        private void CtorAction(ReliableAsyncAction<int, string, double> reliableAction, FuncProxy<int, string, double, Task> expected)
        ...
        private void CtorAction(ReliableAsyncAction<int, string, double> reliableAction, Func<int, string, double, CancellationToken, Task> expected)
            => CtorAction(reliableAction, (Func<int, string, double, CancellationToken, Task> actual) => Assert.AreSame(expected, actual));

        private void CtorAction(ReliableAsyncAction<int, string, double> reliableAction, Action<Func<int, string, double, CancellationToken, Task>> validateAction)
        ...
        {
            Action<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken> invokeAsync;
            if (passToken)
                invokeAsync = (r, arg1, arg2, arg3, t) => r.InvokeAsync(arg1, arg2, arg3, t).Wait();
            else
                invokeAsync = (r, arg1, arg2, arg3, t) => r.InvokeAsync(arg1, arg2, arg3).Wait();

            // Test an action that returns a null Task
            ReliableAsyncAction<int, string, double> badAction = new ReliableAsyncAction<int, string, double>((arg1, arg2, arg3) => null, Retries.Infinite, ExceptionPolicy.Transient, DelayPolicy.None);
            Assert.That.ThrowsException<InvalidOperationException>(() => invokeAsync(badAction, 42, "foo", 3.14D, CancellationToken.None));
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                Invoke_Failure         ((r, arg1, arg2, arg3, t, e) => Assert.That.ThrowsException(() => invokeAsync(r, arg1, arg2, arg3, t), e), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, arg3, t, e) => Assert.That.ThrowsException(() => invokeAsync(r, arg1, arg2, arg3, t), e), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, arg3, t, e) => Assert.That.ThrowsException(() => invokeAsync(r, arg1, arg2, arg3, t), e), addEventHandlers);
        ...
        {
            Func<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken, bool> tryInvokeAsync;
            if (passToken)
            ...
            // Test an action that returns a null Task
            ReliableAsyncAction<int, string, double> badAction = new ReliableAsyncAction<int, string, double>((arg1, arg2, arg3) => null, Retries.Infinite, ExceptionPolicy.Transient, DelayPolicy.None);
            Assert.That.ThrowsException<InvalidOperationException>(() => tryInvokeAsync(badAction, 42, "foo", 3.14D, CancellationToken.None));

            // Callers may optionally include event handlers
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                Invoke_Success         ((r, arg1, arg2, arg3, t   ) => Assert.IsTrue (tryInvokeAsync(r, arg1, arg2, arg3, t)), addEventHandlers);
                Invoke_EventualSuccess ((r, arg1, arg2, arg3, t   ) => Assert.IsTrue (tryInvokeAsync(r, arg1, arg2, arg3, t)), addEventHandlers);
                Invoke_Failure         ((r, arg1, arg2, arg3, t, e) => Assert.IsFalse(tryInvokeAsync(r, arg1, arg2, arg3, t)), addEventHandlers);
                Invoke_EventualFailure ((r, arg1, arg2, arg3, t, e) => Assert.IsFalse(tryInvokeAsync(r, arg1, arg2, arg3, t)), addEventHandlers);
                Invoke_RetriesExhausted((r, arg1, arg2, arg3, t, e) => Assert.IsFalse(tryInvokeAsync(r, arg1, arg2, arg3, t)), addEventHandlers);
        ...
        private void Invoke_Failure(Action<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            FuncProxy<int, string, double, Task> action = new FuncProxy<int, string, double, Task>(async (arg1, arg2, arg3) => await Task.FromException(new OutOfMemoryException()));
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAsyncAction, 42, "foo", 3.14D, tokenSource.Token, typeof(OutOfMemoryException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure(Action<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableAsyncAction, 42, "foo", 3.14D, tokenSource.Token, typeof(IOException));
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAsyncAction<int, string, double>, int, string, double, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
