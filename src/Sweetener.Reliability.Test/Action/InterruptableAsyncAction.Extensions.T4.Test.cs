...
namespace Sweetener.Reliability.Test
{
    partial class InterruptableAsyncActionExtensionsTest
    {
        ...
        {
            InterruptableAsyncAction<int, string, double, long> nullAction = null;
            InterruptableAsyncAction<int, string, double, long> action     = async (arg1, arg2, arg3, arg4, token) => await Operation.NullAsync().ConfigureAwait(false);
            ...
            Func<InterruptableAsyncAction<int, string, double, long>, int, ExceptionPolicy, DelayPolicy, InterruptableAsyncAction<int, string, double, long>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
            ...
            // With Token
            invoke = (action, arg1, arg2, arg3, arg4, token) => action(arg1, arg2, arg3, arg4, token).Wait(token);
            ...
            WithRetryT4_EventualFailure (withAsyncRetry, invoke);
            WithRetryT4_RetriesExhausted(withAsyncRetry, invoke);
            WithRetryT4_Canceled_Action (withAsyncRetry, invoke);
        ...
        public void WithAsyncRetryT4_ComplexDelayPolicy()
        {
            ...
            Action<InterruptableAsyncAction<int, string, double, long>, int, string, double, long, CancellationToken> invoke;
            Func<InterruptableAsyncAction<int, string, double, long>, int, ExceptionPolicy, ComplexDelayPolicy, InterruptableAsyncAction<int, string, double, long>> withAsyncRetry = (a, r, e, d) => a.WithAsyncRetry(r, e, d);
        ...
        private void WithRetryT4_Success<T>(
            Func<InterruptableAsyncAction<int, string, double, long>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
        ...
        private void WithRetryT4_Success<T>(
            Func<InterruptableAsyncAction<int, string, double, long>, int, ExceptionPolicy, ComplexDelayPolicy, T> withRetry,
            Action<T, int, string, double, long, CancellationToken> invoke)
            => WithRetryT4_Success(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
        ...
        private void WithRetryT4_Success<TDelayPolicy, TAction>(
            Func<InterruptableAsyncAction<int, string, double, long>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, CancellationToken> action = new AsyncActionProxy<int, string, double, long, CancellationToken>(async (arg1, arg2, arg3, arg4, token) => await Operation.NullAsync().ConfigureAwait(false));
            ...
            // Define expectations
            action         .Invoking += Expect.Arguments<int, string, double, long, CancellationToken>(Arguments.Validate);
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, CancellationToken> action = new AsyncActionProxy<int, string, double, long, CancellationToken>(async (arg1, arg2, arg3, arg4, token) => await Task.Run(() => throw new InvalidOperationException()).ConfigureAwait(false));
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, CancellationToken> action = new AsyncActionProxy<int, string, double, long, CancellationToken>(async (arg1, arg2, arg3, arg4, token) => await Task.Run(flakyAction).ConfigureAwait(false));
            ...
            where TDelayPolicy : DelegateProxy
        {
            ...
            AsyncActionProxy<int, string, double, long, CancellationToken> action = new AsyncActionProxy<int, string, double, long, CancellationToken>(async (arg1, arg2, arg3, arg4, token) => await Task.Run(() => throw new IOException()).ConfigureAwait(false));
        ...
        private void WithRetryT4_Canceled_Action<T>(
            Func<InterruptableAsyncAction<int, string, double, long>, int, ExceptionPolicy, DelayPolicy, T> withRetry,
            Action<T, int, string, double, long, CancellationToken> invoke)
            => WithRetryT4_Canceled_Action(
                (a, r, e, d) => withRetry(a, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT4_Canceled_Action<TDelayPolicy, TAction>(
            Func<InterruptableAsyncAction<int, string, double, long>, int, ExceptionPolicy, TDelayPolicy, TAction> withRetry,
            Action<TAction, int, string, double, long, CancellationToken> invoke,
            Func<TDelayPolicy> delayPolicyFactory)
            where TDelayPolicy : DelegateProxy
