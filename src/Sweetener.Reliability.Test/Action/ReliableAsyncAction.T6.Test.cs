...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction6Test : ReliableDelegateTest
    {
        ...
        {
            Action<ReliableAsyncAction<int, string, double, long, ushort, byte>, int, string, double, long, ushort, byte, CancellationToken> invoke;
            if (passToken)
                invoke = (r, arg1, arg2, arg3, arg4, arg5, arg6, t) => r.InvokeAsync(arg1, arg2, arg3, arg4, arg5, arg6, t).Wait();
            else
                invoke = (r, arg1, arg2, arg3, arg4, arg5, arg6, t) => r.InvokeAsync(arg1, arg2, arg3, arg4, arg5, arg6).Wait();
            ...
            Assert.That.ThrowsException<InvalidOperationException>(() => invoke(badAction, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, CancellationToken.None));
