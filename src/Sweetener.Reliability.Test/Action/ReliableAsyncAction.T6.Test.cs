...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncAction6Test : ReliableDelegateTest
    {
        ...
        private void Ctor_DelayPolicy(Func<Func<int, string, double, long, ushort, byte, Task>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int, string, double, long, ushort, byte>> factory)
        {
            ...
            Func<int, string, double, long, ushort, byte, CancellationToken, Task> actualAction = s_getAction(actual);
            action.Invoking += Expect.Arguments<int, string, double, long, ushort, byte>(Arguments.Validate);

            Assert.AreEqual(0, action.Calls);
            actualAction(42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, default);
