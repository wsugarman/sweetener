...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableAsyncAction<int, string, double, long, ushort, byte>, InterruptableAsyncAction<int, string, double, long, ushort, byte>> s_getAction = DynamicGetter.ForField<ReliableAsyncAction<int, string, double, long, ushort, byte>, InterruptableAsyncAction<int, string, double, long, ushort, byte>>("_action");
        ...
        {
            AsyncActionProxy<int, string, double, long, ushort, byte> action = new AsyncActionProxy<int, string, double, long, ushort, byte>();
            ...
            ReliableAsyncAction<int, string, double, long, ushort, byte> actual = factory(action.InvokeAsync, 37, exceptionPolicy, delayPolicy.Invoke);

            // Validate wrapped action
            InterruptableAsyncAction<int, string, double, long, ushort, byte> actualAction = s_getAction(actual);
            action.Invoking += Expect.Arguments<int, string, double, long, ushort, byte>(Arguments.Validate);
            Assert.AreEqual(0, action.Calls);
            actualAction(42, "foo", 3.14D, 1000L, (ushort)1, (byte)255);
        ...
        private void Ctor_ComplexDelayPolicy(Func<AsyncAction<int, string, double, long, ushort, byte>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string, double, long, ushort, byte>> factory)
        {
            ...
            // Create a ReliableAsyncAction and validate
            ReliableAsyncAction<int, string, double, long, ushort, byte> actual = factory(action.InvokeAsync, 37, exceptionPolicy, complexDelayPolicy);
        ...
        private void Ctor_Interruptable_DelayPolicy(Func<InterruptableAsyncAction<int, string, double, long, ushort, byte>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncAction<int, string, double, long, ushort, byte>> factory)
        {
            InterruptableAsyncAction<int, string, double, long, ushort, byte> action = (arg1, arg2, arg3, arg4, arg5, arg6, t) => Operation.NullAsync();
            ExceptionPolicy          exceptionPolicy = ExceptionPolicies.Fatal;
            FuncProxy<int, TimeSpan> delayPolicy     = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<InterruptableAsyncAction<int, string, double, long, ushort, byte>, int, ExceptionPolicy, ComplexDelayPolicy, ReliableAsyncAction<int, string, double, long, ushort, byte>> factory)
        {
            InterruptableAsyncAction<int, string, double, long, ushort, byte> action = (arg1, arg2, arg3, arg4, arg5, arg6, t) => Operation.NullAsync();
            ExceptionPolicy    exceptionPolicy    = ExceptionPolicies.Fatal;
            ComplexDelayPolicy complexDelayPolicy = (i, e) => TimeSpan.FromHours(1);
        ...
        private void Invoke_Canceled_Action(Action<ReliableAsyncAction<int, string, double, long, ushort, byte>, int, string, double, long, ushort, byte, CancellationToken> invoke, bool addEventHandlers)
        {
            ...
            AsyncActionProxy<int, string, double, long, ushort, byte, CancellationToken> action = new AsyncActionProxy<int, string, double, long, ushort, byte, CancellationToken>(async (arg1, arg2, arg3, arg4, arg5, arg6, token) =>
            {
