...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAction8Test : ReliableDelegateTest
    {
        ...
        private void TryInvoke(bool passToken)
        {
            ...
            // Test retrying without a delay
            Invoke_NoDelay((r, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, t, e) => Assert.IsFalse(tryInvoke(r, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, t)));
        }
        ...
        private void Invoke_RetriesExhausted(Action<ReliableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Type> assertInvoke, bool addEventHandlers, TimeSpan delay, TimeSpan minExpectedDelay)
        {
        ...
        private void Invoke_NoDelay(Action<ReliableAction<int, string, double, long, ushort, byte, TimeSpan, uint>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Type> assertInvoke)
