...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc15Test : ReliableDelegateTest<string>
    {
        ...
        {
            Func<ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, ulong, sbyte, decimal, char, float, string>, int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, ulong, sbyte, decimal, char, float, CancellationToken, (bool Success, string Result)> tryInvokeAsync;
            if (passToken)
