...
namespace Sweetener.Reliability.Test
{
    ...
    partial class FuncExtensionsTest : FuncExtensionsTestBase
    {
        ...
        public void WithRetryT2_DelayHandler()
        {
            ...
            // Failure (Exception)
            WithRetryT2_Failure_Exception         (funcFactory, delayHandlerFactory, withRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int>(), passResultHandler: false);
        ...
        public void WithRetryT2_ComplexDelayHandler()
        {
            ...
            // Failure (Exception)
            WithRetryT2_Failure_Exception         (funcFactory, delayHandlerFactory, withRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int, int, Exception>(), passResultHandler: false);
        ...
        public void WithRetryT2_ResultPolicy_DelayHandler()
        {
            ...
            // Failure (Exception)
            WithRetryT2_Failure_Exception         (funcFactory, delayHandlerFactory, withRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int>(), passResultHandler: true);
        ...
        public void WithRetryT2_ResultPolicy_ComplexDelayHandler()
        {
            ...
            // Failure (Exception)
            WithRetryT2_Failure_Exception         (funcFactory, delayHandlerFactory, withRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int, int, Exception>(), passResultHandler: true);
