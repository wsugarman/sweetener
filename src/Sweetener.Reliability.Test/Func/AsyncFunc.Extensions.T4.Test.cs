...
namespace Sweetener.Reliability.Test
{
    ...
    partial class AsyncFuncExtensionsTest : FuncExtensionsTestBase
    {
        ...
        public void WithAsyncRetryT4_Async_DelayHandler()
        {
            ...
            // Failure (Exception)
            WithRetryT4_Failure_Exception         (funcFactory, delayHandlerFactory, withAsyncRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int>(), passResultHandler: false);
        ...
        public void WithAsyncRetryT4_Async_ComplexDelayHandler()
        {
            ...
            // Failure (Exception)
            WithRetryT4_Failure_Exception         (funcFactory, delayHandlerFactory, withAsyncRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int, int, Exception>(), passResultHandler: false);
        ...
        public void WithAsyncRetryT4_Async_ResultPolicy_DelayHandler()
        {
            ...
            // Failure (Exception)
            WithRetryT4_Failure_Exception         (funcFactory, delayHandlerFactory, withAsyncRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int>(), passResultHandler: true);
        ...
        public void WithAsyncRetryT4_Async_ResultPolicy_ComplexDelayHandler()
        {
            ...
            // Failure (Exception)
            WithRetryT4_Failure_Exception         (funcFactory, delayHandlerFactory, withAsyncRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int, int, Exception>(), passResultHandler: true);
