...
namespace Sweetener.Reliability.Test
{
    partial class FuncExtensionsTest
    {
        ...
        {
            Func<int, string, double, long, ushort, byte, int> nullFunc = null;
            Func<int, string, double, long, ushort, byte, int> func     = (arg1, arg2, arg3, arg4, arg5, arg6) => 42;
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, arg6, token) => func(arg1, arg2, arg3, arg4, arg5, arg6);

            WithRetryT7_Success                   (withRetry, invoke, useResultPolicy: false);
            WithRetryT7_Failure_Exception         (withRetry, invoke); // ResultPolicy is never called
            WithRetryT7_EventualSuccess           (withRetry, invoke, useResultPolicy: false);
            WithRetryT7_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT7_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);

            // With Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, arg6, token) => func(arg1, arg2, arg3, arg4, arg5, arg6, token);
            ...
            WithRetryT7_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT7_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);
            WithRetryT7_Canceled                  (withRetry        , useResultPolicy: false);
        }
        ...
        public void WithRetryT7_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);
        ...
        public void WithRetryT7_ResultPolicy_DelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, arg6, token) => func(arg1, arg2, arg3, arg4, arg5, arg6);

            WithRetryT7_Success                   (withRetry, invoke);
            WithRetryT7_Failure_Result            (withRetry, invoke);
            WithRetryT7_Failure_Exception         (withRetry, invoke);
            WithRetryT7_EventualSuccess           (withRetry, invoke);
            WithRetryT7_EventualFailure_Result    (withRetry, invoke);
            WithRetryT7_EventualFailure_Exception (withRetry, invoke);
            WithRetryT7_RetriesExhausted_Result   (withRetry, invoke);
            WithRetryT7_RetriesExhausted_Exception(withRetry, invoke);
        ...
        public void WithRetryT7_ResultPolicy_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);
        ...
        private void WithRetryT7_Success(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
        ...
        private void WithRetryT7_Success(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT7_Success(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
        ...
        private void WithRetryT7_Success<T>(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, int> func = new FuncProxy<int, string, double, long, ushort, byte, int>((arg1, arg2, arg3, arg4, arg5, arg6) => 200);
            ...
            InterruptableFunc<int, string, double, long, ushort, byte, int> reliableFunc = withRetry(
                func.Invoke,
                Retries.Infinite,
                resultPolicy   .Invoke,
        ...
        private void WithRetryT7_Failure_Result(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke)
            => WithRetryT7_Failure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT7_Failure_Result<T>(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, int> func = new FuncProxy<int, string, double, long, ushort, byte, int>((arg1, arg2, arg3, arg4, arg5, arg6) => 500);
        ...
        private void WithRetryT7_Failure_Exception(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke)
            => WithRetryT7_Failure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT7_Failure_Exception<T>(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            // Create an "unsuccessful" user-defined func
            FuncProxy<int, string, double, long, ushort, byte, int> func = new FuncProxy<int, string, double, long, ushort, byte, int>((arg1, arg2, arg3, arg4, arg5, arg6) => throw new InvalidOperationException());
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, int> func = new FuncProxy<int, string, double, long, ushort, byte, int>((arg1, arg2, arg3, arg4, arg5, arg6) => flakyFunc());
        ...
        private void WithRetryT7_EventualFailure_Result(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke)
            => WithRetryT7_EventualFailure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT7_EventualFailure_Result<T>(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        private void WithRetryT7_EventualFailure_Exception(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT7_EventualFailure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT7_EventualFailure_Exception<T>(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        private void WithRetryT7_RetriesExhausted_Result(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke)
            => WithRetryT7_RetriesExhausted_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT7_RetriesExhausted_Result<T>(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        private void WithRetryT7_RetriesExhausted_Exception(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT7_RetriesExhausted_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT7_RetriesExhausted_Exception<T>(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, int>, int, string, double, long, ushort, byte, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        private void WithRetryT7_Canceled(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            bool useResultPolicy = true)
        ...
        private void WithRetryT7_Canceled<T>(
            Func<Func<int, string, double, long, ushort, byte, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, int>> withRetry,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
            where T : DelegateProxy
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => reliableFunc(42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, tokenSource.Token));
