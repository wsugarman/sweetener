...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncFunc6Test : ReliableDelegateTest<string>
    {
        ...
        {
            FuncProxy<int, string, double, long, ushort, byte, Task<string>> func = new FuncProxy<int, string, double, long, ushort, byte, Task<string>>();
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, long, ushort, byte, string>, int, string, double, long, ushort, byte, CancellationToken, (bool Success, string Result)> tryInvokeAsync;
            if (passToken)
