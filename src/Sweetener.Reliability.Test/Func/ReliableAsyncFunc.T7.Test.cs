...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncFunc6Test : ReliableDelegateTest<string>
    {
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, long, ushort, byte, string>, int, string, double, long, ushort, byte, CancellationToken, string> invoke;
            if (passToken)
            ...
            Assert.That.ThrowsException<InvalidOperationException>(() => invoke(badFunc, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, CancellationToken.None));
