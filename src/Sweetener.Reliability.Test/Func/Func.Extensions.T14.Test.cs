...
#nullable enable
            ...
            // Failure (Exception)
            WithRetryT14_Failure_Exception         (funcFactory, delayHandlerFactory, withRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int>());
...
#nullable enable
            ...
            // Failure (Exception)
            WithRetryT14_Failure_Exception         (funcFactory, delayHandlerFactory, withRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int, int, Exception>());
