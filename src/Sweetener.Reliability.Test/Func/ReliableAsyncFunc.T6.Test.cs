...
{
    [TestClass]
    public sealed class ReliableAsyncFunc5Test : ReliableDelegateTest<string>
    {
        private static readonly Func<ReliableAsyncFunc<int, string, double, long, ushort, string>, Func<int, string, double, long, ushort, CancellationToken, Task<string>>> s_getFunc = DynamicGetter.ForField<ReliableAsyncFunc<int, string, double, long, ushort, string>, Func<int, string, double, long, ushort, CancellationToken, Task<string>>>("_func");

        [TestMethod]
        public void Ctor_DelayHandler()
            => Ctor_DelayHandler((f, m, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ComplexDelayHandler()
            => Ctor_ComplexDelayHandler((f, m, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ResultHandler_DelayHandler()
            => Ctor_ResultHandler_DelayHandler((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_ResultHandler_ComplexDelayHandler()
            => Ctor_ResultHandler_ComplexDelayHandler((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_DelayHandler()
            => Ctor_Interruptable_DelayHandler((f, m, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayHandler()
            => Ctor_Interruptable_ComplexDelayHandler((f, m, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultHandler_DelayHandler()
            => Ctor_Interruptable_ResultHandler_DelayHandler((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultHandler_ComplexDelayHandler()
            => Ctor_Interruptable_ResultHandler_ComplexDelayHandler((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, string>(f, m, r, e, d));
        ...
        private void Ctor_DelayHandler(Func<Func<int, string, double, long, ushort, Task<string>>, int, ExceptionHandler, DelayHandler, ReliableAsyncFunc<int, string, double, long, ushort, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, Task<string>> func = new FuncProxy<int, string, double, long, ushort, Task<string>>(async (arg1, arg2, arg3, arg4, arg5) => await Task.FromResult("Hello World"));
...
#nullable enable
            ...
            ReliableAsyncFunc<int, string, double, long, ushort, string> actual = factory(func.Invoke, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_ComplexDelayHandler(Func<Func<int, string, double, long, ushort, Task<string>>, int, ExceptionHandler, ComplexDelayHandler<string>, ReliableAsyncFunc<int, string, double, long, ushort, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, Task<string>> func = new FuncProxy<int, string, double, long, ushort, Task<string>>(async (arg1, arg2, arg3, arg4, arg5) => await Task.FromResult("Hello World"));
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, string> actual = factory(func.Invoke, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultHandler_DelayHandler(Func<Func<int, string, double, long, ushort, Task<string>>, int, ResultHandler<string>, ExceptionHandler, DelayHandler, ReliableAsyncFunc<int, string, double, long, ushort, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, Task<string>> func = new FuncProxy<int, string, double, long, ushort, Task<string>>(async (arg1, arg2, arg3, arg4, arg5) => await Task.FromResult("Hello World"));
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, string> actual = factory(func.Invoke, 37, resultHandler, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, resultHandler, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultHandler_ComplexDelayHandler(Func<Func<int, string, double, long, ushort, Task<string>>, int, ResultHandler<string>, ExceptionHandler, ComplexDelayHandler<string>, ReliableAsyncFunc<int, string, double, long, ushort, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, Task<string>> func = new FuncProxy<int, string, double, long, ushort, Task<string>>(async (arg1, arg2, arg3, arg4, arg5) => await Task.FromResult("Hello World"));
            ResultHandler<string> resultHandler = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, string> actual = factory(func.Invoke, 37, resultHandler, exceptionHandler, delayHandler);
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, string> actual = factory(func, 37, exceptionHandler, delayHandler.Invoke);
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, string> actual = factory(func, 37, exceptionHandler, delayHandler);
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, string> actual = factory(func, 37, resultHandler, exceptionHandler, delayHandler.Invoke);
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, string> actual = factory(func, 37, resultHandler, exceptionHandler, delayHandler);

            Ctor(actual, 37, resultHandler, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void CtorFunc(ReliableAsyncFunc<int, string, double, long, ushort, string> reliableFunc, FuncProxy<int, string, double, long, ushort, Task<string>> expected)
        ...
        private void CtorFunc(ReliableAsyncFunc<int, string, double, long, ushort, string> reliableFunc, Func<int, string, double, long, ushort, CancellationToken, Task<string>> expected)
            => CtorFunc(reliableFunc, actual => Assert.AreSame(expected, actual));

        private void CtorFunc(ReliableAsyncFunc<int, string, double, long, ushort, string> reliableFunc, Action<Func<int, string, double, long, ushort, CancellationToken, Task<string>>> validateFunc)
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, string> invokeAsync;
            if (passToken)
...
#nullable disable
            ...
            ReliableAsyncFunc<int, string, double, long, ushort, string> badFunc = new ReliableAsyncFunc<int, string, double, long, ushort, string>((arg1, arg2, arg3, arg4, arg5) => null, Retries.Infinite, ExceptionPolicy.Transient, DelayPolicy.None);
            Assert.That.ThrowsException<InvalidOperationException>(() => invokeAsync(badFunc, 42, "foo", 3.14D, 1000L, (ushort)1, CancellationToken.None));
...
#nullable enable
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, Optional<string>> tryInvokeAsync;
            if (passToken)
...
#nullable disable
            ...
            // Test a function that returns a null Task
            ReliableAsyncFunc<int, string, double, long, ushort, string> badFunc = new ReliableAsyncFunc<int, string, double, long, ushort, string>((arg1, arg2, arg3, arg4, arg5) => null, Retries.Infinite, ExceptionPolicy.Transient, DelayPolicy.None);
            Assert.That.ThrowsException<InvalidOperationException>(() => tryInvokeAsync(badFunc, 42, "foo", 3.14D, 1000L, (ushort)1, CancellationToken.None));

#nullable enable

            Action<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, string> assertSuccess =
            ...
            Action<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, string> assertResultFailure =
                (f, arg1, arg2, arg3, arg4, arg5, t, r) =>
                {
            ...
            Action<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, Type> assertExceptionFailure =
        ...
        private void Invoke_Failure_Exception(Action<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            FuncProxy<int, string, double, long, ushort, Task<string>> func = new FuncProxy<int, string, double, long, ushort, Task<string>>(async (arg1, arg2, arg3, arg4, arg5) => await Task.FromException<string>(new OutOfMemoryException()));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Result(Action<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Exception(Action<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually fails after a transient result and exception
        ...
        private void Invoke_RetriesExhausted_Result(Action<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted_Exception(Action<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually exhausts the maximum number of retries after transient results and exceptions
            Func<string> flakyFunc = FlakyFunc.Create<string, IOException>("Retry");
            FuncProxy<int, string, double, long, ushort, Task<string>> func = new FuncProxy<int, string, double, long, ushort, Task<string>>(async (arg1, arg2, arg3, arg4, arg5) => await Task.FromResult(flakyFunc()));
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAsyncFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
