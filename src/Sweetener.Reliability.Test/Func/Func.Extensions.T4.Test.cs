...
namespace Sweetener.Reliability.Test
{
    partial class FuncExtensionsTest
    {
        ...
        {
            Func<int, string, double, int> nullFunc = null;
            Func<int, string, double, int> func     = (arg1, arg2, arg3) => 42;
            ...
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke;
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, token) => func(arg1, arg2, arg3);

            WithRetryT4_Success                   (withRetry, invoke, useResultPolicy: false);
            WithRetryT4_Failure_Exception         (withRetry, invoke); // ResultPolicy is never called
            WithRetryT4_EventualSuccess           (withRetry, invoke, useResultPolicy: false);
            WithRetryT4_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT4_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);

            // With Token
            invoke = (func, arg1, arg2, arg3, token) => func(arg1, arg2, arg3, token);
            ...
            WithRetryT4_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT4_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);
            WithRetryT4_Canceled                  (withRetry        , useResultPolicy: false);
        }
        ...
        public void WithRetryT4_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke;
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);
        ...
        public void WithRetryT4_ResultPolicy_DelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke;
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, token) => func(arg1, arg2, arg3);

            WithRetryT4_Success                   (withRetry, invoke);
            WithRetryT4_Failure_Result            (withRetry, invoke);
            WithRetryT4_Failure_Exception         (withRetry, invoke);
            WithRetryT4_EventualSuccess           (withRetry, invoke);
            WithRetryT4_EventualFailure_Result    (withRetry, invoke);
            WithRetryT4_EventualFailure_Exception (withRetry, invoke);
            WithRetryT4_RetriesExhausted_Result   (withRetry, invoke);
            WithRetryT4_RetriesExhausted_Exception(withRetry, invoke);
        ...
        public void WithRetryT4_ResultPolicy_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke;
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);
        ...
        private void WithRetryT4_Success(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
        ...
        private void WithRetryT4_Success(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT4_Success(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
        ...
        private void WithRetryT4_Success<T>(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, int> func = new FuncProxy<int, string, double, int>((arg1, arg2, arg3) => 200);
            ...
            InterruptableFunc<int, string, double, int> reliableFunc = withRetry(
                func.Invoke,
                Retries.Infinite,
                resultPolicy   .Invoke,
            ...
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.AreEqual(200, invoke(reliableFunc, 42, "foo", 3.14D, tokenSource.Token));
        ...
        #region WithRetryT4_Failure_Result

        private void WithRetryT4_Failure_Result(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke)
            => WithRetryT4_Failure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT4_Failure_Result<T>(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, int> func = new FuncProxy<int, string, double, int>((arg1, arg2, arg3) => 500);
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.AreEqual(500, invoke(reliableFunc, 42, "foo", 3.14D, tokenSource.Token));
        ...
        #region WithRetryT4_Failure_Exception

        private void WithRetryT4_Failure_Exception(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke)
            => WithRetryT4_Failure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT4_Failure_Exception<T>(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            // Create an "unsuccessful" user-defined func
            FuncProxy<int, string, double, int> func = new FuncProxy<int, string, double, int>((arg1, arg2, arg3) => throw new InvalidOperationException());
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.That.ThrowsException<InvalidOperationException>(() => invoke(reliableFunc, 42, "foo", 3.14D, tokenSource.Token));
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, int> func = new FuncProxy<int, string, double, int>((arg1, arg2, arg3) => flakyFunc());
        ...
        #region WithRetryT4_EventualFailure_Result

        private void WithRetryT4_EventualFailure_Result(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke)
            => WithRetryT4_EventualFailure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT4_EventualFailure_Result<T>(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        #region WithRetryT4_EventualFailure_Exception

        private void WithRetryT4_EventualFailure_Exception(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT4_EventualFailure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT4_EventualFailure_Exception<T>(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        #region WithRetryT4_RetriesExhausted_Result

        private void WithRetryT4_RetriesExhausted_Result(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke)
            => WithRetryT4_RetriesExhausted_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT4_RetriesExhausted_Result<T>(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.AreEqual(418, invoke(reliableFunc, 42, "foo", 3.14D, tokenSource.Token));
        ...
        #region WithRetryT4_RetriesExhausted_Exception

        private void WithRetryT4_RetriesExhausted_Exception(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT4_RetriesExhausted_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT4_RetriesExhausted_Exception<T>(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, int>> withRetry,
            Func<InterruptableFunc<int, string, double, int>, int, string, double, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
            where T : DelegateProxy
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.That.ThrowsException<IOException>(() => invoke(reliableFunc, 42, "foo", 3.14D, tokenSource.Token));
        ...
        private void WithRetryT4_Canceled(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, int>> withRetry,
            bool useResultPolicy = true)
        ...
        private void WithRetryT4_Canceled<T>(
            Func<Func<int, string, double, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, int>> withRetry,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
            where T : DelegateProxy
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => reliableFunc(42, "foo", 3.14D, tokenSource.Token));
