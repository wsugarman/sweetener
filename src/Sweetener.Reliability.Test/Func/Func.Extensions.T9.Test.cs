...
namespace Sweetener.Reliability.Test
{
    partial class FuncExtensionsTest
    {
        ...
        {
            Func<int, string, double, long, ushort, byte, TimeSpan, uint, int> nullFunc = null;
            Func<int, string, double, long, ushort, byte, TimeSpan, uint, int> func     = (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) => 42;
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => func(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);

            WithRetryT9_Success                   (withRetry, invoke, useResultPolicy: false);
            WithRetryT9_Failure_Exception         (withRetry, invoke); // ResultPolicy is never called
            WithRetryT9_EventualSuccess           (withRetry, invoke, useResultPolicy: false);
            WithRetryT9_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT9_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);

            // With Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => func(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token);
            ...
            WithRetryT9_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT9_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);
            WithRetryT9_Canceled                  (withRetry        , useResultPolicy: false);
        }
        ...
        public void WithRetryT9_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);
        ...
        public void WithRetryT9_ResultPolicy_DelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => func(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);

            WithRetryT9_Success                   (withRetry, invoke);
            WithRetryT9_Failure_Result            (withRetry, invoke);
            WithRetryT9_Failure_Exception         (withRetry, invoke);
            WithRetryT9_EventualSuccess           (withRetry, invoke);
            WithRetryT9_EventualFailure_Result    (withRetry, invoke);
            WithRetryT9_EventualFailure_Exception (withRetry, invoke);
            WithRetryT9_RetriesExhausted_Result   (withRetry, invoke);
            WithRetryT9_RetriesExhausted_Exception(withRetry, invoke);
        ...
        public void WithRetryT9_ResultPolicy_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);
        ...
        private void WithRetryT9_Success(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
        ...
        private void WithRetryT9_Success(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT9_Success(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
        ...
        private void WithRetryT9_Success<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, int> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, int>((arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) => 200);
            ...
            InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int> reliableFunc = withRetry(
                func.Invoke,
                Retries.Infinite,
                resultPolicy   .Invoke,
        ...
        private void WithRetryT9_Failure_Result(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke)
            => WithRetryT9_Failure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT9_Failure_Result<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, int> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, int>((arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) => 500);
        ...
        private void WithRetryT9_Failure_Exception(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke)
            => WithRetryT9_Failure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT9_Failure_Exception<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            // Create an "unsuccessful" user-defined func
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, int> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, int>((arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) => throw new InvalidOperationException());
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.That.ThrowsException<InvalidOperationException>(() => invoke(reliableFunc, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), 112U, tokenSource.Token));
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, int> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, int>((arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) => flakyFunc());
        ...
        private void WithRetryT9_EventualFailure_Result(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke)
            => WithRetryT9_EventualFailure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT9_EventualFailure_Result<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        private void WithRetryT9_EventualFailure_Exception(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT9_EventualFailure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT9_EventualFailure_Exception<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        private void WithRetryT9_RetriesExhausted_Result(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke)
            => WithRetryT9_RetriesExhausted_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT9_RetriesExhausted_Result<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        private void WithRetryT9_RetriesExhausted_Exception(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT9_RetriesExhausted_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT9_RetriesExhausted_Exception<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        private void WithRetryT9_Canceled(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            bool useResultPolicy = true)
        ...
        private void WithRetryT9_Canceled<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, int>> withRetry,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
            where T : DelegateProxy
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => reliableFunc(42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), 112U, tokenSource.Token));
