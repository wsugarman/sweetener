...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc4Test : ReliableDelegateTest<string>
    {
        ...
        private void Invoke(Func<ReliableFunc<int, string, double, long, string>, int, string, double, long, string> invoke)
        {
            ...
            // Failure (Bad Result)
            Action<ReliableFunc<int, string, double, long, string>, int, string, double, long> assertFailureResult = (reliableFunc, arg1, arg2, arg3, arg4)
                => Assert.AreEqual("Bad Result", reliableFunc.Invoke(arg1, arg2, arg3, arg4));
        ...
        {
            // Success
            Func<ReliableFunc<int, string, double, long, string>, int, string, double, long, string> assertSuccess = (r, arg1, arg2, arg3, arg4) =>
            {
            ...
            // Failure (Bad Result)
            Action<ReliableFunc<int, string, double, long, string>, int, string, double, long> assertFailure = (reliableFunc, arg1, arg2, arg3, arg4) =>
            {
