...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc4Test : ReliableDelegateTest<string>
    {
        ...
        {
            FuncProxy<int, string, double, long, string> func = new FuncProxy<int, string, double, long, string>((arg1, arg2, arg3, arg4) => "Hello World");
...
#nullable enable
        ...
        {
            Func<ReliableFunc<int, string, double, long, string>, int, string, double, long, CancellationToken, string> invokeAsync;
            if (passToken)
