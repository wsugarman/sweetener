...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc4Test : ReliableDelegateTest<string>
    {
        ...
        public void Ctor_Interruptable_DelayPolicy()
            => Ctor_Interruptable_DelayPolicy((f, m, e, d) => new ReliableFunc<int, string, double, long, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayPolicy()
            => Ctor_Interruptable_ComplexDelayPolicy((f, m, e, d) => new ReliableFunc<int, string, double, long, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultPolicy_DelayPolicy()
            => Ctor_Interruptable_ResultPolicy_DelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, double, long, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy()
            => Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, double, long, string>(f, m, r, e, d));
        ...
        private void Ctor_DelayPolicy(Func<Func<int, string, double, long, string>, int, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, double, long, string>> factory)
        {
            ...
            ReliableFunc<int, string, double, long, string> actual = factory(func.Invoke, 37, exceptionPolicy, delayPolicy.Invoke);
        ...
        private void Ctor_ComplexDelayPolicy(Func<Func<int, string, double, long, string>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, long, string>> factory)
        {
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, string> actual = factory(func.Invoke, 37, exceptionPolicy, delayPolicy);
        ...
        private void Ctor_ResultPolicy_DelayPolicy(Func<Func<int, string, double, long, string>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, double, long, string>> factory)
        {
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, string> actual = factory(func.Invoke, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);
        ...
        private void Ctor_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, double, long, string>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, long, string>> factory)
        {
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, string> actual = factory(func.Invoke, 37, resultPolicy, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_DelayPolicy(Func<Func<int, string, double, long, CancellationToken, string>, int, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, double, long, string>> factory)
        {
        ...
        private void Ctor_Interruptable_ComplexDelayPolicy(Func<Func<int, string, double, long, CancellationToken, string>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, long, string>> factory)
        {
            Func<int, string, double, long, CancellationToken, string> func = (arg1, arg2, arg3, arg4, token) => "Hello World";
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ComplexDelayPolicy<string> delayPolicy = (i, r, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, string> actual = factory(func, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultPolicy_DelayPolicy(Func<Func<int, string, double, long, CancellationToken, string>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, double, long, string>> factory)
        {
            Func<int, string, double, long, CancellationToken, string> func = (arg1, arg2, arg3, arg4, token) => "Hello World";
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
        ...
        private void Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, double, long, CancellationToken, string>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, long, string>> factory)
        {
            Func<int, string, double, long, CancellationToken, string> func = (arg1, arg2, arg3, arg4, token) => "Hello World";
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, delayPolicy);
        ...
        private void Invoke(bool passToken)
        {
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                if (passToken)
                {
                    Invoke_Canceled_Action((f, arg1, arg2, arg3, arg4, t) => f.Invoke(arg1, arg2, arg3, arg4, t), addEventHandlers);
        ...
        private void TryInvoke(bool passToken)
        {
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                if (passToken)
                {
                    Invoke_Canceled_Action((f, arg1, arg2, arg3, arg4, t) => f.TryInvoke(arg1, arg2, arg3, arg4, t, out string _), addEventHandlers);
        ...
        private void Invoke_Canceled_Action(Action<ReliableFunc<int, string, double, long, string>, int, string, double, long, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
