...
namespace Sweetener.Reliability.Test
{
    ...
    public partial class FuncExtensionsTest
    {
        ...
        public void WithRetryT1_DelayPolicy()
        {
            ...
            Func<InterruptableFunc<int>, CancellationToken, int> invoke;
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);

            // Without Token
            invoke = (func, token) => func();

            WithRetryT1_Success                   (withRetry, invoke, useResultPolicy: false);
            WithRetryT1_Failure_Exception         (withRetry, invoke); // ResultPolicy is never called
            WithRetryT1_EventualSuccess           (withRetry, invoke, useResultPolicy: false);
            WithRetryT1_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT1_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);

            // With Token
            invoke = (func, token) => func(token);
            ...
            WithRetryT1_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT1_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);
            WithRetryT1_Canceled                  (withRetry        , useResultPolicy: false);
        }
        ...
        public void WithRetryT1_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int>, CancellationToken, int> invoke;
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);
        ...
        public void WithRetryT1_ResultPolicy_DelayPolicy()
        {
            ...
            Func<InterruptableFunc<int>, CancellationToken, int> invoke;
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);

            // Without Token
            invoke = (func, token) => func();

            WithRetryT1_Success                   (withRetry, invoke);
            WithRetryT1_Failure_Result            (withRetry, invoke);
            WithRetryT1_Failure_Exception         (withRetry, invoke);
            WithRetryT1_EventualSuccess           (withRetry, invoke);
            WithRetryT1_EventualFailure_Result    (withRetry, invoke);
            WithRetryT1_EventualFailure_Exception (withRetry, invoke);
            WithRetryT1_RetriesExhausted_Result   (withRetry, invoke);
            WithRetryT1_RetriesExhausted_Exception(withRetry, invoke);
            ...
            WithRetryT1_RetriesExhausted_Result   (withRetry, invoke);
            WithRetryT1_RetriesExhausted_Exception(withRetry, invoke);
            WithRetryT1_Canceled                  (withRetry);
        }
        ...
        public void WithRetryT1_ResultPolicy_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int>, CancellationToken, int> invoke;
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);
        ...
        private void WithRetryT1_Success(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
        ...
        private void WithRetryT1_Success(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT1_Success(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
        ...
        private void WithRetryT1_Success<T>(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int> func = new FuncProxy<int>(() => 200);
            ...
            InterruptableFunc<int> reliableFunc = withRetry(
                func.Invoke,
                Retries.Infinite,
                resultPolicy   .Invoke,
            ...
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.AreEqual(200, invoke(reliableFunc, tokenSource.Token));
        ...
        #region WithRetryT1_Failure_Result

        private void WithRetryT1_Failure_Result(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke)
            => WithRetryT1_Failure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT1_Failure_Result<T>(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            ...
            FuncProxy<int> func = new FuncProxy<int>(() => 500);
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.AreEqual(500, invoke(reliableFunc, tokenSource.Token));
        ...
        #region WithRetryT1_Failure_Exception

        private void WithRetryT1_Failure_Exception(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke)
            => WithRetryT1_Failure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT1_Failure_Exception<T>(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            // Create an "unsuccessful" user-defined func
            FuncProxy<int> func = new FuncProxy<int>(() => throw new InvalidOperationException());
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.That.ThrowsException<InvalidOperationException>(() => invoke(reliableFunc, tokenSource.Token));
        ...
        private void WithRetryT1_EventualSuccess(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int> func = new FuncProxy<int>(() => flakyFunc());
        ...
        #region WithRetryT1_EventualFailure_Result

        private void WithRetryT1_EventualFailure_Result(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke)
            => WithRetryT1_EventualFailure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT1_EventualFailure_Result<T>(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        #region WithRetryT1_EventualFailure_Exception

        private void WithRetryT1_EventualFailure_Exception(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT1_EventualFailure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT1_EventualFailure_Exception<T>(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        #region WithRetryT1_RetriesExhausted_Result

        private void WithRetryT1_RetriesExhausted_Result(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke)
            => WithRetryT1_RetriesExhausted_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT1_RetriesExhausted_Result<T>(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.AreEqual(418, invoke(reliableFunc, tokenSource.Token));
        ...
        #region WithRetryT1_RetriesExhausted_Exception

        private void WithRetryT1_RetriesExhausted_Exception(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT1_RetriesExhausted_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT1_RetriesExhausted_Exception<T>(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int>> withRetry,
            Func<InterruptableFunc<int>, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
            where T : DelegateProxy
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.That.ThrowsException<IOException>(() => invoke(reliableFunc, tokenSource.Token));
        ...
        private void WithRetryT1_Canceled(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int>> withRetry,
            bool useResultPolicy = true)
            => WithRetryT1_Canceled(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                () =>
                {
                    FuncProxy<int, TimeSpan> delayPolicy = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
        ...
        private void WithRetryT1_Canceled<T>(
            Func<Func<int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int>> withRetry,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
            where T : DelegateProxy
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => reliableFunc(tokenSource.Token));
