...
namespace Sweetener.Reliability.Test
{
    partial class FuncExtensionsTestBase
    {
        ...
        internal void WithRetryT3_Success<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
        ...
        internal void WithRetryT3_Failure_Result<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
            Func<Func<CancellationToken, int>, TFuncProxy> funcFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TFunc, int, ResultHandler<int>, ExceptionHandler, TDelayPolicy, TFunc> withRetry,
            Func<TFunc, int, string, CancellationToken, int> invoke,
            ...
            where TDelayPolicyProxy : DelegateProxy<TDelayPolicy>
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.AreEqual(500, invoke(reliableFunc, 42, "foo", tokenSource.Token));
        ...
        internal void WithRetryT3_Failure_Exception<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
            Func<Func<CancellationToken, int>, TFuncProxy> funcFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TFunc, int, ResultHandler<int>, ExceptionHandler, TDelayPolicy, TFunc> withRetry,
            Func<TFunc, int, string, CancellationToken, int> invoke,
            ...
            where TDelayPolicyProxy : DelegateProxy<TDelayPolicy>
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.That.ThrowsException<OutOfMemoryException>(() => invoke(reliableFunc, 42, "foo", tokenSource.Token));
        ...
        internal void WithRetryT3_EventualSuccess<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
            Func<Func<CancellationToken, int>, TFuncProxy> funcFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TFunc, int, ResultHandler<int>, ExceptionHandler, TDelayPolicy, TFunc> withRetry,
            Func<TFunc, int, string, CancellationToken, int> invoke,
        ...
        internal void WithRetryT3_EventualFailure_Result<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
            Func<Func<CancellationToken, int>, TFuncProxy> funcFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TFunc, int, ResultHandler<int>, ExceptionHandler, TDelayPolicy, TFunc> withRetry,
            Func<TFunc, int, string, CancellationToken, int> invoke,
        ...
        internal void WithRetryT3_EventualFailure_Exception<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
            Func<Func<CancellationToken, int>, TFuncProxy> funcFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TFunc, int, ResultHandler<int>, ExceptionHandler, TDelayPolicy, TFunc> withRetry,
            Func<TFunc, int, string, CancellationToken, int> invoke,
        ...
        internal void WithRetryT3_RetriesExhausted_Result<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
            Func<Func<CancellationToken, int>, TFuncProxy> funcFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TFunc, int, ResultHandler<int>, ExceptionHandler, TDelayPolicy, TFunc> withRetry,
            Func<TFunc, int, string, CancellationToken, int> invoke,
            ...
            where TDelayPolicyProxy : DelegateProxy<TDelayPolicy>
        {
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                Assert.AreEqual(418, invoke(reliableFunc, 42, "foo", tokenSource.Token));
        ...
        internal void WithRetryT3_RetriesExhausted_Exception<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
            Func<Func<CancellationToken, int>, TFuncProxy> funcFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TFunc, int, ResultHandler<int>, ExceptionHandler, TDelayPolicy, TFunc> withRetry,
            Func<TFunc, int, string, CancellationToken, int> invoke,
        ...
        internal void WithRetryT3_Canceled<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
            Func<Func<CancellationToken, int>, TFuncProxy> funcFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TFunc, int, ResultHandler<int>, ExceptionHandler, TDelayPolicy, TFunc> withRetry,
            Func<TFunc, int, string, CancellationToken, int> invoke)
        ...
        internal void WithRetryT3_Canceled_Func<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
            Func<Func<CancellationToken, int>, TFuncProxy> funcFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TFunc, int, ResultHandler<int>, ExceptionHandler, TDelayPolicy, TFunc> withRetry,
            Func<TFunc, int, string, CancellationToken, int> invoke,
        ...
        internal void WithRetryT3_Canceled_Delay<TFunc, TDelayPolicy, TFuncProxy, TDelayPolicyProxy>(
            Func<Func<CancellationToken, int>, TFuncProxy> funcFactory,
            Func<TimeSpan, TDelayPolicyProxy> delayHandlerFactory,
            Func<TFunc, int, ResultHandler<int>, ExceptionHandler, TDelayPolicy, TFunc> withRetry,
            Func<TFunc, int, string, CancellationToken, int> invoke,
