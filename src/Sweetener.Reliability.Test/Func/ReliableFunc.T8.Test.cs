...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc7Test : ReliableDelegateTest<string>
    {
        ...
        public void Ctor_DelayPolicy()
            => Ctor_DelayPolicy((f, m, e, d) => new ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ComplexDelayPolicy()
            => Ctor_ComplexDelayPolicy((f, m, e, d) => new ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ResultPolicy_DelayPolicy()
            => Ctor_ResultPolicy_DelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_ResultPolicy_ComplexDelayPolicy()
            => Ctor_ResultPolicy_ComplexDelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_DelayPolicy()
            => Ctor_Interruptable_DelayPolicy((f, m, e, d) => new ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayPolicy()
            => Ctor_Interruptable_ComplexDelayPolicy((f, m, e, d) => new ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultPolicy_DelayPolicy()
            => Ctor_Interruptable_ResultPolicy_DelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy()
            => Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>(f, m, r, e, d));
        ...
        private void Ctor_DelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, string>, int, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, string> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, string>();
            ...
            ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string> actual = factory(func.Invoke, 37, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, string>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, string> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, string>();
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string> actual = factory(func.Invoke, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultPolicy_DelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, string>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, string> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, string>();
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string> actual = factory(func.Invoke, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, string>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, string> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, string>();
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string> actual = factory(func.Invoke, 37, resultPolicy, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_DelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, string>, int, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>> factory)
        {
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string> actual = factory(func, 37, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, string>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>> factory)
        {
            Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, string> func = (arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => "Hello World";
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ComplexDelayPolicy<string> delayPolicy = (i, r, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string> actual = factory(func, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultPolicy_DelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, string>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>> factory)
        {
            Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, string> func = (arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => "Hello World";
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, string>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>> factory)
        {
            Func<int, string, double, long, ushort, byte, TimeSpan, CancellationToken, string> func = (arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => "Hello World";
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, delayPolicy);
        ...
        private void Invoke(bool passToken)
        {
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                if (passToken)
                {
                    Invoke_Canceled_Action((f, arg1, arg2, arg3, arg4, arg5, arg6, arg7, t) => f.Invoke(arg1, arg2, arg3, arg4, arg5, arg6, arg7, t), addEventHandlers);
        ...
        private void InvokeAsync(bool passToken)
        {
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                if (passToken)
                {
                    Invoke_Canceled_Action((f, arg1, arg2, arg3, arg4, arg5, arg6, arg7, t) => f.InvokeAsync(arg1, arg2, arg3, arg4, arg5, arg6, arg7, t).Wait(), addEventHandlers);
        ...
        private void TryInvoke(bool passToken)
        {
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                if (passToken)
                {
                    Invoke_Canceled_Action((f, arg1, arg2, arg3, arg4, arg5, arg6, arg7, t) => f.TryInvoke(arg1, arg2, arg3, arg4, arg5, arg6, arg7, t, out string _), addEventHandlers);
        ...
        private void Invoke_Failure_Exception(Action<ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, string> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, string>((arg1, arg2, arg3, arg4, arg5, arg6, arg7) => throw new InvalidOperationException());
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableFunc, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), tokenSource.Token, typeof(InvalidOperationException));
        ...
        private void Invoke_Canceled_Action(Action<ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, string>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
