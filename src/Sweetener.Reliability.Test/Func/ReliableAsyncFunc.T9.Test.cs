...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncFunc8Test : ReliableDelegateTest<string>
    {
        ...
        public void Ctor_DelayPolicy()
            => Ctor_DelayPolicy((f, m, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ComplexDelayPolicy()
            => Ctor_ComplexDelayPolicy((f, m, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ResultPolicy_DelayPolicy()
            => Ctor_ResultPolicy_DelayPolicy((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_ResultPolicy_ComplexDelayPolicy()
            => Ctor_ResultPolicy_ComplexDelayPolicy((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_DelayPolicy()
            => Ctor_Interruptable_DelayPolicy((f, m, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayPolicy()
            => Ctor_Interruptable_ComplexDelayPolicy((f, m, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultPolicy_DelayPolicy()
            => Ctor_Interruptable_ResultPolicy_DelayPolicy((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy()
            => Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>(f, m, r, e, d));
        ...
        private void Ctor_DelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, Task<string>>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>> factory)
        {
            ...
            ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string> actual = factory(func.Invoke, 37, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, Task<string>>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, Task<string>> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, Task<string>>();
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string> actual = factory(func.Invoke, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultPolicy_DelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, Task<string>>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, Task<string>> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, Task<string>>();
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string> actual = factory(func.Invoke, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, Task<string>>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>> factory)
        {
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, Task<string>> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, Task<string>>();
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string> actual = factory(func.Invoke, 37, resultPolicy, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_DelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Task<string>>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>> factory)
        {
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string> actual = factory(func, 37, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Task<string>>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>> factory)
        {
            Func<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Task<string>> func = async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => await Task.Run(() => "Hello World").ConfigureAwait(false);
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ComplexDelayPolicy<string> delayPolicy = (i, r, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string> actual = factory(func, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultPolicy_DelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Task<string>>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>> factory)
        {
            Func<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Task<string>> func = async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => await Task.Run(() => "Hello World").ConfigureAwait(false);
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Task<string>>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>> factory)
        {
            Func<int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken, Task<string>> func = async (arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, token) => await Task.Run(() => "Hello World").ConfigureAwait(false);
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, delayPolicy);
        ...
        private void Invoke_Canceled_Action(Action<ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, string>, int, string, double, long, ushort, byte, TimeSpan, uint, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
