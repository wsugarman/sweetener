...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncFunc14Test : ReliableDelegateTest<string>
    {
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, ulong, sbyte, decimal, char, string>, int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, ulong, sbyte, decimal, char, CancellationToken, (bool Success, string Result)> tryInvokeAsync;
            if (passToken)
