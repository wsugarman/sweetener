...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncFunc7Test : ReliableDelegateTest<string>
    {
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, string>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, (bool Success, string Result)> tryInvokeAsync;
            if (passToken)
