...
{
    [TestClass]
    public sealed class ReliableAsyncFunc1Test : ReliableDelegateTest<string>
    {
        private static readonly Func<ReliableAsyncFunc<int, string>, Func<int, CancellationToken, Task<string>>> s_getFunc = DynamicGetter.ForField<ReliableAsyncFunc<int, string>, Func<int, CancellationToken, Task<string>>>("_func");

        [TestMethod]
        public void Ctor_DelayPolicy()
            => Ctor_DelayPolicy((f, m, e, d) => new ReliableAsyncFunc<int, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ComplexDelayPolicy()
            => Ctor_ComplexDelayPolicy((f, m, e, d) => new ReliableAsyncFunc<int, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ResultPolicy_DelayPolicy()
            => Ctor_ResultPolicy_DelayPolicy((f, m, r, e, d) => new ReliableAsyncFunc<int, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_ResultPolicy_ComplexDelayPolicy()
            => Ctor_ResultPolicy_ComplexDelayPolicy((f, m, r, e, d) => new ReliableAsyncFunc<int, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_DelayPolicy()
            => Ctor_Interruptable_DelayPolicy((f, m, e, d) => new ReliableAsyncFunc<int, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayPolicy()
            => Ctor_Interruptable_ComplexDelayPolicy((f, m, e, d) => new ReliableAsyncFunc<int, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultPolicy_DelayPolicy()
            => Ctor_Interruptable_ResultPolicy_DelayPolicy((f, m, r, e, d) => new ReliableAsyncFunc<int, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy()
            => Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy((f, m, r, e, d) => new ReliableAsyncFunc<int, string>(f, m, r, e, d));
        ...
        private void Ctor_DelayPolicy(Func<Func<int, Task<string>>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncFunc<int, string>> factory)
        {
            FuncProxy<int, Task<string>> func = new FuncProxy<int, Task<string>>();
            ...
            ReliableAsyncFunc<int, string> actual = factory(func.Invoke, 37, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ComplexDelayPolicy(Func<Func<int, Task<string>>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableAsyncFunc<int, string>> factory)
        {
            FuncProxy<int, Task<string>> func = new FuncProxy<int, Task<string>>();
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string> actual = factory(func.Invoke, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultPolicy_DelayPolicy(Func<Func<int, Task<string>>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableAsyncFunc<int, string>> factory)
        {
            FuncProxy<int, Task<string>> func = new FuncProxy<int, Task<string>>();
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string> actual = factory(func.Invoke, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultPolicy_ComplexDelayPolicy(Func<Func<int, Task<string>>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableAsyncFunc<int, string>> factory)
        {
            FuncProxy<int, Task<string>> func = new FuncProxy<int, Task<string>>();
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string> actual = factory(func.Invoke, 37, resultPolicy, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_DelayPolicy(Func<Func<int, CancellationToken, Task<string>>, int, ExceptionPolicy, DelayPolicy, ReliableAsyncFunc<int, string>> factory)
        {
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string> actual = factory(func, 37, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ComplexDelayPolicy(Func<Func<int, CancellationToken, Task<string>>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableAsyncFunc<int, string>> factory)
        {
            Func<int, CancellationToken, Task<string>> func = async (arg, token) => await Task.Run(() => "Hello World").ConfigureAwait(false);
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ComplexDelayPolicy<string> delayPolicy = (i, r, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string> actual = factory(func, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultPolicy_DelayPolicy(Func<Func<int, CancellationToken, Task<string>>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableAsyncFunc<int, string>> factory)
        {
            Func<int, CancellationToken, Task<string>> func = async (arg, token) => await Task.Run(() => "Hello World").ConfigureAwait(false);
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy(Func<Func<int, CancellationToken, Task<string>>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableAsyncFunc<int, string>> factory)
        {
            Func<int, CancellationToken, Task<string>> func = async (arg, token) => await Task.Run(() => "Hello World").ConfigureAwait(false);
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void CtorFunc(ReliableAsyncFunc<int, string> reliableFunc, FuncProxy<int, Task<string>> expected)
        ...
        private void CtorFunc(ReliableAsyncFunc<int, string> reliableFunc, Func<int, CancellationToken, Task<string>> expected)
            => CtorFunc(reliableFunc, actual => Assert.AreSame(expected, actual));

        private void CtorFunc(ReliableAsyncFunc<int, string> reliableFunc, Action<Func<int, CancellationToken, Task<string>>> validateFunc)
        ...
        {
            Func<ReliableAsyncFunc<int, string>, int, CancellationToken, string> invoke;
            if (passToken)
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                if (passToken)
                {
                    Invoke_Canceled_Action((f, arg, t) => f.InvokeAsync(arg, t).Wait(), addEventHandlers);
        ...
        private void Invoke_EventualSuccess(Action<ReliableAsyncFunc<int, string>, int, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Result(Action<ReliableAsyncFunc<int, string>, int, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Exception(Action<ReliableAsyncFunc<int, string>, int, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually fails after a transient result and exception
        ...
        private void Invoke_RetriesExhausted_Result(Action<ReliableAsyncFunc<int, string>, int, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted_Exception(Action<ReliableAsyncFunc<int, string>, int, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually exhausts the maximum number of retries after transient results and exceptions
            Func<string> flakyFunc = FlakyFunc.Create<string, IOException>("Retry");
            FuncProxy<int, Task<string>> func = new FuncProxy<int, Task<string>>(async (arg) => await Task.Run(flakyFunc).ConfigureAwait(false));
        ...
        private void Invoke_Canceled_Action(Action<ReliableAsyncFunc<int, string>, int, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAsyncFunc<int, string>, int, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
