...
namespace Sweetener.Reliability.Test
{
    partial class FuncExtensionsTest
    {
        ...
        {
            Func<int, string, double, long, ushort, int> nullFunc = null;
            Func<int, string, double, long, ushort, int> func     = (arg1, arg2, arg3, arg4, arg5) => 42;
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, token) => func(arg1, arg2, arg3, arg4, arg5);

            WithRetryT6_Success                   (withRetry, invoke, useResultPolicy: false);
            WithRetryT6_Failure_Exception         (withRetry, invoke); // ResultPolicy is never called
            WithRetryT6_EventualSuccess           (withRetry, invoke, useResultPolicy: false);
            WithRetryT6_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT6_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);

            // With Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, token) => func(arg1, arg2, arg3, arg4, arg5, token);
            ...
            WithRetryT6_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT6_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);
            WithRetryT6_Canceled                  (withRetry        , useResultPolicy: false);
        }
        ...
        public void WithRetryT6_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);
        ...
        public void WithRetryT6_ResultPolicy_DelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, token) => func(arg1, arg2, arg3, arg4, arg5);

            WithRetryT6_Success                   (withRetry, invoke);
            WithRetryT6_Failure_Result            (withRetry, invoke);
            WithRetryT6_Failure_Exception         (withRetry, invoke);
            WithRetryT6_EventualSuccess           (withRetry, invoke);
            WithRetryT6_EventualFailure_Result    (withRetry, invoke);
            WithRetryT6_EventualFailure_Exception (withRetry, invoke);
            WithRetryT6_RetriesExhausted_Result   (withRetry, invoke);
            WithRetryT6_RetriesExhausted_Exception(withRetry, invoke);
        ...
        public void WithRetryT6_ResultPolicy_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);
        ...
        private void WithRetryT6_Success(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
        ...
        private void WithRetryT6_Success(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT6_Success(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
        ...
        private void WithRetryT6_Success<T>(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, int> func = new FuncProxy<int, string, double, long, ushort, int>((arg1, arg2, arg3, arg4, arg5) => 200);
            ...
            InterruptableFunc<int, string, double, long, ushort, int> reliableFunc = withRetry(
                func.Invoke,
                Retries.Infinite,
                resultPolicy   .Invoke,
        ...
        private void WithRetryT6_Failure_Result(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke)
            => WithRetryT6_Failure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT6_Failure_Result<T>(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, int> func = new FuncProxy<int, string, double, long, ushort, int>((arg1, arg2, arg3, arg4, arg5) => 500);
        ...
        private void WithRetryT6_Failure_Exception(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke)
            => WithRetryT6_Failure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT6_Failure_Exception<T>(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            // Create an "unsuccessful" user-defined func
            FuncProxy<int, string, double, long, ushort, int> func = new FuncProxy<int, string, double, long, ushort, int>((arg1, arg2, arg3, arg4, arg5) => throw new InvalidOperationException());
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, int> func = new FuncProxy<int, string, double, long, ushort, int>((arg1, arg2, arg3, arg4, arg5) => flakyFunc());
        ...
        private void WithRetryT6_EventualFailure_Result(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke)
            => WithRetryT6_EventualFailure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT6_EventualFailure_Result<T>(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        private void WithRetryT6_EventualFailure_Exception(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT6_EventualFailure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT6_EventualFailure_Exception<T>(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        private void WithRetryT6_RetriesExhausted_Result(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke)
            => WithRetryT6_RetriesExhausted_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT6_RetriesExhausted_Result<T>(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        private void WithRetryT6_RetriesExhausted_Exception(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT6_RetriesExhausted_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT6_RetriesExhausted_Exception<T>(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, int>, int, string, double, long, ushort, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        private void WithRetryT6_Canceled(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            bool useResultPolicy = true)
        ...
        private void WithRetryT6_Canceled<T>(
            Func<Func<int, string, double, long, ushort, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, int>> withRetry,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
            where T : DelegateProxy
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => reliableFunc(42, "foo", 3.14D, 1000L, (ushort)1, tokenSource.Token));
