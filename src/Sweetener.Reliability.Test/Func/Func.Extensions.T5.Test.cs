...
namespace Sweetener.Reliability.Test
{
    partial class FuncExtensionsTest
    {
        ...
        {
            Func<int, string, double, long, int> nullFunc = null;
            Func<int, string, double, long, int> func     = (arg1, arg2, arg3, arg4) => 42;
            ...
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, arg4, token) => func(arg1, arg2, arg3, arg4);

            WithRetryT5_Success                   (withRetry, invoke, useResultPolicy: false);
            WithRetryT5_Failure_Exception         (withRetry, invoke); // ResultPolicy is never called
            WithRetryT5_EventualSuccess           (withRetry, invoke, useResultPolicy: false);
            WithRetryT5_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT5_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);

            // With Token
            invoke = (func, arg1, arg2, arg3, arg4, token) => func(arg1, arg2, arg3, arg4, token);
            ...
            WithRetryT5_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT5_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);
            WithRetryT5_Canceled                  (withRetry        , useResultPolicy: false);
        }
        ...
        public void WithRetryT5_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);
        ...
        public void WithRetryT5_ResultPolicy_DelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, arg4, token) => func(arg1, arg2, arg3, arg4);

            WithRetryT5_Success                   (withRetry, invoke);
            WithRetryT5_Failure_Result            (withRetry, invoke);
            WithRetryT5_Failure_Exception         (withRetry, invoke);
            WithRetryT5_EventualSuccess           (withRetry, invoke);
            WithRetryT5_EventualFailure_Result    (withRetry, invoke);
            WithRetryT5_EventualFailure_Exception (withRetry, invoke);
            WithRetryT5_RetriesExhausted_Result   (withRetry, invoke);
            WithRetryT5_RetriesExhausted_Exception(withRetry, invoke);
        ...
        public void WithRetryT5_ResultPolicy_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);
        ...
        private void WithRetryT5_Success(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
        ...
        private void WithRetryT5_Success(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT5_Success(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
        ...
        private void WithRetryT5_Success<T>(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, int> func = new FuncProxy<int, string, double, long, int>((arg1, arg2, arg3, arg4) => 200);
            ...
            InterruptableFunc<int, string, double, long, int> reliableFunc = withRetry(
                func.Invoke,
                Retries.Infinite,
                resultPolicy   .Invoke,
        ...
        private void WithRetryT5_Failure_Result(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke)
            => WithRetryT5_Failure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT5_Failure_Result<T>(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, int> func = new FuncProxy<int, string, double, long, int>((arg1, arg2, arg3, arg4) => 500);
        ...
        private void WithRetryT5_Failure_Exception(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke)
            => WithRetryT5_Failure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT5_Failure_Exception<T>(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            // Create an "unsuccessful" user-defined func
            FuncProxy<int, string, double, long, int> func = new FuncProxy<int, string, double, long, int>((arg1, arg2, arg3, arg4) => throw new InvalidOperationException());
        ...
        private void WithRetryT5_EventualFailure_Result(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke)
            => WithRetryT5_EventualFailure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT5_EventualFailure_Result<T>(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        private void WithRetryT5_EventualFailure_Exception(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT5_EventualFailure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT5_EventualFailure_Exception<T>(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        private void WithRetryT5_RetriesExhausted_Result(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke)
            => WithRetryT5_RetriesExhausted_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT5_RetriesExhausted_Result<T>(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        private void WithRetryT5_RetriesExhausted_Exception(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT5_RetriesExhausted_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT5_RetriesExhausted_Exception<T>(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, int>, int, string, double, long, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        private void WithRetryT5_Canceled(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, int>> withRetry,
            bool useResultPolicy = true)
        ...
        private void WithRetryT5_Canceled<T>(
            Func<Func<int, string, double, long, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, int>> withRetry,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
            where T : DelegateProxy
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => reliableFunc(42, "foo", 3.14D, 1000L, tokenSource.Token));
