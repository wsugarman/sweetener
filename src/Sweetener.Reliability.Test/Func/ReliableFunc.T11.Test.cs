...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc10Test : ReliableDelegateTest<string>
    {
        ...
        private void Ctor_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, string>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, string>> factory)
        {
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, string> actual = factory(func, 37, exceptionPolicy, complexDelayPolicy);
        ...
        private void Ctor_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, string>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, string>> factory)
        {
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, complexDelayPolicy);
