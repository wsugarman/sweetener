...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncFunc4Test : ReliableDelegateTest<string>
    {
        ...
        {
            FuncProxy<int, string, double, long, Task<string>> func = new FuncProxy<int, string, double, long, Task<string>>();
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, long, string>, int, string, double, long, CancellationToken, (bool Success, string Result)> tryInvokeAsync;
            if (passToken)
