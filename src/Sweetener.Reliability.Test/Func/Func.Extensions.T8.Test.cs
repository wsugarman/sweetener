...
namespace Sweetener.Reliability.Test
{
    partial class FuncExtensionsTest
    {
        ...
        {
            Func<int, string, double, long, ushort, byte, TimeSpan, int> nullFunc = null;
            Func<int, string, double, long, ushort, byte, TimeSpan, int> func     = (arg1, arg2, arg3, arg4, arg5, arg6, arg7) => 42;
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => func(arg1, arg2, arg3, arg4, arg5, arg6, arg7);

            WithRetryT8_Success                   (withRetry, invoke, useResultPolicy: false);
            WithRetryT8_Failure_Exception         (withRetry, invoke); // ResultPolicy is never called
            WithRetryT8_EventualSuccess           (withRetry, invoke, useResultPolicy: false);
            WithRetryT8_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT8_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);

            // With Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => func(arg1, arg2, arg3, arg4, arg5, arg6, arg7, token);
            ...
            WithRetryT8_EventualFailure_Exception (withRetry, invoke, useResultPolicy: false);
            WithRetryT8_RetriesExhausted_Exception(withRetry, invoke, useResultPolicy: false);
            WithRetryT8_Canceled                  (withRetry        , useResultPolicy: false);
        }
        ...
        public void WithRetryT8_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, e, d);
        ...
        public void WithRetryT8_ResultPolicy_DelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);

            // Without Token
            invoke = (func, arg1, arg2, arg3, arg4, arg5, arg6, arg7, token) => func(arg1, arg2, arg3, arg4, arg5, arg6, arg7);

            WithRetryT8_Success                   (withRetry, invoke);
            WithRetryT8_Failure_Result            (withRetry, invoke);
            WithRetryT8_Failure_Exception         (withRetry, invoke);
            WithRetryT8_EventualSuccess           (withRetry, invoke);
            WithRetryT8_EventualFailure_Result    (withRetry, invoke);
            WithRetryT8_EventualFailure_Exception (withRetry, invoke);
            WithRetryT8_RetriesExhausted_Result   (withRetry, invoke);
            WithRetryT8_RetriesExhausted_Exception(withRetry, invoke);
        ...
        public void WithRetryT8_ResultPolicy_ComplexDelayPolicy()
        {
            ...
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke;
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry = (f, m, r, e, d) => f.WithRetry(m, r, e, d);
        ...
        private void WithRetryT8_Success(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
        ...
        private void WithRetryT8_Success(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, ComplexDelayPolicy<int>, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT8_Success(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
        ...
        private void WithRetryT8_Success<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, int> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, int>((arg1, arg2, arg3, arg4, arg5, arg6, arg7) => 200);
            ...
            InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int> reliableFunc = withRetry(
                func.Invoke,
                Retries.Infinite,
                resultPolicy   .Invoke,
        ...
        private void WithRetryT8_Failure_Result(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke)
            => WithRetryT8_Failure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT8_Failure_Result<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, int> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, int>((arg1, arg2, arg3, arg4, arg5, arg6, arg7) => 500);
        ...
        private void WithRetryT8_Failure_Exception(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke)
            => WithRetryT8_Failure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT8_Failure_Exception<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        {
            // Create an "unsuccessful" user-defined func
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, int> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, int>((arg1, arg2, arg3, arg4, arg5, arg6, arg7) => throw new InvalidOperationException());
            ...
            where T : DelegateProxy
        {
            ...
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, int> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, int>((arg1, arg2, arg3, arg4, arg5, arg6, arg7) => flakyFunc());
        ...
        private void WithRetryT8_EventualFailure_Result(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke)
            => WithRetryT8_EventualFailure_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT8_EventualFailure_Result<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        private void WithRetryT8_EventualFailure_Exception(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT8_EventualFailure_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT8_EventualFailure_Exception<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        private void WithRetryT8_RetriesExhausted_Result(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke)
            => WithRetryT8_RetriesExhausted_Result(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT8_RetriesExhausted_Result<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory)
            where T : DelegateProxy
        ...
        private void WithRetryT8_RetriesExhausted_Exception(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
            bool useResultPolicy = true)
            => WithRetryT8_RetriesExhausted_Exception(
                (f, m, r, e, d) => withRetry(f, m, r, e, d.Invoke),
                invoke,
                () =>
                {
        ...
        private void WithRetryT8_RetriesExhausted_Exception<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>, int, string, double, long, ushort, byte, TimeSpan, CancellationToken, int> invoke,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
        ...
        private void WithRetryT8_Canceled(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, DelayPolicy, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            bool useResultPolicy = true)
        ...
        private void WithRetryT8_Canceled<T>(
            Func<Func<int, string, double, long, ushort, byte, TimeSpan, int>, int, ResultPolicy<int>, ExceptionPolicy, T, InterruptableFunc<int, string, double, long, ushort, byte, TimeSpan, int>> withRetry,
            Func<T> delayPolicyFactory,
            bool useResultPolicy)
            where T : DelegateProxy
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => reliableFunc(42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), tokenSource.Token));
