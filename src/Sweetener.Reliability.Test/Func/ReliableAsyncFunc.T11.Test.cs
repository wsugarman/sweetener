...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncFunc10Test : ReliableDelegateTest<string>
    {
        ...
        private void InvokeAsync(bool passToken)
        {
            ...
            Assert.That.ThrowsException<InvalidOperationException>(() => invoke(badFunc, 42, "foo", 3.14D, 1000L, (ushort)1, (byte)255, TimeSpan.FromDays(30), 112U, Tuple.Create(true, 64UL), new DateTime(2019, 10, 06), CancellationToken.None));
