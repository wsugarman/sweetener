...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncFunc3Test : ReliableDelegateTest<string>
    {
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, string> invoke;
            if (passToken)
            ...
            Assert.That.ThrowsException<InvalidOperationException>(() => invoke(badFunc, 42, "foo", 3.14D, CancellationToken.None));
