...
{
    [TestClass]
    public sealed class ReliableAsyncFunc3Test : ReliableDelegateTest<string>
    {
        private static readonly Func<ReliableAsyncFunc<int, string, double, string>, Func<int, string, double, CancellationToken, Task<string>>> s_getFunc = DynamicGetter.ForField<ReliableAsyncFunc<int, string, double, string>, Func<int, string, double, CancellationToken, Task<string>>>("_func");

        [TestMethod]
        public void Ctor_DelayHandler()
            => Ctor_DelayHandler((f, m, e, d) => new ReliableAsyncFunc<int, string, double, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ComplexDelayHandler()
            => Ctor_ComplexDelayHandler((f, m, e, d) => new ReliableAsyncFunc<int, string, double, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ResultHandler_DelayHandler()
            => Ctor_ResultHandler_DelayHandler((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_ResultHandler_ComplexDelayHandler()
            => Ctor_ResultHandler_ComplexDelayHandler((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_DelayHandler()
            => Ctor_Interruptable_DelayHandler((f, m, e, d) => new ReliableAsyncFunc<int, string, double, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayHandler()
            => Ctor_Interruptable_ComplexDelayHandler((f, m, e, d) => new ReliableAsyncFunc<int, string, double, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultHandler_DelayHandler()
            => Ctor_Interruptable_ResultHandler_DelayHandler((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultHandler_ComplexDelayHandler()
            => Ctor_Interruptable_ResultHandler_ComplexDelayHandler((f, m, r, e, d) => new ReliableAsyncFunc<int, string, double, string>(f, m, r, e, d));
        ...
        private void Ctor_DelayHandler(Func<Func<int, string, double, Task<string>>, int, ExceptionHandler, DelayHandler, ReliableAsyncFunc<int, string, double, string>> factory)
        {
            FuncProxy<int, string, double, Task<string>> func = new FuncProxy<int, string, double, Task<string>>(async (arg1, arg2, arg3) => await Task.FromResult("Hello World"));
...
#nullable enable
            ...
            ReliableAsyncFunc<int, string, double, string> actual = factory(func.Invoke, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_ComplexDelayHandler(Func<Func<int, string, double, Task<string>>, int, ExceptionHandler, ComplexDelayHandler<string>, ReliableAsyncFunc<int, string, double, string>> factory)
        {
            FuncProxy<int, string, double, Task<string>> func = new FuncProxy<int, string, double, Task<string>>(async (arg1, arg2, arg3) => await Task.FromResult("Hello World"));
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, string> actual = factory(func.Invoke, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultHandler_DelayHandler(Func<Func<int, string, double, Task<string>>, int, ResultHandler<string>, ExceptionHandler, DelayHandler, ReliableAsyncFunc<int, string, double, string>> factory)
        {
            FuncProxy<int, string, double, Task<string>> func = new FuncProxy<int, string, double, Task<string>>(async (arg1, arg2, arg3) => await Task.FromResult("Hello World"));
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, string> actual = factory(func.Invoke, 37, resultHandler, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, resultHandler, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultHandler_ComplexDelayHandler(Func<Func<int, string, double, Task<string>>, int, ResultHandler<string>, ExceptionHandler, ComplexDelayHandler<string>, ReliableAsyncFunc<int, string, double, string>> factory)
        {
            FuncProxy<int, string, double, Task<string>> func = new FuncProxy<int, string, double, Task<string>>(async (arg1, arg2, arg3) => await Task.FromResult("Hello World"));
            ResultHandler<string> resultHandler = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, string> actual = factory(func.Invoke, 37, resultHandler, exceptionHandler, delayHandler);
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, string> actual = factory(func, 37, exceptionHandler, delayHandler.Invoke);
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, string> actual = factory(func, 37, exceptionHandler, delayHandler);
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, string> actual = factory(func, 37, resultHandler, exceptionHandler, delayHandler.Invoke);
...
#nullable enable
            ...
            // Create a ReliableAsyncFunc and validate
            ReliableAsyncFunc<int, string, double, string> actual = factory(func, 37, resultHandler, exceptionHandler, delayHandler);

            Ctor(actual, 37, resultHandler, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void CtorFunc(ReliableAsyncFunc<int, string, double, string> reliableFunc, FuncProxy<int, string, double, Task<string>> expected)
        ...
        private void CtorFunc(ReliableAsyncFunc<int, string, double, string> reliableFunc, Func<int, string, double, CancellationToken, Task<string>> expected)
            => CtorFunc(reliableFunc, actual => Assert.AreSame(expected, actual));

        private void CtorFunc(ReliableAsyncFunc<int, string, double, string> reliableFunc, Action<Func<int, string, double, CancellationToken, Task<string>>> validateFunc)
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, string> invokeAsync;
            if (passToken)
                invokeAsync = (r, arg1, arg2, arg3, t) => r.InvokeAsync(arg1, arg2, arg3, t).Result;
            else
                invokeAsync = (r, arg1, arg2, arg3, t) => r.InvokeAsync(arg1, arg2, arg3).Result;

#nullable disable

            // Test a function that returns a null Task
            ReliableAsyncFunc<int, string, double, string> badFunc = new ReliableAsyncFunc<int, string, double, string>((arg1, arg2, arg3) => null, Retries.Infinite, ExceptionPolicy.Transient, DelayPolicy.None);
            Assert.That.ThrowsException<InvalidOperationException>(() => invokeAsync(badFunc, 42, "foo", 3.14D, CancellationToken.None));
...
#nullable enable
            ...
            {
                // Success
                Invoke_Success                ((f, arg1, arg2, arg3, t, r) => Assert.AreEqual(r, invokeAsync(f, arg1, arg2, arg3, t)), addEventHandlers);
                Invoke_EventualSuccess        ((f, arg1, arg2, arg3, t, r) => Assert.AreEqual(r, invokeAsync(f, arg1, arg2, arg3, t)), addEventHandlers);

                // Failure (Result)
                Invoke_Failure_Result         ((f, arg1, arg2, arg3, t, r) => Assert.AreEqual(r, invokeAsync(f, arg1, arg2, arg3, t)), addEventHandlers);
                Invoke_EventualFailure_Result ((f, arg1, arg2, arg3, t, r) => Assert.AreEqual(r, invokeAsync(f, arg1, arg2, arg3, t)), addEventHandlers);
                Invoke_RetriesExhausted_Result((f, arg1, arg2, arg3, t, r) => Assert.AreEqual(r, invokeAsync(f, arg1, arg2, arg3, t)), addEventHandlers);

                // Failure (Exception)
                Invoke_Failure_Exception         ((f, arg1, arg2, arg3, t, e) => Assert.That.ThrowsException(() => invokeAsync(f, arg1, arg2, arg3, t), e), addEventHandlers);
                Invoke_EventualFailure_Exception ((f, arg1, arg2, arg3, t, e) => Assert.That.ThrowsException(() => invokeAsync(f, arg1, arg2, arg3, t), e), addEventHandlers);
                Invoke_RetriesExhausted_Exception((f, arg1, arg2, arg3, t, e) => Assert.That.ThrowsException(() => invokeAsync(f, arg1, arg2, arg3, t), e), addEventHandlers);
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, Optional<string>> tryInvokeAsync;
            if (passToken)
                tryInvokeAsync = (r, arg1, arg2, arg3, t) => r.TryInvokeAsync(arg1, arg2, arg3, t).Result;
            else
                tryInvokeAsync = (r, arg1, arg2, arg3, t) => r.TryInvokeAsync(arg1, arg2, arg3).Result;

#nullable disable

            // Test a function that returns a null Task
            ReliableAsyncFunc<int, string, double, string> badFunc = new ReliableAsyncFunc<int, string, double, string>((arg1, arg2, arg3) => null, Retries.Infinite, ExceptionPolicy.Transient, DelayPolicy.None);
            Assert.That.ThrowsException<InvalidOperationException>(() => tryInvokeAsync(badFunc, 42, "foo", 3.14D, CancellationToken.None));

#nullable enable

            Action<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, string> assertSuccess =
                (f, arg1, arg2, arg3, t, r) =>
                {
                    Optional<string> result = tryInvokeAsync(f, arg1, arg2, arg3, t);
                    Assert.IsTrue(result.HasValue);
                    Assert.AreEqual(r, result.Value);
                };

            Action<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, string> assertResultFailure =
                (f, arg1, arg2, arg3, t, r) =>
                {
            ...
            Action<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, Type> assertExceptionFailure =
        ...
        private void Invoke_Failure_Exception(Action<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            FuncProxy<int, string, double, Task<string>> func = new FuncProxy<int, string, double, Task<string>>(async (arg1, arg2, arg3) => await Task.FromException<string>(new OutOfMemoryException()));
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableFunc, 42, "foo", 3.14D, tokenSource.Token, typeof(OutOfMemoryException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Result(Action<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Exception(Action<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually fails after a transient result and exception
        ...
        private void Invoke_RetriesExhausted_Result(Action<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted_Exception(Action<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually exhausts the maximum number of retries after transient results and exceptions
            Func<string> flakyFunc = FlakyFunc.Create<string, IOException>("Retry");
            FuncProxy<int, string, double, Task<string>> func = new FuncProxy<int, string, double, Task<string>>(async (arg1, arg2, arg3) => await Task.FromResult(flakyFunc()));
        ...
        private void Invoke_Canceled_Delay(Action<ReliableAsyncFunc<int, string, double, string>, int, string, double, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
