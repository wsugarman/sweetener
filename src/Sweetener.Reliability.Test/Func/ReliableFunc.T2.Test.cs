...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc1Test : ReliableDelegateTest<string>
    {
        ...
        private void Invoke(Func<ReliableFunc<int, string>, int, string> invoke)
        {
            ...
            // Failure (Bad Result)
            Action<ReliableFunc<int, string>, int> assertFailureResult = (reliableFunc, arg)
                => Assert.AreEqual("Bad Result", reliableFunc.Invoke(arg));
        ...
        {
            // Success
            Func<ReliableFunc<int, string>, int, string> assertSuccess = (r, arg) =>
            {
            ...
            // Failure (Bad Result)
            Action<ReliableFunc<int, string>, int> assertFailure = (reliableFunc, arg) =>
            {
