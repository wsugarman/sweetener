...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncFunc11Test : ReliableDelegateTest<string>
    {
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, ulong, string>, int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, DateTime, ulong, CancellationToken, (bool Success, string Result)> tryInvokeAsync;
            if (passToken)
