...
namespace Sweetener.Reliability.Test
{
    ...
    public partial class AsyncFuncExtensionsTest : FuncExtensionsTestBase
    {
        ...
        public void WithAsyncRetryT1_Async_ResultPolicy_DelayHandler()
        {
            ...
            WithRetryT1_EventualSuccess(funcFactory, delayHandlerFactory, withAsyncRetry, invoke, observeFuncDelay, (d, r, e) => d.Invoking += Expect.Asc(), passResultHandler: true);

            // Failure (Result)
            WithRetryT1_Failure_Result         (funcFactory, delayHandlerFactory, withAsyncRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int>());
            WithRetryT1_EventualFailure_Result (funcFactory, delayHandlerFactory, withAsyncRetry, invoke, observeFuncDelay, (d, r, e) => d.Invoking += Expect.Asc());
        ...
        public void WithAsyncRetryT1_Async_ResultPolicy_ComplexDelayHandler()
        {
            ...
            WithRetryT1_EventualSuccess(funcFactory, delayHandlerFactory, withAsyncRetry, invoke, observeFuncDelay, (d, r, e) => d.Invoking += Expect.AlternatingAsc(r, e), passResultHandler: true);

            // Failure (Result)
            WithRetryT1_Failure_Result         (funcFactory, delayHandlerFactory, withAsyncRetry, invoke, observeFunc     ,  d        => d.Invoking += Expect.Nothing<int, int, Exception>());
            WithRetryT1_EventualFailure_Result (funcFactory, delayHandlerFactory, withAsyncRetry, invoke, observeFuncDelay, (d, r, e) => d.Invoking += Expect.AlternatingAsc(r, e));
        ...
        public void WithAsyncRetryT1_Async_WithToken_DelayHandler()
        {
            ...
            // Test a function that returns a null Task
            InterruptableTestFunc nullTaskFunc         = (token) => null;
