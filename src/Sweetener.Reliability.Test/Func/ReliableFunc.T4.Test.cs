...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc3Test : ReliableDelegateTest<string>
    {
        ...
        public void Ctor_DelayPolicy()
            => Ctor_DelayPolicy((f, m, e, d) => new ReliableFunc<int, string, double, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ComplexDelayPolicy()
            => Ctor_ComplexDelayPolicy((f, m, e, d) => new ReliableFunc<int, string, double, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ResultPolicy_DelayPolicy()
            => Ctor_ResultPolicy_DelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, double, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_ResultPolicy_ComplexDelayPolicy()
            => Ctor_ResultPolicy_ComplexDelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, double, string>(f, m, r, e, d));
        ...
        public void Invoke_CancellationToken()
        {
            ...
            Invoke_Canceled((reliableFunc, arg1, arg2, arg3, token) => reliableFunc.Invoke(arg1, arg2, arg3, token), addEventHandlers: false);
            Invoke_Canceled((reliableFunc, arg1, arg2, arg3, token) => reliableFunc.Invoke(arg1, arg2, arg3, token), addEventHandlers: true );
        }
        ...
        public void TryInvoke_CancellationToken()
        {
            ...
            // Ensure CancellationToken prevents additional retry
            Invoke_Canceled((reliableFunc, arg1, arg2, arg3, token) => reliableFunc.TryInvoke(arg1, arg2, arg3, token, out string _), addEventHandlers: false);
            Invoke_Canceled((reliableFunc, arg1, arg2, arg3, token) => reliableFunc.TryInvoke(arg1, arg2, arg3, token, out string _), addEventHandlers: true );
        ...
        private void Ctor_DelayPolicy(Func<Func<int, string, double, string>, int, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, double, string>> factory)
        {
            ...
            ReliableFunc<int, string, double, string> actual = factory(func, 37, exceptionPolicy, delayPolicy.Invoke);
        ...
        private void Ctor_ComplexDelayPolicy(Func<Func<int, string, double, string>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, string>> factory)
        {
            Func<int, string, double, string> func = (arg1, arg2, arg3) => "Hello World";
            ExceptionPolicy            exceptionPolicy    = ExceptionPolicies.Retry<IOException>();
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, string> actual = factory(func, 37, exceptionPolicy, complexDelayPolicy);
            Ctor(actual, func, 37, ReliableDelegate<string>.DefaultResultPolicy, exceptionPolicy, complexDelayPolicy);
        }

        private void Ctor_ResultPolicy_DelayPolicy(Func<Func<int, string, double, string>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, double, string>> factory)
        {
            Func<int, string, double, string> func = (arg1, arg2, arg3) => "Hello World";
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);
        ...
        private void Ctor_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, double, string>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, double, string>> factory)
        {
            Func<int, string, double, string> func = (arg1, arg2, arg3) => "Hello World";
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, complexDelayPolicy);
        ...
        private void Invoke(Func<ReliableFunc<int, string, double, string>, int, string, double, string> invoke)
        {
            ...
            {
                // Success
                Invoke_Success                ((f, arg1, arg2, arg3, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, arg3)), addEventHandlers);
                Invoke_EventualSuccess        ((f, arg1, arg2, arg3, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, arg3)), addEventHandlers);

                // Failure (Result)
                Invoke_Failure_Result         ((f, arg1, arg2, arg3, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, arg3)), addEventHandlers);
                Invoke_EventualFailure_Result ((f, arg1, arg2, arg3, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, arg3)), addEventHandlers);
                Invoke_RetriesExhausted_Result((f, arg1, arg2, arg3, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, arg3)), addEventHandlers);

                // Failure (Exception)
                Invoke_Failure_Exception         ((f, arg1, arg2, arg3, t) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2, arg3), t), addEventHandlers);
                Invoke_EventualFailure_Exception ((f, arg1, arg2, arg3, t) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2, arg3), t), addEventHandlers);
                Invoke_RetriesExhausted_Exception((f, arg1, arg2, arg3, t) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2, arg3), t), addEventHandlers);
            }
        }
        ...
        private void Invoke_Success(Action<ReliableFunc<int, string, double, string>, int, string, double, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_Failure_Result(Action<ReliableFunc<int, string, double, string>, int, string, double, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_Failure_Exception(Action<ReliableFunc<int, string, double, string>, int, string, double, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualSuccess(Action<ReliableFunc<int, string, double, string>, int, string, double, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Result(Action<ReliableFunc<int, string, double, string>, int, string, double, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Exception(Action<ReliableFunc<int, string, double, string>, int, string, double, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually fails after a transient result and exception
        ...
        private void Invoke_RetriesExhausted_Result(Action<ReliableFunc<int, string, double, string>, int, string, double, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted_Exception(Action<ReliableFunc<int, string, double, string>, int, string, double, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually exhausts the maximum number of retries after transient results and exceptions
            Func<string> flakyFunc = FlakyFunc.Create<string, IOException>("Retry");
            FuncProxy<int, string, double, string> func = new FuncProxy<int, string, double, string>((arg1, arg2, arg3) => flakyFunc());
        ...
        private void Invoke_Canceled(Action<ReliableFunc<int, string, double, string>, int, string, double, CancellationToken> assertInvoke, bool addEventHandlers)
        {
            ...
            func            .Invoking += (arg1, arg2, arg3, c) =>
            {
                if (c.Calls > 1)
