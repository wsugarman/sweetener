...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc3Test : ReliableDelegateTest<string>
    {
        ...
        {
            FuncProxy<int, string, double, string> func = new FuncProxy<int, string, double, string>((arg1, arg2, arg3) => "Hello World");
...
#nullable enable
        ...
        {
            Func<ReliableFunc<int, string, double, string>, int, string, double, CancellationToken, string> invokeAsync;
            if (passToken)
        ...
        {
            Func<ReliableFunc<int, string, double, string>, int, string, double, CancellationToken, Optional<string>> tryInvokeAsync;
            if (passToken)
