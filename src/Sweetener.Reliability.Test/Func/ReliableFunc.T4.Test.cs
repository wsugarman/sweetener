...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc3Test : ReliableDelegateTest<string>
    {
        ...
        private void Invoke(Func<ReliableFunc<int, string, double, string>, int, string, double, string> invoke)
        {
            ...
            // Failure (Bad Result)
            Action<ReliableFunc<int, string, double, string>, int, string, double> assertFailureResult = (reliableFunc, arg1, arg2, arg3)
                => Assert.AreEqual("Bad Result", reliableFunc.Invoke(arg1, arg2, arg3));
        ...
        {
            // Success
            Func<ReliableFunc<int, string, double, string>, int, string, double, string> assertSuccess = (r, arg1, arg2, arg3) =>
            {
            ...
            // Failure (Bad Result)
            Action<ReliableFunc<int, string, double, string>, int, string, double> assertFailure = (reliableFunc, arg1, arg2, arg3) =>
            {
