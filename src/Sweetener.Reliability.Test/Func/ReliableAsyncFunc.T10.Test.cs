...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableAsyncFunc9Test : ReliableDelegateTest<string>
    {
        ...
        {
            FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, Task<string>> func = new FuncProxy<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, Task<string>>();
        ...
        {
            Func<ReliableAsyncFunc<int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, string>, int, string, double, long, ushort, byte, TimeSpan, uint, Tuple<bool, ulong>, CancellationToken, (bool Success, string Result)> tryInvokeAsync;
            if (passToken)
