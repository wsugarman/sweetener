...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc5Test : ReliableDelegateTest<string>
    {
        ...
        public void Ctor_DelayPolicy()
        {
            ...
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(null, Retries.Infinite, exceptionPolicy, delayPolicy.Invoke));
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new ReliableFunc<int, string, double, long, ushort, string>(func, -2              , exceptionPolicy, delayPolicy.Invoke));
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(func, Retries.Infinite, null           , delayPolicy.Invoke));
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(func, Retries.Infinite, exceptionPolicy, (DelayPolicy)null ));

            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, string> actual = new ReliableFunc<int, string, double, long, ushort, string>(func, 37, exceptionPolicy, delayPolicy.Invoke);
        ...
        public void Ctor_ComplexDelayPolicy()
        {
            ...
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(null, Retries.Infinite, exceptionPolicy, complexDelayPolicy              ));
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new ReliableFunc<int, string, double, long, ushort, string>(func, -2              , exceptionPolicy, complexDelayPolicy              ));
            ...
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(func, Retries.Infinite, exceptionPolicy, (ComplexDelayPolicy<string>)null));

            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, string> actual = new ReliableFunc<int, string, double, long, ushort, string>(func, 37, exceptionPolicy, complexDelayPolicy);
        ...
        public void Ctor_ResultPolicy_DelayPolicy()
        {
            ...
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(null, Retries.Infinite, resultPolicy, exceptionPolicy, delayPolicy.Invoke));
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new ReliableFunc<int, string, double, long, ushort, string>(func, -2              , resultPolicy, exceptionPolicy, delayPolicy.Invoke));
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(func, Retries.Infinite, null        , exceptionPolicy, delayPolicy.Invoke));
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(func, Retries.Infinite, resultPolicy, null           , delayPolicy.Invoke));
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(func, Retries.Infinite, resultPolicy, exceptionPolicy, (DelayPolicy)null ));

            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, string> actual = new ReliableFunc<int, string, double, long, ushort, string>(func, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);
        ...
        public void Ctor_ResultPolicy_ComplexDelayPolicy()
        {
            ...
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(null, Retries.Infinite, resultPolicy, exceptionPolicy, complexDelayPolicy              ));
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => new ReliableFunc<int, string, double, long, ushort, string>(func, -2              , resultPolicy, exceptionPolicy, complexDelayPolicy              ));
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(func, Retries.Infinite, null        , exceptionPolicy, complexDelayPolicy              ));
            ...
            Assert.ThrowsException<ArgumentNullException      >(() => new ReliableFunc<int, string, double, long, ushort, string>(func, Retries.Infinite, resultPolicy, exceptionPolicy, (ComplexDelayPolicy<string>)null));

            // Create a ReliableFunc and validate
            ReliableFunc<int, string, double, long, ushort, string> actual = new ReliableFunc<int, string, double, long, ushort, string>(func, 37, resultPolicy, exceptionPolicy, complexDelayPolicy);
        ...
        public void TryInvoke_CancellationToken()
        {
            ...
            // Ensure CancellationToken prevents additional retry
            Invoke_Canceled((reliableFunc, arg1, arg2, arg3, arg4, arg5, token) => reliableFunc.TryInvoke(arg1, arg2, arg3, arg4, arg5, token, out string _));
        ...
        {
            // Success
            Invoke_Success                ((f, arg1, arg2, arg3, arg4, arg5, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, arg3, arg4, arg5)));
            Invoke_EventualSuccess        ((f, arg1, arg2, arg3, arg4, arg5, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, arg3, arg4, arg5)));

            // Failure (Result)
            Invoke_Failure_Result         ((f, arg1, arg2, arg3, arg4, arg5, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, arg3, arg4, arg5)));
            Invoke_EventualFailure_Result ((f, arg1, arg2, arg3, arg4, arg5, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, arg3, arg4, arg5)));
            Invoke_RetriesExhausted_Result((f, arg1, arg2, arg3, arg4, arg5, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, arg3, arg4, arg5)));

            // Failure (Exception)
            Invoke_Failure_Exception         ((f, arg1, arg2, arg3, arg4, arg5, t) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2, arg3, arg4, arg5), t));
            Invoke_EventualFailure_Exception ((f, arg1, arg2, arg3, arg4, arg5, t) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2, arg3, arg4, arg5), t));
            Invoke_RetriesExhausted_Exception((f, arg1, arg2, arg3, arg4, arg5, t) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2, arg3, arg4, arg5), t));
        }
        ...
        {
            Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, string> assertSuccess =
                (f, arg1, arg2, arg3, arg4, arg5, r) =>
                {
                    Assert.IsTrue(tryInvoke(f, arg1, arg2, arg3, arg4, arg5, out string actual));
                    Assert.AreEqual(r, actual);
                };

            Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, string> assertResultFailure =
                (f, arg1, arg2, arg3, arg4, arg5, r) =>
                {
                    Assert.IsFalse(tryInvoke(f, arg1, arg2, arg3, arg4, arg5, out string actual));
                    Assert.AreEqual(default, actual);
                };

            Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, Type> assertExceptionFailure =
                (f, arg1, arg2, arg3, arg4, arg5, r) =>
                {
                    Assert.IsFalse(tryInvoke(f, arg1, arg2, arg3, arg4, arg5, out string actual));
                    Assert.AreEqual(default, actual);
        ...
        private void Invoke_Success(Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, string> assertInvoke)
        {
            ...
            // Invoke
            assertInvoke(reliableFunc, 42, "foo", 3.14D, 1000L, (ushort)1, "Success");
        ...
        private void Invoke_Failure_Result(Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, string> assertInvoke)
        {
            ...
            // Invoke
            assertInvoke(reliableFunc, 42, "foo", 3.14D, 1000L, (ushort)1, "Failure");
        ...
        private void Invoke_Failure_Exception(Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, Type> assertInvoke)
        {
            ...
            // Invoke
            assertInvoke(reliableFunc, 42, "foo", 3.14D, 1000L, (ushort)1, typeof(InvalidOperationException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, string> assertInvoke)
        {
        ...
        private void Invoke_EventualFailure_Result(Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, string> assertInvoke)
        {
        ...
        private void Invoke_EventualFailure_Exception(Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, Type> assertInvoke)
        {
            // Create a user-defined function that eventually fails after a transient result and exception
        ...
        private void Invoke_RetriesExhausted_Result(Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, string> assertInvoke)
        {
            ...
            // Invoke
            assertInvoke(reliableFunc, 42, "foo", 3.14D, 1000L, (ushort)1, "Retry");
        ...
        private void Invoke_RetriesExhausted_Exception(Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, Type> assertInvoke)
        {
            // Create a user-defined function that eventually exhausts the maximum number of retries after transient results and exceptions
            Func<string> flakyFunc = FlakyFunc.Create<string, IOException>("Retry");
            FuncProxy<int, string, double, long, ushort, string> func = new FuncProxy<int, string, double, long, ushort, string>((arg1, arg2, arg3, arg4, arg5) => flakyFunc());
            ...
            // Invoke
            assertInvoke(reliableFunc, 42, "foo", 3.14D, 1000L, (ushort)1, typeof(IOException));
        ...
        private void Invoke_Canceled(Action<ReliableFunc<int, string, double, long, ushort, string>, int, string, double, long, ushort, CancellationToken> assertInvoke)
        {
            ...
            Assert.That.ThrowsException<OperationCanceledException>(() => assertInvoke(reliableFunc, 42, "foo", 3.14D, 1000L, (ushort)1, tokenSource.Token));
