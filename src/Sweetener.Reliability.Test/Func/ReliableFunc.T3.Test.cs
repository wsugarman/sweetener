...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc2Test : ReliableDelegateTest<string>
    {
        ...
        public void Invoke_CancellationToken()
        {
            ...
            Invoke_Canceled((reliableFunc, arg1, arg2, token) => reliableFunc.Invoke(arg1, arg2, token), addEventHandlers: false);
            Invoke_Canceled((reliableFunc, arg1, arg2, token) => reliableFunc.Invoke(arg1, arg2, token), addEventHandlers: true );
        }
        ...
        public void TryInvoke_CancellationToken()
        {
            ...
            // Ensure CancellationToken prevents additional retry
            Invoke_Canceled((reliableFunc, arg1, arg2, token) => reliableFunc.TryInvoke(arg1, arg2, token, out string _), addEventHandlers: false);
            Invoke_Canceled((reliableFunc, arg1, arg2, token) => reliableFunc.TryInvoke(arg1, arg2, token, out string _), addEventHandlers: true );
        ...
        private void Ctor_ComplexDelayPolicy(Func<Func<int, string, string>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, string>> factory)
        {
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func, 37, exceptionPolicy, complexDelayPolicy);
        ...
        private void Ctor_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, string>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, string>> factory)
        {
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, complexDelayPolicy);
        ...
        private void Invoke(Func<ReliableFunc<int, string, string>, int, string, string> invoke)
        {
            ...
            {
                // Success
                Invoke_Success                ((f, arg1, arg2, r) => Assert.AreEqual(r, invoke(f, arg1, arg2)), addEventHandlers);
                Invoke_EventualSuccess        ((f, arg1, arg2, r) => Assert.AreEqual(r, invoke(f, arg1, arg2)), addEventHandlers);

                // Failure (Result)
                Invoke_Failure_Result         ((f, arg1, arg2, r) => Assert.AreEqual(r, invoke(f, arg1, arg2)), addEventHandlers);
                Invoke_EventualFailure_Result ((f, arg1, arg2, r) => Assert.AreEqual(r, invoke(f, arg1, arg2)), addEventHandlers);
                Invoke_RetriesExhausted_Result((f, arg1, arg2, r) => Assert.AreEqual(r, invoke(f, arg1, arg2)), addEventHandlers);

                // Failure (Exception)
                Invoke_Failure_Exception         ((f, arg1, arg2, t) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2), t), addEventHandlers);
                Invoke_EventualFailure_Exception ((f, arg1, arg2, t) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2), t), addEventHandlers);
                Invoke_RetriesExhausted_Exception((f, arg1, arg2, t) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2), t), addEventHandlers);
            }
        }
        ...
        private void Invoke_Success(Action<ReliableFunc<int, string, string>, int, string, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_Failure_Result(Action<ReliableFunc<int, string, string>, int, string, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_Failure_Exception(Action<ReliableFunc<int, string, string>, int, string, Type> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualSuccess(Action<ReliableFunc<int, string, string>, int, string, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Result(Action<ReliableFunc<int, string, string>, int, string, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Exception(Action<ReliableFunc<int, string, string>, int, string, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually fails after a transient result and exception
        ...
        private void Invoke_RetriesExhausted_Result(Action<ReliableFunc<int, string, string>, int, string, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted_Exception(Action<ReliableFunc<int, string, string>, int, string, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually exhausts the maximum number of retries after transient results and exceptions
            Func<string> flakyFunc = FlakyFunc.Create<string, IOException>("Retry");
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>((arg1, arg2) => flakyFunc());
        ...
        private void Invoke_Canceled(Action<ReliableFunc<int, string, string>, int, string, CancellationToken> assertInvoke, bool addEventHandlers)
        {
