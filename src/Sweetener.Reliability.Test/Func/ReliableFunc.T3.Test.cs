...
namespace Sweetener.Reliability.Test
{
    ...
    {
        private static readonly Func<ReliableFunc<int, string, string>, Func<int, string, CancellationToken, string>> s_getFunc = DynamicGetter.ForField<ReliableFunc<int, string, string>, Func<int, string, CancellationToken, string>>("_func");

        [TestMethod]
        public void Ctor_DelayPolicy()
            => Ctor_DelayPolicy((f, m, e, d) => new ReliableFunc<int, string, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ComplexDelayPolicy()
            => Ctor_ComplexDelayPolicy((f, m, e, d) => new ReliableFunc<int, string, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ResultPolicy_DelayPolicy()
            => Ctor_ResultPolicy_DelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_ResultPolicy_ComplexDelayPolicy()
            => Ctor_ResultPolicy_ComplexDelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_DelayPolicy()
            => Ctor_Interruptable_DelayPolicy((f, m, e, d) => new ReliableFunc<int, string, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayPolicy()
            => Ctor_Interruptable_ComplexDelayPolicy((f, m, e, d) => new ReliableFunc<int, string, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultPolicy_DelayPolicy()
            => Ctor_Interruptable_ResultPolicy_DelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy()
            => Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy((f, m, r, e, d) => new ReliableFunc<int, string, string>(f, m, r, e, d));
        ...
        private void Ctor_DelayPolicy(Func<Func<int, string, string>, int, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, string>> factory)
        {
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>();
            ...
            ReliableFunc<int, string, string> actual = factory(func.Invoke, 37, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ComplexDelayPolicy(Func<Func<int, string, string>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, string>> factory)
        {
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>();
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func.Invoke, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultPolicy_DelayPolicy(Func<Func<int, string, string>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, string>> factory)
        {
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>();
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func.Invoke, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, string>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, string>> factory)
        {
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>();
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func.Invoke, 37, resultPolicy, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_DelayPolicy(Func<Func<int, string, CancellationToken, string>, int, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, string>> factory)
        {
            Func<int, string, CancellationToken, string> func = (arg1, arg2, token) => "Hello World";
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            FuncProxy<int, TimeSpan> delayPolicy = new FuncProxy<int, TimeSpan>(i => Constants.Delay);
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func, 37, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ComplexDelayPolicy(Func<Func<int, string, CancellationToken, string>, int, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, string>> factory)
        {
            Func<int, string, CancellationToken, string> func = (arg1, arg2, token) => "Hello World";
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ComplexDelayPolicy<string> delayPolicy = (i, r, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func, 37, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultPolicy_DelayPolicy(Func<Func<int, string, CancellationToken, string>, int, ResultPolicy<string>, ExceptionPolicy, DelayPolicy, ReliableFunc<int, string, string>> factory)
        {
            Func<int, string, CancellationToken, string> func = (arg1, arg2, token) => "Hello World";
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, delayPolicy.Invoke);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultPolicy_ComplexDelayPolicy(Func<Func<int, string, CancellationToken, string>, int, ResultPolicy<string>, ExceptionPolicy, ComplexDelayPolicy<string>, ReliableFunc<int, string, string>> factory)
        {
            Func<int, string, CancellationToken, string> func = (arg1, arg2, token) => "Hello World";
            ResultPolicy<string> resultPolicy = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionPolicy exceptionPolicy = ExceptionPolicies.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func, 37, resultPolicy, exceptionPolicy, delayPolicy);

            Ctor(actual, 37, resultPolicy, exceptionPolicy, delayPolicy);
            CtorFunc(actual, func);
        }

        private void CtorFunc(ReliableFunc<int, string, string> reliableFunc, FuncProxy<int, string, string> expected)
        ...
        private void CtorFunc(ReliableFunc<int, string, string> reliableFunc, Func<int, string, CancellationToken, string> expected)
            => CtorFunc(reliableFunc, actual => Assert.AreSame(expected, actual));

        private void CtorFunc(ReliableFunc<int, string, string> reliableFunc, Action<Func<int, string, CancellationToken, string>> validateFunc)
        ...
        {
            Func<ReliableFunc<int, string, string>, int, string, CancellationToken, string> invoke;
            if (passToken)
                invoke = (r, arg1, arg2, t) => r.Invoke(arg1, arg2, t);
            else
                invoke = (r, arg1, arg2, t) => r.Invoke(arg1, arg2);

            // Callers may optionally include event handlers
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                // Success
                Invoke_Success                ((f, arg1, arg2, t, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, t)), addEventHandlers);
                Invoke_EventualSuccess        ((f, arg1, arg2, t, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, t)), addEventHandlers);

                // Failure (Result)
                Invoke_Failure_Result         ((f, arg1, arg2, t, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, t)), addEventHandlers);
                Invoke_EventualFailure_Result ((f, arg1, arg2, t, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, t)), addEventHandlers);
                Invoke_RetriesExhausted_Result((f, arg1, arg2, t, r) => Assert.AreEqual(r, invoke(f, arg1, arg2, t)), addEventHandlers);

                // Failure (Exception)
                Invoke_Failure_Exception         ((f, arg1, arg2, t, e) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2, t), e), addEventHandlers);
                Invoke_EventualFailure_Exception ((f, arg1, arg2, t, e) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2, t), e), addEventHandlers);
                Invoke_RetriesExhausted_Exception((f, arg1, arg2, t, e) => Assert.That.ThrowsException(() => invoke(f, arg1, arg2, t), e), addEventHandlers);

                if (passToken)
                {
                    Invoke_Canceled_Action((f, arg1, arg2, t) => f.Invoke(arg1, arg2, t), addEventHandlers);
        ...
        private void InvokeAsync(bool passToken)
        {
            Func<ReliableFunc<int, string, string>, int, string, CancellationToken, string> invoke;
            if (passToken)
                invoke = (r, arg1, arg2, t) => r.InvokeAsync(arg1, arg2, t).Result;
            else
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                if (passToken)
                {
                    Invoke_Canceled_Action((f, arg1, arg2, t) => f.InvokeAsync(arg1, arg2, t).Wait(), addEventHandlers);
        ...
        {
            TryFunc<ReliableFunc<int, string, string>, int, string, CancellationToken, string> tryInvoke;
            if (passToken)
                tryInvoke = TryInvokeFuncWithToken;
            else
                tryInvoke = TryInvokeFunc;

            Action<ReliableFunc<int, string, string>, int, string, CancellationToken, string> assertSuccess =
                (f, arg1, arg2, t, r) =>
                {
                    Assert.IsTrue(tryInvoke(f, arg1, arg2, t, out string actual));
                    Assert.AreEqual(r, actual);
                };

            Action<ReliableFunc<int, string, string>, int, string, CancellationToken, string> assertResultFailure =
                (f, arg1, arg2, t, r) =>
                {
                    // TryInvoke returns the default value instead of the failed value 'r'
                    Assert.IsFalse(tryInvoke(f, arg1, arg2, t, out string actual));
                    Assert.AreEqual(default, actual);
                };

            Action<ReliableFunc<int, string, string>, int, string, CancellationToken, Type> assertExceptionFailure =
                (f, arg1, arg2, t, e) =>
                {
            ...
            foreach (bool addEventHandlers in new bool[] { false, true })
            {
                ...
                if (passToken)
                {
                    Invoke_Canceled_Action((f, arg1, arg2, t) => f.TryInvoke(arg1, arg2, t, out string _), addEventHandlers);
                    Invoke_Canceled_Delay ((f, arg1, arg2, t) => f.TryInvoke(arg1, arg2, t, out string _), addEventHandlers);
                }
            }

            bool TryInvokeFunc(ReliableFunc<int, string, string> reliableFunc, int arg1, string arg2, CancellationToken token, out string result)
                => reliableFunc.TryInvoke(arg1, arg2, out result);

            bool TryInvokeFuncWithToken(ReliableFunc<int, string, string> reliableFunc, int arg1, string arg2, CancellationToken token, out string result)
                => reliableFunc.TryInvoke(arg1, arg2, token, out result);
        }
        ...
        private void Invoke_Success(Action<ReliableFunc<int, string, string>, int, string, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
            // Create a "successful" user-defined function
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>((arg1, arg2) => "Success");
        ...
        private void Invoke_Failure_Result(Action<ReliableFunc<int, string, string>, int, string, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
            // Create an "unsuccessful" user-defined function that returns a fatal result
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>((arg1, arg2) => "Failure");
        ...
        private void Invoke_Failure_Exception(Action<ReliableFunc<int, string, string>, int, string, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create an "unsuccessful" user-defined function that throws a fatal exception
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>((arg1, arg2) => throw new InvalidOperationException());
            ...
            // Invoke
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
                assertInvoke(reliableFunc, 42, "foo", tokenSource.Token, typeof(InvalidOperationException));
        ...
        private void Invoke_EventualSuccess(Action<ReliableFunc<int, string, string>, int, string, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Result(Action<ReliableFunc<int, string, string>, int, string, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_EventualFailure_Exception(Action<ReliableFunc<int, string, string>, int, string, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually fails after a transient result and exception
        ...
        private void Invoke_RetriesExhausted_Result(Action<ReliableFunc<int, string, string>, int, string, CancellationToken, string> assertInvoke, bool addEventHandlers)
        {
        ...
        private void Invoke_RetriesExhausted_Exception(Action<ReliableFunc<int, string, string>, int, string, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            // Create a user-defined function that eventually exhausts the maximum number of retries after transient results and exceptions
            Func<string> flakyFunc = FlakyFunc.Create<string, IOException>("Retry");
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>((arg1, arg2) => flakyFunc());
        ...
        private void Invoke_Canceled_Action(Action<ReliableFunc<int, string, string>, int, string, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
        ...
        private void Invoke_Canceled_Delay(Action<ReliableFunc<int, string, string>, int, string, CancellationToken> invoke, bool addEventHandlers)
        {
            using CancellationTokenSource tokenSource = new CancellationTokenSource();
