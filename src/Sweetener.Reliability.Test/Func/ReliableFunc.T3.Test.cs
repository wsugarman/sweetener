...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc2Test : ReliableDelegateTest<string>
    {
        ...
        public void Ctor_DelayHandler()
            => Ctor_DelayHandler((f, m, e, d) => new ReliableFunc<int, string, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ComplexDelayHandler()
            => Ctor_ComplexDelayHandler((f, m, e, d) => new ReliableFunc<int, string, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_ResultHandler_DelayHandler()
            => Ctor_ResultHandler_DelayHandler((f, m, r, e, d) => new ReliableFunc<int, string, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_ResultHandler_ComplexDelayHandler()
            => Ctor_ResultHandler_ComplexDelayHandler((f, m, r, e, d) => new ReliableFunc<int, string, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_DelayHandler()
            => Ctor_Interruptable_DelayHandler((f, m, e, d) => new ReliableFunc<int, string, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ComplexDelayHandler()
            => Ctor_Interruptable_ComplexDelayHandler((f, m, e, d) => new ReliableFunc<int, string, string>(f, m, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultHandler_DelayHandler()
            => Ctor_Interruptable_ResultHandler_DelayHandler((f, m, r, e, d) => new ReliableFunc<int, string, string>(f, m, r, e, d));

        [TestMethod]
        public void Ctor_Interruptable_ResultHandler_ComplexDelayHandler()
            => Ctor_Interruptable_ResultHandler_ComplexDelayHandler((f, m, r, e, d) => new ReliableFunc<int, string, string>(f, m, r, e, d));
        ...
        private void Ctor_DelayHandler(Func<Func<int, string, string>, int, ExceptionHandler, DelayHandler, ReliableFunc<int, string, string>> factory)
        {
            ...
            ReliableFunc<int, string, string> actual = factory(func.Invoke, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_ComplexDelayHandler(Func<Func<int, string, string>, int, ExceptionHandler, ComplexDelayHandler<string>, ReliableFunc<int, string, string>> factory)
        {
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>();
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func.Invoke, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultHandler_DelayHandler(Func<Func<int, string, string>, int, ResultHandler<string>, ExceptionHandler, DelayHandler, ReliableFunc<int, string, string>> factory)
        {
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>();
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func.Invoke, 37, resultHandler, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, resultHandler, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_ResultHandler_ComplexDelayHandler(Func<Func<int, string, string>, int, ResultHandler<string>, ExceptionHandler, ComplexDelayHandler<string>, ReliableFunc<int, string, string>> factory)
        {
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>();
            ResultHandler<string> resultHandler = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func.Invoke, 37, resultHandler, exceptionHandler, delayHandler);

            Ctor(actual, 37, resultHandler, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_DelayHandler(Func<Func<int, string, CancellationToken, string>, int, ExceptionHandler, DelayHandler, ReliableFunc<int, string, string>> factory)
        {
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func, 37, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ComplexDelayHandler(Func<Func<int, string, CancellationToken, string>, int, ExceptionHandler, ComplexDelayHandler<string>, ReliableFunc<int, string, string>> factory)
        {
            Func<int, string, CancellationToken, string> func = (arg1, arg2, token) => "Hello World";
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ComplexDelayHandler<string> delayHandler = (i, r, e) => TimeSpan.FromHours(1);
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func, 37, exceptionHandler, delayHandler);

            Ctor(actual, 37, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultHandler_DelayHandler(Func<Func<int, string, CancellationToken, string>, int, ResultHandler<string>, ExceptionHandler, DelayHandler, ReliableFunc<int, string, string>> factory)
        {
            Func<int, string, CancellationToken, string> func = (arg1, arg2, token) => "Hello World";
            ResultHandler<string> resultHandler = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func, 37, resultHandler, exceptionHandler, delayHandler.Invoke);

            Ctor(actual, 37, resultHandler, exceptionHandler, delayHandler);
            CtorFunc(actual, func);
        }

        private void Ctor_Interruptable_ResultHandler_ComplexDelayHandler(Func<Func<int, string, CancellationToken, string>, int, ResultHandler<string>, ExceptionHandler, ComplexDelayHandler<string>, ReliableFunc<int, string, string>> factory)
        {
            Func<int, string, CancellationToken, string> func = (arg1, arg2, token) => "Hello World";
            ResultHandler<string> resultHandler = r => r == "Successful Value" ? ResultKind.Successful : ResultKind.Fatal;
            ExceptionHandler exceptionHandler = ExceptionPolicy.Fatal;
            ...
            // Create a ReliableFunc and validate
            ReliableFunc<int, string, string> actual = factory(func, 37, resultHandler, exceptionHandler, delayHandler);
        ...
        {
            Func<ReliableFunc<int, string, string>, int, string, CancellationToken, string> invokeAsync;
            if (passToken)
        ...
        {
            Func<ReliableFunc<int, string, string>, int, string, CancellationToken, (bool Success, string Result)> tryInvokeAsync;
            if (passToken)
            ...
            Action<ReliableFunc<int, string, string>, int, string, CancellationToken, string> assertSuccess =
                (f, arg1, arg2, t, r) =>
                {
                    (bool success, string result) = tryInvokeAsync(f, arg1, arg2, t);
        ...
        private void Invoke_Failure_Exception(Action<ReliableFunc<int, string, string>, int, string, CancellationToken, Type> assertInvoke, bool addEventHandlers)
        {
            ...
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>((arg1, arg2) => throw new OutOfMemoryException());
