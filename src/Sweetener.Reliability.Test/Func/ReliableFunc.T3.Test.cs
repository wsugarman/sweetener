...
namespace Sweetener.Reliability.Test
{
    ...
    public sealed class ReliableFunc2Test : ReliableDelegateTest<string>
    {
        ...
        {
            FuncProxy<int, string, string> func = new FuncProxy<int, string, string>((arg1, arg2) => "Hello World");
...
#nullable enable
        ...
        {
            Func<ReliableFunc<int, string, string>, int, string, CancellationToken, Optional<string>> tryInvokeAsync;
            if (passToken)
